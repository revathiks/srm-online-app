...
class Mbaparttime extends FrontendController
{
    //
    public $CI;
    ...
    public function mbaparttime_form($mode = false , $applicant_login_id = false , $applicant_personal_det_id = false) {
        ...
        // Get Form ID
        $get_form_id = APP_FORM_ID_PART_TIME;
        // Get Applicant ID
        ...
        if ( $this->input->post () ){
            ...
            $user_data['app_form_id']=APP_FORM_ID_PART_TIME;
            ...
            if($user_data['currentIndex']==0){
                ...
                $url = $api_urls[ 'part_time_ug_pg_basic_detail' ];
            ...
            if($user_data['currentIndex']==1){
                ...
                $url = $api_urls[ 'part_time_ug_pg_personal_detail' ];
                // Get Personal ApplicaNT ID
                $user_data['applicant_personal_det_id'] = $applicant_id;
                $user_data['grad_id'] = is_numeric($user_data['pd_program'])?$user_data['pd_program'] : NULL;
                
                $user_data['course_pref'] = is_numeric($user_data['course_pref_1'])?$user_data['course_pref_1'] : NULL;
                $user_data['course_choice_no'] = $user_data['course_choice_no_1'];
                $user_data['course_prefer_id'] = $user_data['course_prefer_id_1'];
                  
                $user_data['specialization_pref'] = is_numeric($user_data['special_pref_1'])?$user_data['special_pref_1'] : NULL;
                $user_data['specialization_choice_no'] = $user_data['specialization_choice_no_1'];
                $user_data['specialization_prefer_id'] = $user_data['specialization_prefer_id_1'];
            ...
            if($user_data['currentIndex']==2){
                $url = $api_urls[ 'part_time_ug_pg_parent_detail' ];
            ...
            {
                $api_urls = $this->config->item ( 'api_urls' );
                $url = $api_urls[ 'part_time_ug_pg_addressdet' ];
                $method = 'POST';
                $user_data['applicant_personal_det_id'] = $applicant_id;
            ...
            if($user_data['currentIndex']==4){
                ...
                $academic_data['current_education_qual_status']=$current_education_qual_status;
                ...
                $academic_data['name_as_in_marksheet'] = $user_data['canditate_name'];
                
                // Tenth Academic
                $academic_data['cur_qual_completed_tenth'] = 't';
                $academic_data['schooling_id_tenth'] = $user_data['schooling_id_tenth'];
                $academic_data['institute_name_tenth'] = $user_data['academic_tenth_inst'];
                $academic_data['board_tenth'] = $user_data['academic_tenth_board'];
                $academic_data['marking_scheme_tenth'] = ($user_data['academic_tenth_msv']!='null') ? $user_data['academic_tenth_msv'] :'';
                $academic_data['cgpa_tenth'] = ($user_data['academic_tenth_cgpa']!='null') ? $user_data['academic_tenth_cgpa']:'';
                $academic_data['yr_of_passing_tenth'] = $user_data['academic_tenth_yrp'];
                $academic_data['roll_no_tenth'] = $user_data['academic_tenth_regno'];
                
                
                if($user_data['academic_tenth_board']==OTHER_BOARD){
                    $academic_data['other_tenth_board'] = $user_data['other_tenth_board'];
                }
                
                // Twelfth Academic
                $academic_data['cur_qual_completed_twelfth'] = ($cur_qual_completed==2)?'t':'f';
                $academic_data['schooling_id_twelfth'] = $user_data['schooling_id_twelfth'];
                $academic_data['institute_name_twelfth'] = $user_data['academic_twelfth_inst'];
                $academic_data['board_twelfth'] = $user_data['academic_twelfth_board'];
                $academic_data['marking_scheme_twelfth'] = ($user_data['academic_twelfth_msv']!='null')? $user_data['academic_twelfth_msv'] :NULL;
                $academic_data['cgpa_twelfth'] = ($user_data['academic_twelfth_cgpa']!='null') ? $user_data['academic_twelfth_cgpa'] :NULL;
                $academic_data['yr_of_passing_twelfth'] = $user_data['academic_twelfth_yrp'];
                $academic_data['roll_no_twelfth'] = $user_data['academic_twelfth_regno'];
                
                
                if($user_data['academic_twelfth_board']==OTHER_BOARD){
                    $academic_data['other_twelfth_board'] = $user_data['other_twelfth_board'];
                }
                ...
                $api_urls = $this->config->item ( 'api_urls' );
                $url = $api_urls['part_time_ug_pg_academicdet'];
                $method = 'POST';
                $userdata = $this->user_details_data;
            ...
            if($user_data['currentIndex']==6){
                $url = $api_urls[ 'part_time_ug_pg_declaration' ];
                // Get Personal Applicant ID
                $user_data['applicant_personal_det_id'] = $applicant_id;
            ...
            $wizard_dt = $this->_get_wizard_details(APP_FORM_ID_PART_TIME);
            ...
            $this->data['site_title'] = $this->data['page_title'] = 'Part Time Ug/Pg Courses 2020';
            $this->template('applications/form_mbaparttime', $this->data, true);
        }
        
    }
    
    public function mbaparttime_preview($mode = false , $applicant_login_id = false , $applicant_personal_det_id = false) {
        $this->is_exists_user_logged();
        /*CRM ADMIN Edit form start*/
        $this->data['get_admin_session'] = $get_crmadmin_session = $this->_get_crmadmin_session();
        $this->data['mode_edit'] = $mode;
        ...
        $this->template('applications/part_time_preview', $this->data, true);
    }
