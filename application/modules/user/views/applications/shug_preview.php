...
$board_eleven = isset($board_eleven) ? $board_eleven:'Select';
$marking_scheme_eleven = isset($marking_scheme_eleven)? $marking_scheme_eleven : '';
...
$url = base_url().'shug?startIndex='.$startIndex;
if($mode_edit == ADMIN_MODE_EDIT)
{
    $url = base_url().'shug/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
}
...
<div class="row disable_div_preview" id="shug_form">
    <div class="col-sm-12">
        <div class="card " id="ShugPreviewToPrint">
            <div class="card-body">
                <div class="accordion" id="accordionExample">
                    ...
                    <div class="card card_print shug_print">
                                			...
                                			<tr>
                                				...
                                				<td>
                                					<div class="form-group mg-b-10-force">
                                						<select class="form-control select2" name="academic_eleven_board" id="academic_eleven_board" title="Select Board" data-parsley-required="false" data-parsley-required-message="Please Select Board" data-parsley-errors-container="#custom-academic_eleven_board-parsley-error">
                                							<option value=""><?php echo $board_eleven?></option>
                                						</select>
                                						<span id="custom-academic_eleven_board-parsley-error"></span>
                                					</div>
                                					<?php if($board_id_eleven==OTHER_BOARD) { ?>
                                				...
                                				<td>
                                					<div class="form-group mg-b-10-force" > 
                                						...
                                						<option value=""><?php echo $mark_percentage_eleven;?></option>
                                						</select>
                                					</div>
                                				</td>
                                				<td>
                                				<div class="">
                                					<input class="form-control" type="text" name="academic_obtain_cgpa_eleven" id="academic_obtain_cgpa_eleven" data-parsley-required="false" data-parsley-required-message="Please Enter Percentage/CGPA"  data-parsley-type-message="Please Enter Valid CGPA" min="33" max="100" data-parsley-trigger="keyup" data-parsley-type="number" value="<?php echo $mark_percentage_eleven; ?>" maxlength="6">
                                				</div>
                                				</td>
                                				<td>
                                					<div class="form-group mg-b-10-force">
                                						<input class="form-control" type="text" name="academic_yr_passing_eleven" id="academic_yr_passing_eleven" placeholder="YYYY" maxlength="4" data-parsley-required="false" data-parsley-required-message="Please Pick Year Of Passing" data-parsley-trigger="change" data-parsley-errors-container="#custom-academic_yr_passing_eleven-parsley-error" value="<?php echo $completion_year_eleven; ?>">
                                						<span id="custom-academic_yr_passing_eleven-parsley-error"></span>	
                                					</div>
                                				</td>				
                                				<td class="reg_width">
                                				<div class="">
                                					<input class="form-control" type="text" name="academic_reg_no_eleven" id="academic_reg_no_eleven" maxlength="20" data-parsley-required="false" data-parsley-required-message="Please Enter Registration No" data-parsley-length="[1, 20]" value="<?php echo $registration_no_eleven; ?>" data-parsley-type='alphanum'  data-parsley-type-message="Enter Valid Roll /Registration Number">
                                				</div>
                                				</td>
                                			</tr>
                                		</tbody>
