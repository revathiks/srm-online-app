...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'shug_form', 'name' => 'form_shug', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
...
<div class="table-responsive">
	...
	<div class="table-responsive">
	<table class="table table-bordered mt-0 table_eleven" id="table_eleven">
		...
		<tbody>
			<tr>
				...
				<input class="form-control" type="text" name="academic_eleven_inst" id="academic_eleven_inst" maxlength="<?php echo APLCT_INSTITUTE_NAME_MAXLENGTH;?>" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_INSTITUTE_NAME_MSG; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>" data-parsley-length="[1, 200]" value="<?php echo $inst_name_eleven; ?>">
				</td>
				<td>
					<div class="form-group mg-b-10-force">
						<select class="form-control select2" name="academic_eleven_board" id="academic_eleven_board" title="Select Board" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_BOARD_MSG; ?>" data-parsley-errors-container="#custom-academic_eleven_board-parsley-error">
							<option value="">Select</option>
						</select>
						<span id="custom-academic_eleven_board-parsley-error"></span>
					</div>
					<div class="form-group" id="other_board3" style="display: none;">
					<input type="text" class="form-control" name="other_eleven_board" id="other_eleven_board" placeholder="If Other, please enter here.." maxlength="<?php echo APLCT_OTHER_BOARD_MAXLENGTH; ?>" value="<?php echo $other_board_name_eleven; ?>">
				   </div>
				</td>
				...
				<td>
				<div class="">
					<input class="form-control" type="text" name="academic_obtain_cgpa_eleven" id="academic_obtain_cgpa_eleven" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_PERCENT_CGPA_MSG; ?>"  data-parsley-type-message="<?php echo REQD_PERCENT_CGPA_VALID_MSG; ?>" data-parsley-trigger="keyup" data-parsley-type="number" value="<?php echo $mark_percentage_eleven; ?>" maxlength="<?php echo APLCT_PERCENT_CGPA_MAXLENGTH; ?>">
				</div>
				</td>
				<td>
					<div class="form-group mg-b-10-force">
						<input class="form-control" type="text" name="academic_yr_passing_eleven" id="academic_yr_passing_eleven" placeholder="YYYY" maxlength="<?php echo APLCT_YEAR_OF_PASSING_MAXLENGTH; ?>" data-parsley-required="false" data-parsley-required-message="Please Pick Year Of Passing" data-parsley-trigger="change" data-parsley-errors-container="#custom-academic_yr_passing_eleven-parsley-error" value="<?php echo $completion_year_eleven; ?>">
						<span id="custom-academic_yr_passing_eleven-parsley-error"></span>	
					</div>
				</td>				
				<td class="reg_width">
				<div class="">
					<input class="form-control" type="text" name="academic_reg_no_eleven" id="academic_reg_no_eleven" maxlength="<?php echo APLCT_REG_NO_MAXLENGTH; ?>" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_REG_NO_MSG; ?>" data-parsley-length="[1, 20]" value="<?php echo $registration_no_eleven; ?>" data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_REG_NO_MSG; ?>">
				</div>
				</td>
			</tr>
		</tbody>
	...
	<div class="table-responsive">
	<table class="table table-bordered mt-0 table_twelfth" >
	...
	<div class="help_text" style="margin-bottom:20px;"><small id="emailHelp" class="form-text text-muted"><?php echo DIPLOMA_HOLDER_MSG;?></small></div>
...
<div class="col-lg-6">
              <div class="card mb-3 base_details_card">
                  <div class="card-body">
                      ...
                      <p class="card-subtitle mb-3 mt-3">Sub Total <span style="float: right;"><?php echo $appln_form_fee; ?></span>
                      </p>
	...
	<div class="col-md-12">
		<div class="form-layout">
			<div class="row mg-b-25 mt-3">
				...
				<div class="row w-100 mt-3">
				<!--  <div class="col-md-6">
                      <a target="_blank" href="<?php echo base_url();?>shug_preview">
