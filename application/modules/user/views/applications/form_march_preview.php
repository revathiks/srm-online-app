...
$applicant_board_name=isset($applicant_board_name) ?$applicant_board_name : 'Select';
$applicant_marking_scheme_name=isset($applicant_marking_scheme_name) ?$applicant_marking_scheme_name : 'Select';
...
$campus_1 = !empty($campus_prefer_name) ? $campus_prefer_name : 'Select Campus Preference 1';
...
//echo $payment_mode_id;die;
/* Payment Details End */

$startIndex = $this->input->get('startIndex', true);
/*CRM ADMIN Edit form start*/
$url = base_url().'march?startIndex='.$startIndex;
if($mode_edit == ADMIN_MODE_EDIT)
{
  $url = base_url().'march/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
}
/*CRM ADMIN Edit form start*/
...
<div class="row disable_div_preview" id="marchdesign_form">
<div class="col-sm-12">
<div class="card " id="MarchPreviewToPrint">
<div class="card-body">
<div class="accordion" id="accordionExample">
   ...
   <div class="card card_print">
    ...
    <div id="collapseTwo" class="collapse show bg-light" aria-labelledby="headingTwo" data-parent="#accordionExample">
     <div class="card-body">
      <section class="row">
		<h5 class="text-primary mb-3">Campus Preferences</h5>
        <div class="row w-100">
			<!-- col-4 -->
      ...
      <section class="row">
         ...
         <div class="row w-100">
                    ...
                    <div class="col-lg-4" id="mother_occupation_div">
                        ...
                        <input class="form-control" type="text" name="pd_mother_other_occupation" id="pd_mother_other_occupation"  placeholder="If Other, please enter here..." data-parsley-required="false"   data-parsley-errors-container="#custom-pd_mother_other_occupation-parsley-error" 
                        value="<?php echo $mother_other_occupation;?>">
         ...
         <div class="row w-100" id="guardian_details">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div id="guardian_other_occupation_div" class="form-group">
                            <input class="form-control" type="text" name="guardian_other_occupation" id="guardian_other_occupation"  placeholder="If Other, please enter here..."data-parsley-required="false"   data-parsley-errors-container="#custom-guardian_other_occupation-parsley-error" 
                  ...
                  <td style="width:200px;">
                    <div class="form-group mg-b-10-force">
                      <select class="form-control custom-select" name="board_0" id="board_0" data-parsley-required="true" data-parsley-required-message="Please Choose Board" data-parsley-trigger="change" data-parsley-errors-container="#custom-board0-parsley-error">
                        <option value=""><?php echo $applicant_board_name;?></option>
                      </select>
                  ...
                  <td>
                    <div class="form-group mg-b-10-force" id="appering_info_0">
                      <select class="form-control custom-select" name="marking_scheme_0" id="marking_scheme_0" data-parsley-required="true" data-parsley-required-message="Please Choose Marking Scheme" data-parsley-trigger="change" data-parsley-errors-container="#custom-marking_scheme0-parsley-error">
                        <option value=""><?php echo $applicant_marking_scheme_name;?></option>
                      </select>
    ...
    <table class="table table-bordered mt-0 ">
        ...
        <tbody>
            <tr>
                ...
                <input class="form-control" type="text" name="institute_name_1" id="institute_name_1" maxlength="200" data-parsley-required="true" data-parsley-required-message="Please Enter Institute Name" data-parsley-nameonly="true" data-parsley-nameonly-message="Name must be alphabetic only." data-parsley-length="[1, 200]" 
                ...
                <td>
                  <?php if($applicant_result_declared == 't') { ?>
                  <div class="form-group mg-b-10-force" id="appering_info_1">
                    <select class="form-control custom-select" name="marking_scheme_1" 
                    id="marking_scheme_1" data-parsley-required="true" data-parsley-required-message="Please Choose Marking Scheme" data-parsley-trigger="change" data-parsley-errors-container="#custom-marking_scheme1-parsley-error">
                ...
                <td>
                  <?php if($applicant_result_declared == 't') {?>
                    <input class="form-control" type="text" name="obtained_percentage_cgpa_1" placeholder="Obtained Percentage" id="obtained_percentage_cgpa_1" maxlength="5" data-parsley-required="true" 
                    data-parsley-required-message="Please Enter Obtained Percentage/CGPA"  data-parsley-type-message="Please Enter Valid CGPA" min="33" max="100" data-parsley-trigger="keyup" 
                ...
                <td>
                    <input class="form-control" type="text" name="year_of_passing_1" id="year_of_passing_1" placeholder="YYYY" maxlength="4" data-parsley-required="true" data-parsley-trigger="change" data-parsley-required-message="Please Enter Year of Passing"  data-parsley-errors-container="#custom-year_of_passing_1-parsley-error" 
                ...
                <td>
                    ...
                    " data-parsley-required-message="Please Enter Registration No" data-parsley-trigger="change" value="<?php echo $applicant_grad_det_reg_no; ?>" 
