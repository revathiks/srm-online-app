...
if($applicant_appln_details_list[0]['qual_status_id']==1){
	$current_education_qual_status = $this->config->item('agrisci_current_qualification_status')[1];
	$styleSchooling="display:none;";
}else{
	$current_education_qual_status = $this->config->item('agrisci_current_qualification_status')[2];
...
//end address
	...
	$url = base_url().'agrisci?startIndex='.$startIndex;
	if($mode_edit == ADMIN_MODE_EDIT)
	{
	  $url = base_url().'agrisci/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
	}
	/*CRM ADMIN Edit form start*/ 
?>
<div class="row">
...
<div class="row disable-div">
    <div class="col-sm-12" id="AGRIPreviewToPrint">
        <div class="card">
            <div class="card-body">
                                    ...
                                    <div class="col-lg-6">
										<div class="form-group">
											...
											<select class="form-control select2" data-placeholder="Choose Current Qualification Status" tabindex="-1" aria-hidden="true" name="current_qualification_status" id="current_qualification_status" title="Choose Current Qualification Status" data-parsley-required="true" data-parsley-required-message="Please Choose Qualification Status" data-parsley-errors-container="#custom-current_qualification_status-parsley-error">
												<option><?php echo $current_education_qual_status; ?></option>
											</select>
			   ...
			   <div class="row w-100">
				  ...
				  <div class="form-layout">
					...
					<div class="row w-100">
                      ...
                      <div class="form-group col-md-6" id="main_div_twelvfth_marksheet" style="<?php echo $styleSchooling; ?>">
