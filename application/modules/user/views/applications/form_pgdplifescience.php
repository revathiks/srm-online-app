...
// Check PG Qualified
$pg_qualified = $is_curr_qualify[$graduation_type_id_pg];
...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'pgdplifescience_form', 'name' => 'pgdplifescience_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
			...
			<div class="row mg-b-25 mt-3">
				<div class="col-lg-6">
					<div class="form-group mg-b-10-force">
						...
						<h6 style="color:#626ed4!important;"><?php echo ADPGDLS_CAMPUS_AVAILABLE_AT; ?></h6>
					</div>
				</div><!-- col-4 -->
		...
		<div class="row">
			...
			<div class="col-lg-6 ">
				<div class="form-group wd-xs-300 mr-5 w-100">
					...
					<div class="form-group mg-b-10-force">
						<input class="form-control" type="text" name="candidate_name" id="candidate_name" placeholder="Candidate's Name" maxlength="200" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CANDIDATE_NAME_MSG;?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG;?>" data-parsley-length="[<?php echo APLCT_CAND_NAME_MINLENGTH; ?>, <?php echo APLCT_CAND_NAME_MAXLENGTH; ?>]" value="<?php echo $name_as_in_marksheet[$tenth_schooling_id]; ?>" maxlength="<?php echo APLCT_CAND_NAME_MAXLENGTH; ?>" data-parsley-trigger="change">
	...
	<table class="table table-bordered table-responsive mt-3" id="academc_common">
		...
		<tbody>
			<tr>
				...
				<td>
					<div class="form-group mg-b-10-force">
						<select class="form-control select2 academic_board" name="academic_board" id="academic_board" title="Choose Board" data-parsley-required="true" data-parsley-required-message="Please Select Board" data-parsley-errors-container="#custom-academic_board-parsley-error">
							<option value="">Select</option>
						</select>
			...
			<td>Graduation</td>
				...
				<td>
					<div class="form-group mg-b-10-force"  id="td_graduation_ms">
				...
				<td>
					<div  id="td_graduation_cgpa">
						<input class="form-control" type="text" name="academic_obtain_cgpa_graduation" id=	"academic_obtain_cgpa_graduation" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_PERCENT_CGPA_MSG; ?>"  data-parsley-type-message="<?php echo REQD_PERCENT_CGPA_VALID_MSG; ?>" data-parsley-trigger="keyup" data-parsley-type="number" value="<?php echo $mark_percentage[$graduation_type_id_ug]; ?>" maxlength="<?php echo APLCT_PERCENT_CGPA_MAXLENGTH; ?>">
					</div>
				</td>
				<td>
					<div class="form-group mg-b-10-force"  id="td_graduation_yop">
			...
			<tr>
				<td>Post Graduation</td>
					<td><input class="form-control" type="text" name="academic_pg_graduation_inst" id="academic_pg_graduation_inst" maxlength="<?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_INSTITUTE_NAME_MSG; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>" data-parsley-length="[<?php echo APLCT_1_MAXLENGTH; ?>, <?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>]" value="<?php echo $inst_name[$graduation_type_id_pg]; ?>">
					...
					<td>
						<div class="form-group mg-b-10-force"  id="td_pg_graduation_ms" style="display:none;">
					...
					<td>
						<div  id="td_pg_graduation_cgpa" style="display:none;">
							<input class="form-control" type="text" name="academic_obtain_cgpa_pg_graduation" id=	"academic_obtain_cgpa_pg_graduation" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_PERCENT_CGPA_MSG; ?>"  data-parsley-type-message="<?php echo REQD_PERCENT_CGPA_VALID_MSG; ?>" data-parsley-trigger="keyup" data-parsley-type="number" value="<?php echo $mark_percentage[$graduation_type_id_pg]; ?>" maxlength="<?php echo CGPA_MAXLENGTH; ?>">
						</div>
					</td>
					<td>
						<div class="form-group mg-b-10-force"  id="td_pg_graduation_yop" style="display:none;">
					...
					<td>
						<div  id="td_pg_graduation_reg_no" style="display:none;">
	...
	?>	
		<div class="form-layout">
			<div class="row mg-b-25 mt-3">
				...
				if($pg_qualified=='t'){
					$pg_qualified_mark = "*";
					$pg_qualified_required = ((isset($docs[$document_id_post_graduation_marksheet]))?'false':'true');
				}else{
					$pg_qualified_mark = "";
					$pg_qualified_required = ((isset($docs[$document_id_post_graduation_marksheet]))?'false':'true');
				}
				...
				<div class="row w-100">
					...
					<div class="form-group col-md-6 ">
					   <label for="exampleFormControlTextarea1">Upload Your Post Graduation Marksheet <span class="tx-danger"> <?php echo $pg_qualified_mark; ?></span></label>
					   <input type="file" class="filestyle" name="post_graduation_marksheet" id="post_graduation_marksheet" data-parsley-required="<?php echo $pg_qualified_required; ?>" data-parsley-required-message="<?php echo REQD_UPLOAD_PG_GRAD_MARK_MSG; ?>" data-parsley-errors-container="#custom-post_graduation_marksheet-parsley-error"data-parsley-max-file-size="<?php echo MAX_FILE_SIZE_GRADUATION; ?>" data-max-file-size-js="<?php echo MAX_FILE_SIZE_JS; ?>" data-parsley-file-extension="<?php echo $file_allowed_type; ?>" onchange="upload_file(this.id)" data-file-id="<?php if(isset($docs[$document_id_post_graduation_marksheet])){ echo $docs[$document_id_post_graduation_marksheet]['id']; } ?>"accept="<?php  echo allow_extension($file_allowed_type); ?>">
