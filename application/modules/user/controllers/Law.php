...
class Law extends FrontendController
{
	//
    public $CI;
    ...
    public function Law_form($mode = false , $applicant_login_id = false , $applicant_personal_det_id = false)
    {
            ...
            {
                $url = $api_urls[ 'law_personal_detail' ];
                $user_data['applicant_personal_det_id'] = $applicant_id;
            ...
            { 
                ...
                $url = $api_urls['law_parent_detail'];
            ...
            if($user_data['currentIndex']==6){
                ...
                $url = $api_urls[ 'law_declaration_detail' ];
                $method ="POST";
            ...
            $url .= '/?fk_id='.$applicant_id.'&fk1_id='.APP_FORM_ID_LAW;
            $method = 'GET';
            //$userdata = $this->session_userdata();
            $userdata = $this->user_details_data;
            ...
            $applicantformdtl_id = array('applicant_personal_det_id' => $applicant_id , 
                'applicant_form_id' => APP_FORM_ID_LAW );
            ...
            $wizard_dt = $this->_get_wizard_details(APP_FORM_ID_LAW);
           ...
           //print_r($applicant_competitive_details_list);
            ...
            /*Get Instruction End*/
                ...
                $this->data['site_title'] = $this->data['page_title'] = 'Law Application Form';
                $this->template('applications/form_law', $this->data, true);
            }
            
    }


    public function law_edu_status() {
        parent::_law_edu_status(false, $this->is_admin);
    }

    public function law_form_preview($mode = false , $applicant_login_id = false , $applicant_personal_det_id = false)
    {
        	$this->is_exists_user_logged();
            /*CRM ADMIN Edit form start*/
            $this->data['get_admin_session'] = $get_crmadmin_session = $this->_get_crmadmin_session();
		...
		$this->data['user_data'] = $this->user_details_data['user_details']['data'][0];
		$this->data['personal_detail_list'] = $this->personal_detail_list($applicant_id);
		$this->data['site_title'] = $this->data['page_title'] = 'Law Application Form Preview';
        $this->template('applications/form_law_preview', $this->data, true);
    }		
