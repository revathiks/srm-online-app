...
$dob=isset($applicant_basic_details_list['dob'])? date('d/m/Y',strtotime($applicant_basic_details_list['dob'])):'DD/MM/YYYY';
...
$attemptsetstenth_tenth = isset($applicant_schooling_list[0]['attemptsetstenth']) ? $applicant_schooling_list[0]['attemptsetstenth'] : '';
$attemptstwelth_twelfth = isset($applicant_schooling_list[1]['attemptstwelth']) ? $applicant_schooling_list[1]['attemptstwelth'] : '';
...
//fetch current qualification status
...
$url = base_url().'bba?startIndex='.$startIndex;
if($mode_edit == ADMIN_MODE_EDIT)
{
    $url = base_url().'bba/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
}
?>
...
<div class="row disable_div_preview" id="bba_form">
    <div class="col-sm-12">
        <div class="card " id="BbaPreviewToPrint">
            <div class="card-body">
                            ...
                            <div class="card-body">
                                <section class="row">
                                    <div class="w-100 pd-20 pd-sm-40">
                                        <h5 class="text-primary mb-3">Select Campus Preferences </h5><hr/>
                             ...
                             <h5 class="text-primary mb-3">Academic Details</h5>
                                ...
                                <div class="row">
                                     <div class="col-lg-12 mb-3">
                                        Only one attempt after first appearance is allowed.
                                    </div>
                                </div>
                                <div class="row w-100  ">
                                    <div class="col-lg-6">
                                ...
                                <section class="row">
                                    <h5 class="text-primary mb-3 print_margin_12">10th Details</h5>
                                   <div class="table-responsive">
                                    ...
                                    <div class="mt-0 w-100">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
											<?php if ($cur_qual_completed == 't') { ?>
                                                    <div class="form-group attempts" id="Attempts1" >
                                            ...
                                            <div class="col-lg-4">
												<?php if ($cur_qual_completed == 't') { ?>
                                                    <div class="form-group attempts" id="Attempts-2">
    ...
    echo $docs[$document_id_photograph]['id'];
                                                        ...
                                                        <?php if (isset($docs[$document_id_photograph])) { ?>
                                                            ...
                                                            echo $docs[$document_id_photograph]['id'];
                                                        } ?>" data-doc-id="<?php echo $document_id_photograph; ?>" data-toggle="modal" data-target="#contentDeletePop" onclick="removeClick(this)"><i class="fa fa-trash" aria-hidden="true"></i></a> -->
...
<?php if (isset($docs[$document_id_signature])) { ?>
        ...
        echo $docs[$document_id_signature]['id'];
    } ?>" data-doc-id="<?php echo $document_id_signature; ?>" data-toggle="modal" data-target="#contentDeletePop" onclick="removeClick(this)"><i class="fa fa-trash" aria-hidden="true"></i></a> -->
...
<?php } ?>
    ...
    echo $docs[$document_id_tenth_marksheet]['id'];
                                                        ...
                                                        <?php if (isset($docs[$document_id_tenth_marksheet])) { ?>
                                                            ...
                                                            echo $docs[$document_id_tenth_marksheet]['id'];
                                                        } ?>" data-doc-id="<?php echo $document_id_tenth_marksheet; ?>" data-toggle="modal" data-target="#contentDeletePop" onclick="removeClick(this)"><i class="fa fa-trash" aria-hidden="true"></i></a> -->
...
<?php } ?>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleFormControlTextarea1">Upload Your 12th Marksheet <?php if ($cur_qual_completed == 't') { ?><span class="tx-danger" >*</span> <?php } ?></label>
...
<?php if (isset($docs[$document_id_twelvfth_marksheet])) { ?>
        ...
        echo $docs[$document_id_twelvfth_marksheet]['id'];
    } ?>" data-doc-id="<?php echo $document_id_twelvfth_marksheet; ?>" data-toggle="modal" data-target="#contentDeletePop" onclick="removeClick(this)"><i class="fa fa-trash" aria-hidden="true"></i></a> -->
