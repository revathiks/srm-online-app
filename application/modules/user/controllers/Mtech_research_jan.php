...
class Mtech_research_jan extends FrontendController
{
	//
    public $CI;
    ...
    public function mtechresearch_form($view_type = false , $mode = false , $applicant_login_id = false , $applicant_personal_det_id = false) {
        ...
        if ( $this->input->post () ){	
            ...
            {
                $url = $api_urls['mtechreearchbasicdet_jan'];
                $method = 'POST';
                $form_id = APP_FORM_ID_MTECH_RESEARCH_JAN;
           ...
           if($user_data['currentIndex']==1)
            {                
                $url = $api_urls['mtechresearch_personal_detail_jan'];
                $method = 'POST';
                $user_data['applicant_personal_det_id'] = $applicant_id;
                $user_data['applicant_login_id'] = $applicant_login_id; 
            ...
            {                
                ...
                $url = $api_urls[ 'mtechresearch_parent_detail_jan' ];
                //$userdata = $this->session_userdata();
                $userdata = $this->user_details_data;
            ...
            {              
                ...
                /*Professional Det*/
                $url = $api_urls['mtechresearch_acdemic_dtl_jan'];
                $method = 'POST';    
                //$userdata = $this->session_userdata();
                $userdata = $this->user_details_data;
            ...
            if($user_data['currentIndex']==5)
            {
                ...
                // Get 
                $user_data['applicant_personal_det_id'] = $applicant_id;
                $user_data['app_form_id'] = APP_FORM_ID_MTECH_RESEARCH_JAN;
            ...
            if($user_data['currentIndex']==6){
                $url = $api_urls[ 'mtechresearch_declaration_jan' ];
                $method ='POST';
        ...
        else
        {
            ...
            /* result_appicant start */
            //echo $applicant_id;
            //echo APP_FORM_ID_MTECH_RESEARCH_JAN;
            ...
            $wizard_dt = $this->_get_wizard_details(APP_FORM_ID_MTECH_RESEARCH_JAN);
            ...
            if($view_type == 'preview') {
                ...
                $this->template('applications/form_mtechresearch_jan_preview', $this->data, true);
            } else {
            ...
            //End: redirect to dashboard after appln completion
                $this->template('applications/form_mtechresearch_jan', $this->data, true);
            }
        }
