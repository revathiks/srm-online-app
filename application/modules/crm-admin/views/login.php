    ...
    <div class="form-group">
        ...
        <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Enter Email" data-parsley-required="true" data-parsley-type="email" data-parsley-required-message="Email required" data-parsley-type-message="Enter valid Email">
    </div>
    <div class="form-group">
    ...
    <!-- <div class="mt-4 pt-2 text-center">
        <p>Don't have an account ? <a href="<?php echo base_url('register');?>" class="font-weight-medium text-primary"> Signup now </a> </p>    
    </div> -->
