...
!(function (e, t) {
    ...
    (t.prototype.createHeadersElement = function () {
        ...
        (t.prototype._addColumn = function (e, t, o) {
            ...
            if (o && r > -1) {
                var a = this.columns.indexOf(o.getTopColumn()),
                    l = o.getElement();
                t ? (this.columns.splice(a, 0, n), l.parentNode.insertBefore(s, l)) : (this.columns.splice(a + 1, 0, n), l.parentNode.insertBefore(s, l.nextSibling));
            } else t ? (this.columns.unshift(n), this.headersElement.insertBefore(n.getElement(), this.headersElement.firstChild)) : (this.columns.push(n), this.headersElement.appendChild(n.getElement())), n.columnRendered();
            return n;
        }),
        ...
        (t.prototype.scrollToColumn = function (e, t, o) {
            ...
            return new Promise(function (l, c) {
                if ((void 0 === t && (t = i.table.options.scrollToColumnPosition), void 0 === o && (o = i.table.options.scrollToColumnIfVisible), e.visible)) {
                    ...
                    if (!o && (s = a.offsetLeft) > 0 && s + a.offsetWidth < i.element.clientWidth) return !1;
                    (n = a.offsetLeft + i.element.scrollLeft + r),
            ...
            return (
                ...
                this.columnsByIndex.forEach(function (i) {
                    ...
                    i.visible &&
                        ...
                        (r = "string" == typeof n ? (n.indexOf("%") > -1 ? (t / 100) * parseInt(n) : parseInt(n)) : n),
                        (o += r > s ? r : s));
                }),
                o
            );
        ...
        (t.prototype.addColumn = function (e, t, o) {
            ...
            return new Promise(function (n, s) {
                ...
                i._reIndexColumns(),
                    ...
                    i.redraw(),
                    "fitColumns" != i.table.modules.layout.getMode() && r.reinitializeWidth(),
        ...
        (t.prototype.redraw = function (e) {
            e && (u.prototype.helpers.elVisible(this.element) && this._verticalAlignHeaders(), this.table.rowManager.resetScroll(), this.table.rowManager.reinitialize()),
    ...
    var i = function e(t, o) {
        ...
        (this.table = o.table),
            ...
            (this.modules = {}),
            (this.cellEvents = { cellClick: !1, cellDblClick: !1, cellContext: !1, cellTap: !1, cellDblTap: !1, cellTapHold: !1, cellMouseEnter: !1, cellMouseLeave: !1, cellMouseOver: !1, cellMouseOut: !1, cellMouseMove: !1 }),
            (this.width = null),
            (this.widthStyled = ""),
            (this.minWidth = null),
            (this.minWidthStyled = ""),
    ...
    (i.prototype.createElement = function () {
        ...
        (i.prototype._mapDepricatedFunctionality = function () {
            void 0 !== this.definition.hideInHtml && ((this.definition.htmlOutput = !this.definition.hideInHtml), console.warn("hideInHtml column definition property is deprecated, you should now use htmlOutput")),
        ...
        (i.prototype._buildHeader = function () {
            ...
            t.headerVertical && (e.element.classList.add("tabulator-col-vertical"), "flip" === t.headerVertical && e.element.classList.add("tabulator-col-vertical-flip")),
                ...
                t.headerFilter &&
                    ...
                    (void 0 !== t.headerFilterPlaceholder && t.field && e.table.modules.localize.setHeaderFilterColumnPlaceholder(t.field, t.headerFilterPlaceholder), e.table.modules.filter.initializeColumn(e)),
        ...
        (i.prototype._formatColumnHeaderTitle = function (e, t) {
            ...
            if (this.definition.titleFormatter && this.table.modExists("format"))
                switch (
                    ...
                    (i = o.call(this.table.modules.format, s, n, r)),
                    void 0 === i ? "undefined" : _typeof(i))
                ) {
                    case "object":
                        i instanceof Node
                            ? e.appendChild(i)
                            : ((e.innerHTML = ""), console.warn("Format Error - Title formatter has returned a type of object, the only valid formatter object return is an instance of Node, the formatter returned:", i));
                        break;
                    case "undefined":
                    case "null":
                        e.innerHTML = "";
        ...
        (i.prototype.verticalAlign = function (e, t) {
            ...
            (this.element.style.height = o + "px"),
                ...
                this.isGroup ||
                    "top" === e ||
                    (this.element.style.paddingTop = "bottom" === e ? this.element.clientHeight - this.contentElement.offsetHeight + "px" : (this.element.clientHeight - this.contentElement.offsetHeight) / 2 + "px"),
    ...
    (n.prototype.createHolderElement = function () {
        ...
        (n.prototype.setColumnManager = function (e) {
                ...
                "virtual" === this.renderMode &&
                    e.element.addEventListener("scroll", function () {
                        var t = e.element.scrollTop,
                            o = e.scrollTop > t;
                        e.scrollTop != t
                            ? ((e.scrollTop = t), e.scrollVertical(o), "scroll" == e.table.options.ajaxProgressiveLoad && e.table.modules.ajax.nextPage(e.element.scrollHeight - e.element.clientHeight - t), e.table.options.scrollVertical(t))
                            : (e.scrollTop = t);
                    });
        }),
        (n.prototype.findRow = function (e) {
            var t = this;
            ...
            if (e instanceof s) return e._getSelf() || !1;
            if ("undefined" != typeof HTMLElement && e instanceof HTMLElement) {
                return (
        ...
        (n.prototype.getRowFromDataObject = function (e) {
            return (
        ...
        (n.prototype.scrollToRow = function (e, t, o) {
            var i,
                n = this,
            ...
            return new Promise(function (e, l) {
                if (s > -1) {
                    if ((void 0 === t && (t = n.table.options.scrollToRowPosition), void 0 === o && (o = n.table.options.scrollToRowIfVisible), "nearest" === t))
                        switch (n.renderMode) {
                            case "classic":
                                (i = u.prototype.helpers.elOffset(r).top), (t = Math.abs(n.element.scrollTop - i) > Math.abs(n.element.scrollTop + n.element.clientHeight - i) ? "bottom" : "top");
                                break;
                            case "virtual":
                                t = Math.abs(n.vDomTop - s) > Math.abs(n.vDomBottom - s) ? "bottom" : "top";
                        }
                    if (!o && u.prototype.helpers.elVisible(r) && (a = u.prototype.helpers.elOffset(r).top - u.prototype.helpers.elOffset(n.element).top) > 0 && a < n.element.clientHeight - r.offsetHeight) return !1;
                    switch (n.renderMode) {
                        case "classic":
                            n.element.scrollTop = u.prototype.helpers.elOffset(r).top - u.prototype.helpers.elOffset(n.element).top + n.element.scrollTop;
                            break;
                        case "virtual":
                    ...
                    switch (t) {
                        ...
                        case "center":
                            n.element.scrollHeight - n.element.scrollTop == n.element.clientHeight
                                ? (n.element.scrollTop = n.element.scrollTop + (r.offsetTop - n.element.scrollTop) - (n.element.scrollHeight - r.offsetTop) / 2)
                                : (n.element.scrollTop = n.element.scrollTop - n.element.clientHeight / 2);
                            break;
                        case "bottom":
                            n.element.scrollHeight - n.element.scrollTop == n.element.clientHeight
                                ? (n.element.scrollTop = n.element.scrollTop - (n.element.scrollHeight - r.offsetTop) + r.offsetHeight)
                                : (n.element.scrollTop = n.element.scrollTop - n.element.clientHeight + r.offsetHeight);
                    }
                    e();
        ...
        (n.prototype._setDataActual = function (e, t) {
            var o = this;
        ...
        (n.prototype.deleteRow = function (e, t) {
        ...
        (n.prototype.addRow = function (e, t, o, i) {
        ...
        (n.prototype.addRows = function (e, t, o) {
            var i = this,
                n = this,
                s = 0,
                r = [];
        ...
        (n.prototype.findAddRowPos = function (e) {
            return void 0 === e && (e = this.table.options.addRowPos), "pos" === e && (e = !0), "bottom" === e && (e = !1), e;
        }),
        (n.prototype.addRowActual = function (e, t, o, i) {
            var n,
                s,
            ...
            if (
                (!o &&
                    ...
                    l ? (s.length ? (o = s[0]) : this.activeRows.length && ((o = this.activeRows[this.activeRows.length - 1]), (l = !1))) : s.length && ((o = s[s.length - 1]), (l = !(s.length < this.table.modules.page.getPageSize())))),
        ...
        (n.prototype.moveRow = function (e, t, o) {
            this.table.options.history && this.table.modExists("history") && this.table.modules.history.action("rowMove", e, { posFrom: this.getRowPosition(e), posTo: this.getRowPosition(t), to: t, after: o }),
                this.moveRowActual(e, t, o),
                this.regenerateRowNumbers(),
                this.table.options.rowMoved.call(this.table, e.getComponent());
        }),
        (n.prototype.moveRowActual = function (e, t, o) {
            var i = this;
            if (
                ...
                !o && t instanceof T && (t = this.table.rowManager.prevDisplayRow(e) || t);
                var n = t.getGroup(),
                    s = e.getGroup();
                n === s ? this._moveRowInArray(n.rows, e, t, o) : (s && s.removeRow(e), n.insertRow(e, t, o));
            }
        }),
        (n.prototype._moveRowInArray = function (e, t, o, i) {
            var n, s, r, a;
            if (t !== o && ((n = e.indexOf(t)), n > -1 && (e.splice(n, 1), (s = e.indexOf(o)), s > -1 ? (i ? e.splice(s + 1, 0, t) : e.splice(s, 0, t)) : e.splice(n, 0, t)), e === this.getDisplayRows())) {
                ...
                for (var l = r; l <= a; l++) e[l] && this.styleRow(e[l], l);
            }
        }),
        (n.prototype.clearData = function () {
            this.setData([]);
        }),
        (n.prototype.getRowIndex = function (e) {
            return this.findRowIndex(e, this.rows);
        }),
        (n.prototype.getDisplayRowIndex = function (e) {
            var t = this.getDisplayRows().indexOf(e);
            return t > -1 && t;
        }),
        (n.prototype.nextDisplayRow = function (e, t) {
        ...
        (n.prototype.sorterRefresh = function (e) {
            var t = this.table,
        ...
        (n.prototype.scrollHorizontal = function (e) {
        ...
        (n.prototype.refreshActiveData = function (e, t, o) {
            var i,
                n = this,
                s = this.table,
                r = ["all", "filter", "sort", "display", "freeze", "group", "tree", "page"];
            if (this.redrawBlock) return void ((!this.redrawBlockRestoreConfig || r.indexOf(e) < r.indexOf(this.redrawBlockRestoreConfig.stage)) && (this.redrawBlockRestoreConfig = { stage: e, skipStage: t, renderInPosition: o }));
            ...
            u.prototype.helpers.elVisible(n.element) && (o ? n.reRenderInPosition() : (n.renderTable(), s.options.layoutColumnsOnNewData && n.table.columnManager.redraw(!0))),
                s.modExists("columnCalcs") && s.modules.columnCalcs.recalc(this.activeRows);
        }),
        (n.prototype.regenerateRowNumbers = function () {
            var e = this;
            this.rowNumColumn &&
        ...
        (n.prototype.setActiveRows = function (e) {
        ...
        (n.prototype.setDisplayRows = function (e, t) {
            var o = !0;
            return (
        ...
        (n.prototype.getVisibleRows = function (e) {
            ...
            if (e) {
                ...
                for (var a = this.vDomTop; a <= this.vDomBottom; a++)
                    if (r[a])
                        if (i) {
                            if (!(o - r[a].getElement().offsetTop >= 0)) break;
                            s = a;
                        } else if (t - r[a].getElement().offsetTop >= 0) n = a;
                        else {
                            if (((i = !0), !(o - r[a].getElement().offsetTop >= 0))) break;
                            s = a;
                        }
            } else (n = this.vDomTop), (s = this.vDomBottom);
            return r.slice(n, s + 1);
        }),
        (n.prototype.displayRowIterator = function (e) {
        ...
        (n.prototype.reRenderInPosition = function (e) {
        ...
        (n.prototype.styleRow = function (e, t) {
            var o = e.getElement();
        ...
        (n.prototype._virtualRenderFill = function (e, t, o) {
            var i = this,
                n = i.tableElement,
                s = i.element,
                r = 0,
            ...
            if (i.displayRowsCount && u.prototype.helpers.elVisible(i.element)) {
                ...
                e
                    ? ((i.vDomTopPad = t ? i.vDomRowHeight * this.vDomTop + o : i.scrollTop - l), (i.vDomBottomPad = i.vDomBottom == i.displayRowsCount - 1 ? 0 : Math.max(i.vDomScrollHeight - i.vDomTopPad - a - l, 0)))
                    : ((this.vDomTopPad = 0), (i.vDomRowHeight = Math.floor((a + l) / c)), (i.vDomBottomPad = i.vDomRowHeight * (i.displayRowsCount - i.vDomBottom - 1)), (i.vDomScrollHeight = l + a + i.vDomBottomPad - i.height)),
                    ...
                    (n.style.minWidth = d ? i.table.columnManager.getWidth() + "px" : ""),
        ...
        (n.prototype.scrollVertical = function (e) {
        ...
        (n.prototype._addTopRow = function (e) {
        ...
        (n.prototype._removeTopRow = function (e) {
        ...
        (n.prototype._addBottomRow = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                o = this.tableElement,
                i = this.getDisplayRows();
        ...
        (n.prototype._removeBottomRow = function (e) {
            var t = this.tableElement,
        ...
        (n.prototype._quickNormalizeRowHeight = function (e) {
            e.forEach(function (e) {
                e.calcHeight();
            }),
                e.forEach(function (e) {
    ...
    (s.prototype.getData = function (e) {
        ...
        (s.prototype.getCell = function (e) {
        ...
        (r.prototype.delete = function () {
            ...
            return new Promise(function (t, o) {
                ...
                e.table.options.history &&
                    ...
                    (e.table.options.groupBy && e.table.modExists("groupRows") ? ((n = e.getGroup().rows), (i = n.indexOf(e)) && (i = n[i - 1])) : (i = e.table.rowManager.getRowIndex(e)) && (i = e.table.rowManager.rows[i - 1]),
        ...
        (r.prototype.deleteActual = function (e) {
            ...
            this.table.modExists("selectRow") && this.table.modules.selectRow._deselectRow(this, !0),
                ...
                this.table.modExists("columnCalcs") &&
                    (this.table.options.groupBy && this.table.modExists("groupRows") ? this.table.modules.columnCalcs.recalcRowGroup(this) : this.table.modules.columnCalcs.recalc(this.table.rowManager.activeRows));
        }),
    ...
    (a.prototype.getValue = function () {
        ...
        (a.prototype.getOldValue = function () {
        ...
        (a.prototype.restoreOldValue = function () {
            this._cell.setValueActual(this._cell.getOldValue());
        }),
        (a.prototype.edit = function (e) {
            return this._cell.edit(e);
        }),
        (a.prototype.cancelEdit = function () {
            this._cell.cancelEdit();
        }),
        (a.prototype.nav = function () {
            return this._cell.nav();
        }),
        (a.prototype.checkHeight = function () {
    ...
    var l = function (e, t) {
        (this.table = e.table), (this.column = e), (this.row = t), (this.element = null), (this.value = null), (this.oldValue = null), (this.modules = {}), (this.height = null), (this.width = null), (this.minWidth = null), this.build();
    };
    (l.prototype.build = function () {
        ...
        (l.prototype._bindClickEvents = function (e) {
            var t = this,
                o = t.element;
        ...
        (l.prototype._bindMouseEvents = function (e) {
            var t = this,
                o = t.element;
        ...
        (l.prototype._bindTouchEvents = function (e) {
            var t,
                o,
                i,
                n = this,
        ...
        (l.prototype.setValueProcessData = function (e, t) {
            var o = !1;
            return (
        ...
        (l.prototype.setValueActual = function (e) {
        ...
        (l.prototype.delete = function () {
            this.table.rowManager.redrawBlock || this.element.parentNode.removeChild(this.element), (this.element = !1), this.column.deleteCell(this), this.row.deleteCell(this), (this.calcs = {});
        }),
    ...
    (c.prototype.createElement = function () {
        ...
        (c.prototype._initialize = function (e) {
        ...
        (c.prototype.deactivate = function (e) {
    ...
    (u.prototype.defaultOptions = {
        ...
        (u.prototype.initializeOptions = function (e) {
        ...
        (u.prototype.initializeElement = function (e) {
        ...
        (u.prototype._mapDepricatedFunctionality = function () {
            (this.options.persistentLayout || this.options.persistentSort || this.options.persistentFilter) && (this.options.persistence || (this.options.persistence = {})),
                ...
                !0 !== this.options.printVisibleRows && (console.warn("printVisibleRows option is deprecated, you should now use the printRowRange option"), (this.options.persistence.printRowRange = "active")),
                !0 !== this.options.printCopyStyle && (console.warn("printCopyStyle option is deprecated, you should now use the printStyled option"), (this.options.persistence.printStyled = this.options.printCopyStyle)),
                ...
                this.options.persistentSort &&
                    (console.warn("persistentSort option is deprecated, you should now use the persistence option"), !0 !== this.options.persistence && void 0 === this.options.persistence.sort && (this.options.persistence.sort = !0)),
                this.options.persistentFilter &&
                    (console.warn("persistentFilter option is deprecated, you should now use the persistence option"), !0 !== this.options.persistence && void 0 === this.options.persistence.filter && (this.options.persistence.filter = !0)),
                this.options.columnVertAlign && (console.warn("columnVertAlign option is deprecated, you should now use the columnHeaderVertAlign option"), (this.options.columnHeaderVertAlign = this.options.columnVertAlign));
        }),
        ...
        (u.prototype._create = function () {
            this._clearObjectPointers(),
                ...
                (this.rowManager = new n(this)),
                (this.footerManager = new c(this)),
        ...
        (u.prototype.destroy = function () {
            var e = this.element;
            for (
                u.prototype.comms.deregister(this),
        ...
        (u.prototype.setDataFromLocalFile = function (e) {
            var t = this;
            return new Promise(function (o, i) {
                var n = document.createElement("input");
                (n.type = "file"),
        ...
        (u.prototype._setData = function (e, t, o, i, n) {
            var s = this;
        ...
        (u.prototype.replaceData = function (e, t, o) {
        ...
        (u.prototype.addData = function (e, t, o) {
            var i = this;
            return new Promise(function (n, s) {
        ...
        (u.prototype.updateOrAddData = function (e) {
            var t = this,
                o = this,
                i = [],
                n = 0;
        ...
        (u.prototype.deleteRow = function (e) {
            var t = this;
            return new Promise(function (o, i) {
                function n() {
        ...
        (u.prototype.addRow = function (e, t, o) {
            var i = this;
            return new Promise(function (n, s) {
                "string" == typeof e && (e = JSON.parse(e)),
                    i.rowManager.addRows(e, t, o).then(function (e) {
        ...
        (u.prototype.updateOrAddRow = function (e, t) {
            var o = this;
        ...
        (u.prototype.updateRow = function (e, t) {
            var o = this;
            return new Promise(function (i, n) {
                var s = o.rowManager.findRow(e);
                "string" == typeof t && (t = JSON.parse(t)),
        ...
        (u.prototype.copyToClipboard = function (e) {
            this.modExists("clipboard", !0) && this.modules.clipboard.copy(e);
        }),
        (u.prototype.setColumns = function (e) {
            this.columnManager.setColumns(e);
        }),
        (u.prototype.getColumns = function (e) {
            return this.columnManager.getComponents(e);
        }),
        (u.prototype.getColumn = function (e) {
        ...
        (u.prototype.setColumnLayout = function (e) {
        ...
        (u.prototype.showColumn = function (e) {
            var t = this.columnManager.findColumn(e);
        ...
        (u.prototype.hideColumn = function (e) {
            var t = this.columnManager.findColumn(e);
        ...
        (u.prototype.deleteColumn = function (e) {
            var t = this;
            return new Promise(function (o, i) {
        ...
        (u.prototype.updateColumnDefinition = function (e, t) {
            var o = this;
            return new Promise(function (i, n) {
        ...
        (u.prototype.moveColumn = function (e, t, o) {
        ...
        (u.prototype.scrollToColumn = function (e, t, o) {
            var i = this;
            return new Promise(function (n, s) {
                var r = i.columnManager.findColumn(e);
                r
                    ? i.columnManager
                          .scrollToColumn(r, t, o)
                          .then(function () {
                              n();
                          })
                          .catch(function (e) {
        ...
        (u.prototype.getLang = function (e) {
        ...
        (u.prototype.setSort = function (e, t) {
        ...
        (u.prototype.setFilter = function (e, t, o) {
            this.modExists("filter", !0) && (this.modules.filter.setFilter(e, t, o), this.rowManager.filterRefresh());
        }),
        (u.prototype.addFilter = function (e, t, o) {
            this.modExists("filter", !0) && (this.modules.filter.addFilter(e, t, o), this.rowManager.filterRefresh());
        }),
        (u.prototype.getFilters = function (e) {
            if (this.modExists("filter", !0)) return this.modules.filter.getFilters(e);
        }),
        (u.prototype.setHeaderFilterFocus = function (e) {
        ...
        (u.prototype.getHeaderFilterValue = function (e) {
            if (this.modExists("filter", !0)) {
                var t = this.columnManager.findColumn(e);
        ...
        (u.prototype.setHeaderFilterValue = function (e, t) {
            if (this.modExists("filter", !0)) {
        ...
        (u.prototype.selectRow = function (e) {
            this.modExists("selectRow", !0) &&
                (!0 === e && (console.warn("passing a boolean to the selectRowselectRow function is deprecated, you should now pass the string 'active'"), (e = "active")), this.modules.selectRow.selectRows(e));
        }),
        (u.prototype.deselectRow = function (e) {
            this.modExists("selectRow", !0) && this.modules.selectRow.deselectRows(e);
        }),
        (u.prototype.toggleSelectRow = function (e) {
        ...
        (u.prototype.setGroupBy = function (e) {
        ...
        (u.prototype.setGroupStartOpen = function (e) {
            if (!this.modExists("groupRows", !0)) return !1;
            (this.options.groupStartOpen = e),
                this.modules.groupRows.initialize(),
                this.options.groupBy
                    ? (this.rowManager.refreshActiveData("group"), this.options.persistence && this.modExists("persistence", !0) && this.modules.persistence.config.group && this.modules.persistence.save("group"))
                    : console.warn("Grouping Update - cant refresh view, no groups have been set");
        }),
        (u.prototype.setGroupHeader = function (e) {
            if (!this.modExists("groupRows", !0)) return !1;
        ...
        (u.prototype.getGroups = function (e) {
        ...
        (u.prototype.download = function (e, t, o, i) {
            this.modExists("download", !0) && this.modules.download.download(e, t, o, i);
        }),
        (u.prototype.downloadToTab = function (e, t, o, i) {
            this.modExists("download", !0) && this.modules.download.download(e, t, o, i, !0);
        }),
        (u.prototype.tableComms = function (e, t, o, i) {
            this.modules.comms.receive(e, t, o, i);
        }),
        (u.prototype.moduleBindings = {}),
        (u.prototype.extendModule = function (e, t, o) {
            if (u.prototype.moduleBindings[e]) {
                var i = u.prototype.moduleBindings[e].prototype[t];
                if (i)
        ...
        (u.prototype.registerModule = function (e, t) {
            u.prototype.moduleBindings[e] = t;
        }),
        (u.prototype.bindModules = function () {
            this.modules = {};
            for (var e in u.prototype.moduleBindings) this.modules[e] = new u.prototype.moduleBindings[e](this);
        }),
        (u.prototype.modExists = function (e, t) {
        ...
        (u.prototype.comms = {
            tables: [],
            register: function (e) {
                u.prototype.comms.tables.push(e);
            },
            deregister: function (e) {
                var t = u.prototype.comms.tables.indexOf(e);
                t > -1 && u.prototype.comms.tables.splice(t, 1);
            },
            lookupTable: function (e, t) {
                var o,
                    ...
                    n = [];
                if ("string" == typeof e) {
                    if (((o = document.querySelectorAll(e)), o.length)) for (var s = 0; s < o.length; s++) (i = u.prototype.comms.matchElement(o[s])) && n.push(i);
                } else
                    ("undefined" != typeof HTMLElement && e instanceof HTMLElement) || e instanceof u
                        ? (i = u.prototype.comms.matchElement(e)) && n.push(i)
                        : Array.isArray(e)
                        ? e.forEach(function (e) {
                              n = n.concat(u.prototype.comms.lookupTable(e));
                          })
                        : t || console.warn("Table Connection Error - Invalid Selector", e);
                return n;
            },
            matchElement: function (e) {
                return u.prototype.comms.tables.find(function (t) {
                    return e instanceof u ? t === e : t.element === e;
                });
            },
        }),
        (u.prototype.findTable = function (e) {
            var t = u.prototype.comms.lookupTable(e, !0);
                    ...
                    e.forEach(function (e) {
                        ...
                        e.visible &&
                            ...
                            o
                                ...
                                : (c.push({ column: e, width: 0 }), (a += e.definition.widthGrow || 1)));
                    }),
                    (r = n - s),
                    (l = Math.floor(r / a));
                var p = o(c, r, l, !1);
    ...
    (h.prototype.setHeaderFilterPlaceholder = function (e) {
        this.langs.default.headerFilters.default = e;
    }),
        (h.prototype.setHeaderFilterColumnPlaceholder = function (e, t) {
        ...
        (h.prototype.installLang = function (e, t) {
            this.langs[e] ? this._setLangProp(this.langs[e], t) : (this.langs[e] = t);
        }),
        (h.prototype._setLangProp = function (e, t) {
        ...
        (h.prototype.setLocale = function (e) {
            ...
            (o.locale = e), (o.lang = u.prototype.helpers.deepClone(o.langs.default || {})), "default" != e && t(o.langs[e], o.lang), o.table.options.localized.call(o.table, o.locale, o.lang), o._executeBindings();
        }),
        (h.prototype.getLocale = function (e) {
            return self.locale;
        }),
        (h.prototype.getLang = function (e) {
            return e ? this.langs[e] : this.lang;
        }),
        (h.prototype.getText = function (e, t) {
            var e = t ? e + "|" + t : e,
                o = e.split("|");
            return this._getLangElement(o, this.locale) || "";
        }),
        (h.prototype._getLangElement = function (e, t) {
            var o = this,
                i = o.lang;
            return (
                e.forEach(function (e) {
        ...
        (h.prototype.langs = {
            default: {
                ...
                pagination: { page_size: "Page Size", first: "First", first_title: "First Page", last: "Last", last_title: "Last Page", prev: "Prev", prev_title: "Prev Page", next: "Next", next_title: "Next Page" },
    ...
    (p.prototype.getConnections = function (e) {
        var t,
            o = this,
            i = [];
        return (
            (t = u.prototype.comms.lookupTable(e)),
        ...
        (p.prototype.send = function (e, t, o, i) {
            var n = this,
        ...
        (p.prototype.receive = function (e, t, o, i) {
    ...
    (m.prototype.initializeColumn = function (e) {
        var t = this,
            o = !1,
            i = {};
        this.allowedTypes.forEach(function (n) {
            ...
            e.definition[r] && (s = t.lookupAccessor(e.definition[r])) && ((o = !0), (i[r] = { accessor: s, params: e.definition[r + "Params"] || {} }));
        }),
            o && (e.modules.accessor = i);
    }),
        (m.prototype.lookupAccessor = function (e) {
            var t = !1;
        ...
        (m.prototype.transformRow = function (e, t) {
            var o = this,
                i = "accessor" + (t.charAt(0).toUpperCase() + t.slice(1)),
                n = u.prototype.helpers.deepClone(e || {});
            return (
                o.table.columnManager.traverse(function (e) {
                    ...
                    e.modules.accessor &&
                        ...
                        ((a = e.getComponent()), (r = "function" == typeof s.params ? s.params(o, n, t, a) : s.params), e.setFieldValue(n, s.accessor(o, n, t, r, a)));
                }),
                n
            );
        }),
        (m.prototype.accessors = {}),
        u.prototype.registerModule("accessor", m);
    var f = function (e) {
        (this.table = e),
            (this.config = !1),
            (this.url = ""),
    ...
    (f.prototype.initialize = function () {
        ...
        (f.prototype.setParams = function (e, t) {
            if (t) {
        ...
        (f.prototype.nextPage = function (e) {
            var t;
            this.loading ||
        ...
        (f.prototype._loadDataStandard = function (e, t) {
            var o = this;
            return new Promise(function (i, n) {
                o.sendRequest(e)
                    .then(function (s) {
        ...
        (f.prototype.generateParamsList = function (e, t) {
            var o = this,
                i = [];
        ...
        (f.prototype.serializeParams = function (e) {
        ...
        (f.prototype.sendRequest = function (e) {
            var t,
                o = this,
                i = this,
                n = i.url;
        ...
        (f.prototype.defaultConfig = { method: "GET" }),
        (f.prototype.defaultURLGenerator = function (e, t, o) {
            return e && o && Object.keys(o).length && ((t.method && "get" != t.method.toLowerCase()) || ((t.method = "get"), (e += (e.includes("?") ? "&" : "?") + this.serializeParams(o)))), e;
        }),
        (f.prototype.defaultLoaderPromise = function (e, t, o) {
            var i,
                n = this;
            return new Promise(function (s, r) {
                if (((e = n.urlGenerator(e, t, o)), "GET" != t.method.toUpperCase()))
                    if ((i = "object" === _typeof(n.table.options.ajaxContentType) ? n.table.options.ajaxContentType : n.contentTypeFormatters[n.table.options.ajaxContentType])) {
                        for (var a in i.headers) t.headers || (t.headers = {}), void 0 === t.headers[a] && (t.headers[a] = i.headers[a]);
                ...
                e
                    ? (void 0 === t.headers && (t.headers = {}),
                      ...
                      "cors" == t.mode
                          ? (void 0 === t.headers["Access-Control-Allow-Origin"] && (t.headers["Access-Control-Allow-Origin"] = window.location.origin), void 0 === t.credentials && (t.credentials = "same-origin"))
    ...
    (g.prototype.createElement = function () {
        ...
        (g.prototype.initialize = function () {
            this.genColumn = new i({ field: "value" }, this);
        }),
        (g.prototype.registerColumnField = function () {}),
        ...
        (g.prototype.scrollHorizontal = function (e) {
        ...
        (g.prototype.recalcRowGroup = function (e) {
            this.recalcGroup(this.table.modules.groupRows.getRowGroup(e));
        }),
        (g.prototype.recalcAll = function () {
            var e = this;
        ...
        (g.prototype.recalcGroup = function (e) {
            var t, o;
            e &&
                e.calcs &&
        ...
        (g.prototype.generateTopRow = function (e) {
            return this.generateRow("top", this.rowsToData(e));
        }),
        (g.prototype.generateBottomRow = function (e) {
            return this.generateRow("bottom", this.rowsToData(e));
        }),
        (g.prototype.rowsToData = function (e) {
            var t = this,
                o = [];
            return (
                e.forEach(function (e) {
        ...
        (g.prototype.generateRow = function (e, t) {
            var o,
                i = this,
        ...
        (g.prototype.generateRowData = function (e, t) {
            var o,
                i,
                n = {},
            ...
            return (
                s.forEach(function (e) {
                    ...
                    e.modules.columnCalcs &&
                        ...
                        e.setFieldValue(n, e.modules.columnCalcs[r](s, t, o)));
                }),
                n
            );
        }),
        ...
        (g.prototype.getGroupResults = function (e) {
            var t = this,
                o = e._getSelf(),
                i = e.getSubGroups(),
                n = {};
    ...
    (b.prototype.initialize = function () {
                ...
                this.table.element.addEventListener("copy", function (t) {
                    ...
                    e.blocked ||
                        ...
                        e.customSelection
                            ...
                            : ((i = e.table.modules.export.getHtml(e.rowRange, e.table.options.clipboardCopyStyled, e.table.options.clipboardCopyConfig, "clipboard")),
                              (o = i ? e.generatePlainContent(i) : ""),
        ...
        (b.prototype.generatePlainContent = function (e) {
            var t = [],
                o = document.createElement("div");
            o.innerHTML = e;
            var i = o.getElementsByTagName("table")[0];
            return (
                Array.prototype.slice.call(i.getElementsByTagName("tr")).forEach(function (e) {
                    var o = [],
                        i = Array.prototype.slice.call(e.getElementsByTagName("th")),
                        n = Array.prototype.slice.call(e.getElementsByTagName("td"));
                    (n = n.concat(i)),
                        n.forEach(function (e) {
                            var t = e.innerHTML;
                            (t = "&nbsp;" == t ? "" : t), o.push(t);
            ...
            (this.blocked = !1),
                ...
                (!0 !== this.mode && "copy" !== this.mode) ||
                    ...
                    void 0 !== window.getSelection && void 0 !== document.createRange
                        ? ((e = document.createRange()), e.selectNodeContents(this.table.element), (o = window.getSelection()), o.toString() && t && (this.customSelection = o.toString()), o.removeAllRanges(), o.addRange(e))
        ...
        (b.prototype.setPasteAction = function (e) {
            switch (void 0 === e ? "undefined" : _typeof(e)) {
                case "string":
        ...
        (b.prototype.setPasteParser = function (e) {
            switch (void 0 === e ? "undefined" : _typeof(e)) {
                case "string":
        ...
        (b.prototype.mutateData = function (e) {
            var t = this,
                o = [];
            return (
                Array.isArray(e)
        ...
        (b.prototype.checkPaseOrigin = function (e) {
            var t = !0;
            return ("DIV" != e.target.tagName || this.table.modules.edit.currentCell) && (t = !1), t;
        }),
        (b.prototype.getPasteData = function (e) {
            var t;
            return (
    ...
    (v.prototype.initialize = function () {
        ...
        (v.prototype.layoutRow = function (e) {
        ...
        (v.prototype.generateControlElement = function (e, t) {
            var o = this,
                i = e.modules.dataTree,
        ...
        (v.prototype.getChildren = function (e) {
            var t = this,
        ...
        (v.prototype.generateChildren = function (e) {
            var t = this,
                o = [],
        ...
        (v.prototype.expandRow = function (e, t) {
        ...
        (v.prototype.collapseRow = function (e) {
        ...
        (v.prototype.getTreeChildren = function (e) {
            var t = e.modules.dataTree,
                o = [];
            return (
                t.children &&
        ...
        (v.prototype.checkForRestyle = function (e) {
            e.row.cells.indexOf(e) || e.row.reinitialize();
        }),
        (v.prototype.getChildField = function () {
            return this.field;
        }),
        (v.prototype.redrawNeeded = function (e) {
            return (!!this.field && void 0 !== e[this.field]) || (!!this.elementField && void 0 !== e[this.elementField]);
        }),
        u.prototype.registerModule("dataTree", v);
    var y = function (e) {
        (this.table = e), (this.fields = {}), (this.columnsByIndex = []), (this.columnsByField = {}), (this.config = {}), (this.active = !1);
    };
    (y.prototype.download = function (e, t, o, i, n) {
        function s(o, i) {
        ...
        this.processConfig(),
            (this.active = i),
            "function" == typeof e ? (a = e) : r.downloaders[e] ? (a = r.downloaders[e]) : console.warn("Download Error - No such download type found: ", e),
            this.processColumns(),
            a && a.call(this, r.processDefinitions(), r.processData(i || "active"), o || {}, s, this.config);
    }),
        (y.prototype.processConfig = function () {
            var e = { columnGroups: !0, rowGroups: !0, columnCalcs: !0, dataTree: !0 };
            if (this.table.options.downloadConfig) for (var t in this.table.options.downloadConfig) e[t] = this.table.options.downloadConfig[t];
            (this.config.rowGroups = e.rowGroups && this.table.options.groupBy && this.table.modExists("groupRows")),
                e.columnGroups && this.table.columnManager.columns.length != this.table.columnManager.columnsByIndex.length && (this.config.columnGroups = !0),
                e.columnCalcs && this.table.modExists("columnCalcs") && (this.config.columnCalcs = !0),
                e.dataTree && this.table.options.dataTree && this.table.modExists("dataTree") && (this.config.dataTree = !0);
        }),
        (y.prototype.processColumns = function () {
            var e = this;
            (e.columnsByIndex = []),
                (e.columnsByField = {}),
                e.table.columnManager.columnsByIndex.forEach(function (t) {
                    t.field && !1 !== t.definition.download && (t.visible || (!t.visible && t.definition.download)) && (e.columnsByIndex.push(t), (e.columnsByField[t.field] = t));
                });
        }),
        (y.prototype.processDefinitions = function () {
            ...
            return (
                this.config.columnGroups
                    ? e.table.columnManager.columns.forEach(function (o) {
                          var i = e.processColumnGroup(o);
                          i && t.push(i);
                      })
                    : e.columnsByIndex.forEach(function (o) {
                          !1 !== o.download && t.push(e.processDefinition(o));
                      }),
                t
            );
        }),
        (y.prototype.processColumnGroup = function (e) {
            var t = this,
                o = e.columns,
                i = 0,
                n = this.processDefinition(e),
                s = { type: "group", title: n.title, depth: 1 };
            if (o.length) {
                if (
                    ((s.subGroups = []),
                    (s.width = 0),
                    o.forEach(function (e) {
                        ...
                        o.depth > i && (i = o.depth), o && ((s.width += o.width), s.subGroups.push(o));
                    }),
                    (s.depth += i),
                    !s.width)
                )
                ...
                if (!e.field || !1 === e.definition.download || !(e.visible || (!e.visible && e.definition.download))) return !1;
                (s.width = 1), (s.definition = n);
            }
            return s;
        }),
        (y.prototype.processDefinition = function (e) {
            var t = {};
            for (var o in e.definition) t[o] = e.definition[o];
            return void 0 !== e.definition.downloadTitle && (t.title = e.definition.downloadTitle), t;
        }),
        (y.prototype.processData = function (e) {
            var t = this,
                o = this,
                i = [],
                n = [],
            ...
            return (
                this.config.rowGroups
                    ? ("visible" == e
                          ? ((s = o.table.rowManager.getRows(e)),
                            s.forEach(function (e) {
                                if ("row" == e.type) {
                                    var t = e.getGroup();
                          ...
                          : (n = this.table.modules.groupRows.getGroups()),
                      n.forEach(function (e) {
                          i.push(t.processGroupData(e, s));
                      }))
                    : (this.config.dataTree && (e = e = "display"), (i = o.table.rowManager.getData(e, "download"))),
                this.config.columnCalcs && ((r = this.table.getCalcResults()), (i = { calcs: r, data: i })),
                "function" == typeof o.table.options.downloadDataFormatter && (i = o.table.options.downloadDataFormatter(i)),
                i
            );
        }),
        (y.prototype.processGroupData = function (e, t) {
            var o = this,
                i = e.getSubGroups(),
                n = { type: "group", key: e.key };
            return (
                i.length
                    ? ((n.subGroups = []),
                      i.forEach(function (e) {
                          n.subGroups.push(o.processGroupData(e, t));
                      }))
                    : t
                    ? ((n.rows = []),
                      e.rows.forEach(function (e) {
                          t.indexOf(e) > -1 && n.rows.push(e.getData("download"));
                      }))
                    : (n.rows = e.getData(!0, "download")),
                n
            );
        }),
        (y.prototype.triggerDownload = function (e, t, o, i, n) {
            var s = document.createElement("a"),
                r = new Blob([e], { type: t }),
                i = i || "Tabulator." + ("function" == typeof o ? "txt" : o);
            (r = this.table.options.downloadReady.call(this.table, e, r)) &&
                (n
                    ? window.open(window.URL.createObjectURL(r))
                    : navigator.msSaveOrOpenBlob
                    ? navigator.msSaveOrOpenBlob(r, i)
                    : (s.setAttribute("href", window.URL.createObjectURL(r)), s.setAttribute("download", i), (s.style.display = "none"), document.body.appendChild(s), s.click(), document.body.removeChild(s)),
                this.table.options.downloadComplete && this.table.options.downloadComplete());
        }),
        (y.prototype.getFieldValue = function (e, t) {
            var o = this.columnsByField[e];
            return !!o && o.getFieldValue(t);
        }),
        (y.prototype.commsReceived = function (e, t, o) {
            switch (t) {
                case "intercept":
        ...
        (y.prototype.downloaders = {
            csv: function (e, t, o, i, n) {
                function s(e, t) {
                    e.subGroups
                        ? e.subGroups.forEach(function (e) {
                              s(e, t + 1);
                          })
                        : (d.push('"' + String(e.title).split('"').join('""') + '"'), h.push(e.definition.field));
                }
                function r(e) {
                    e.forEach(function (e) {
                        var t = [];
                        h.forEach(function (o) {
                            var i = u.getFieldValue(o, e);
                ...
                n.columnGroups
                    ...
                    : (function () {
                          e.forEach(function (e) {
                              d.push('"' + String(e.title).split('"').join('""') + '"'), h.push(e.field);
                          });
                      })(),
                    (l = [d.join(p)]),
                    n.columnCalcs && (console.warn("Download Warning - CSV downloader cannot process column calculations"), (t = t.data)),
                    n.rowGroups
            ...
            json: function (e, t, o, i, n) {
                var s;
                n.columnCalcs && (console.warn("Download Warning - CSV downloader cannot process column calculations"), (t = t.data)), (s = JSON.stringify(t, null, "\t")), i(s, "application/json");
            },
            pdf: function (e, t, o, i, n) {
                function s(e, t) {
                    var o = e.width,
                        i = 1,
                        n = { content: e.title || "" };
                    if (
                        (e.subGroups
                            ? (e.subGroups.forEach(function (e) {
                              ...
                              (i = 1))
                            : (h.push(e.definition.field), (i = g - t)),
                        (n.rowSpan = i),
                        p[t].push(n),
                        o--,
                        i > 1)
                    )
                        for (var r = t + 1; r < g; r++) p[r].push("");
                    for (var r = 0; r < o; r++) p[t].push("");
                }
                function r(e) {
                    switch (void 0 === e ? "undefined" : _typeof(e)) {
                        case "object":
                ...
                function l(e, t) {
                    ...
                    return (
                        h.forEach(function (i) {
                            var n = d.getFieldValue(i, e);
                            (n = r(n)), t ? o.push({ content: n, styles: t }) : o.push(n);
                        }),
                        o
                    );
                }
                function c(e, t) {
                    var o = [];
                    o.push({ content: r(e.key), colSpan: h.length, styles: v }),
                        m.push(o),
                        e.subGroups
                            ? e.subGroups.forEach(function (o) {
                                  c(o, t[e.key] ? t[e.key].groups || {} : {});
                              })
                            : (n.columnCalcs && u(t, e.key, "top"), a(e.rows), n.columnCalcs && u(t, e.key, "bottom"));
                }
                function u(e, t, o) {
                    var i = e[t];
                ...
                var d = this,
                    ...
                    g = 1,
                    b = {},
                    v = o.rowGroupStyles || { fontStyle: "bold", fontSize: 12, cellPadding: 6, fillColor: 220 },
                    y = o.rowCalcStyles || { fontStyle: "bold", fontSize: 10, cellPadding: 4, fillColor: 232 },
                    w = o.jsPDF || {},
                    E = o && o.title ? o.title : "";
                if ((n.columnCalcs && ((f = t.calcs), (t = t.data)), w.orientation || (w.orientation = o.orientation || "landscape"), w.unit || (w.unit = "pt"), n.columnGroups)) {
                    e.forEach(function (e) {
                        e.depth > g && (g = e.depth);
                    });
                    ...
                    !(function () {
                        e.forEach(function (e) {
                            e.field && (p.push(e.title || ""), h.push(e.field));
                        }),
                            (p = [p]);
                    })();
                n.rowGroups
                    ...
                    : (n.columnCalcs && u(f, "top"), a(t), n.columnCalcs && u(f, "bottom"));
                var x = new jsPDF(w);
                o && o.autoTable && (b = "function" == typeof o.autoTable ? o.autoTable(x) || {} : o.autoTable),
                    E &&
                        (b.addPageContent = function (e) {
                            x.text(E, 40, 30);
                        }),
                    (b.head = p),
                    (b.body = m),
                    x.autoTable(b),
                    o && o.documentProcessing && o.documentProcessing(x),
                    i(x.output("arraybuffer"), "application/pdf");
            },
            xlsx: function (e, t, o, i, n) {
                function s() {
                    function o(e, t) {
                        void 0 === f[t] && (f[t] = []),
                            void 0 === h[t] && (h[t] = []),
                            e.width > 1 && h[t].push({ type: "hoz", start: f[t].length, end: f[t].length + e.width - 1 }),
                            f[t].push(e.title),
                            e.subGroups
                                ? e.subGroups.forEach(function (e) {
                                      o(e, t + 1);
                                  })
                                : (g.push(e.definition.field), i(g.length), h[t].push({ type: "vert", start: g.length - 1 }));
                    }
                    function i() {
                        var e = 0;
                        f.forEach(function (t) {
                            ...
                            f.forEach(function (t) {
                                var o = t.length;
                                if (o < e) for (var i = o; i < e; i++) t.push("");
                            });
                    }
                    function s() {
                        var e = [];
                        return (
                            d.forEach(function (t) {
                                e.push({ s: { r: t, c: 0 }, e: { r: t, c: g.length - 1 } });
                            }),
                            h.forEach(function (t, o) {
                                t.forEach(function (t) {
                                    "hoz" === t.type ? e.push({ s: { r: o, c: t.start }, e: { r: o, c: t.end } }) : o != f.length - 1 && e.push({ s: { r: o, c: t.start }, e: { r: f.length - 1, c: t.start } });
                                });
                            }),
                            e
                        );
                    ...
                    function l(e) {
                        ...
                        return (
                            g.forEach(function (o) {
                                var i = a.getFieldValue(o, e);
                                t.push(i instanceof Date || "object" !== (void 0 === i ? "undefined" : _typeof(i)) ? i : JSON.stringify(i));
                            }),
                            t
                        );
                    }
                    ...
                    function m(e, t) {
                        ...
                        o.push(e.key),
                            ...
                            e.subGroups
                                ? e.subGroups.forEach(function (o) {
                                      m(o, t[e.key] ? t[e.key].groups || {} : {});
                                  })
                                : (n.columnCalcs && c(t, e.key, "top"), r(e.rows), n.columnCalcs && c(t, e.key, "bottom"));
                    }
                    var f = [],
                        g = [],
                        b = [];
                    return (
                        ...
                        n.rowGroups
                            ...
                            : (n.columnCalcs && c(u, "top"), r(t), n.columnCalcs && c(u, "bottom")),
                        (function () {
                            var e = {},
                                t = { s: { c: 0, r: 0 }, e: { c: g.length, r: b.length } };
                            XLSX.utils.sheet_add_aoa(e, b), (e["!ref"] = XLSX.utils.encode_range(t));
                            var o = s();
                            return o.length && (e["!merges"] = o), e;
                        })()
                    );
                }
                var r,
                    ...
                    h = [],
                    p = [];
                if (((c.SheetNames = []), (c.Sheets = {}), n.columnCalcs && ((u = t.calcs), (t = t.data)), o.sheetOnly)) return void i(s());
                if (o.sheets)
                    for (var m in o.sheets)
                        !0 === o.sheets[m]
                            ? (c.SheetNames.push(m), (c.Sheets[m] = s()))
                            : (c.SheetNames.push(m),
                              this.table.modules.comms.send(o.sheets[m], "download", "intercept", {
                                  type: "xlsx",
                                  options: { sheetOnly: !0 },
                                  active: a.active,
                ...
                o.documentProcessing && (c = o.documentProcessing(c)),
                    (r = XLSX.write(c, { bookType: "xlsx", bookSST: !0, type: "binary" })),
                    i(
                        (function (e) {
            ...
            html: function (e, t, o, i, n) {
                this.table.modExists("export", !0) && i(this.table.modules.export.getHtml(!0, o.style, n), "text/html");
            },
        }),
        u.prototype.registerModule("download", y);
    var w = function (e) {
        (this.table = e), (this.currentCell = !1), (this.mouseClick = !1), (this.recursionBlock = !1), (this.invalidEdit = !1);
    };
    (w.prototype.initializeColumn = function (e) {
            ...
            case "boolean":
                !0 === e.definition.editor &&
                    ("function" != typeof e.definition.formatter
                        ? ("tick" === e.definition.formatter && ((e.definition.formatter = "tickCross"), console.warn("DEPRECATION WARNING - the tick editor has been deprecated, please use the tickCross editor")),
        ...
        (w.prototype.clearEditor = function () {
            ...
            if (((this.invalidEdit = !1), t)) {
                for (this.currentCell = !1, e = t.getElement(), e.classList.remove("tabulator-validation-fail"), e.classList.remove("tabulator-editing"); e.firstChild; ) e.removeChild(e.firstChild);
                t.row.getElement().classList.remove("tabulator-row-editing");
            }
        }),
        ...
        (w.prototype.bindEditor = function (e) {
            var t = this,
                o = e.getElement();
        ...
        (w.prototype.edit = function (e, t, o) {
            function i(t) {
                if (c.currentCell === e) {
                    var o = !0;
                    return (
                        e.column.modules.validate && c.table.modExists("validate") && (o = c.table.modules.validate.validate(e.column.modules.validate, e.getComponent(), t)),
                        !0 === o
                            ? (c.clearEditor(), e.setValue(t, !0), c.table.options.dataTree && c.table.modExists("dataTree") && c.table.modules.dataTree.checkForRestyle(e), !0)
            ...
            if (u || o) {
                if (
                    ...
                    (a = e.getComponent()),
                    this.mouseClick && ((this.mouseClick = !1), e.column.cellEvents.cellClick && e.column.cellEvents.cellClick.call(this.table, t, a)),
                    e.column.cellEvents.cellEditing && e.column.cellEvents.cellEditing.call(this.table, a),
                    c.table.options.cellEditing.call(this.table, a),
                    (l = "function" == typeof e.column.modules.edit.params ? e.column.modules.edit.params(a) : e.column.modules.edit.params),
                    !1 === (r = e.column.modules.edit.editor.call(c, a, s, i, n, l)))
                )
                    return h.blur(), !1;
                if (!(r instanceof Node)) return console.warn("Edit Error - Editor should return an instance of Node, the editor returned:", r), h.blur(), !1;
        ...
        (w.prototype.maskInput = function (e, t) {
            function o(t) {
                var a = i[t];
            ...
            e.addEventListener("keydown", function (t) {
                var o = e.value.length,
                    l = t.key;
                if (t.keyCode > 46) {
                    if (o >= i.length) return t.preventDefault(), t.stopPropagation(), (a = !1), !1;
                    switch (i[o]) {
                        case n:
                            if (l.toUpperCase() == l.toLowerCase()) return t.preventDefault(), t.stopPropagation(), (a = !1), !1;
                            break;
                        case s:
                            if (isNaN(l)) return t.preventDefault(), t.stopPropagation(), (a = !1), !1;
                            break;
                        case r:
                            break;
                        default:
                            if (l !== i[o]) return t.preventDefault(), t.stopPropagation(), (a = !1), !1;
                    }
                    a = !0;
                }
            }),
        ...
        (w.prototype.editors = {
            input: function (e, t, o, i, n) {
                ...
                if ((a.setAttribute("type", n.search ? "search" : "text"), (a.style.padding = "4px"), (a.style.width = "100%"), (a.style.boxSizing = "border-box"), n.elementAttributes && "object" == _typeof(n.elementAttributes)))
                    for (var l in n.elementAttributes) "+" == l.charAt(0) ? ((l = l.slice(1)), a.setAttribute(l, a.getAttribute(l) + n.elementAttributes["+" + l])) : a.setAttribute(l, n.elementAttributes[l]);
                return (
                    (a.value = void 0 !== r ? r : ""),
                    t(function () {
            ...
            textarea: function (e, t, o, i, n) {
                function s(t) {
                    ((null === r || void 0 === r) && "" !== c.value) || c.value !== r
                        ? (o(c.value) && (r = c.value),
                          setTimeout(function () {
            ...
            select: function (e, t, o, i, n) {
                function s(t) {
                    var o,
                        ...
                        s = f.table.getData();
                    return (
                        (o = t ? f.table.columnManager.getColumnByField(t) : e.getColumn()._getSelf()),
                        o
                            ? (s.forEach(function (e) {
                ...
                function r(t, o) {
                    function i(e) {
                        var e = { label: n.listItemFormatter ? n.listItemFormatter(e.value, e.label) : e.label, value: e.value, element: !1 };
                        return (e.value !== o && (isNaN(parseFloat(e.value)) || isNaN(parseFloat(e.value)) || parseFloat(e.value) !== parseFloat(o))) || l(e), s.push(e), r.push(e), e;
                    }
                    var s = [],
                        r = [];
                    if (("function" == typeof t && (t = t(e)), Array.isArray(t)))
                        t.forEach(function (e) {
                            ...
                            "object" === (void 0 === e ? "undefined" : _typeof(e))
                                ? e.options
                                    ? ((t = { label: e.label, group: !0, element: !1 }),
                                      r.push(t),
                                      e.options.forEach(function (e) {
                                          i(e);
                                      }))
                                    : i(e)
                                : ((t = { label: n.listItemFormatter ? n.listItemFormatter(e, e) : e, value: e, element: !1 }),
                                  (t.value !== o && (isNaN(parseFloat(t.value)) || isNaN(parseFloat(t.value)) || parseFloat(t.value) !== parseFloat(o))) || l(t),
                                  s.push(t),
                                  r.push(t));
                        });
                    else
                        for (var c in t) {
                            var u = { label: n.listItemFormatter ? n.listItemFormatter(c, t[c]) : t[c], value: c, element: !1 };
                            (u.value !== o && (isNaN(parseFloat(u.value)) || isNaN(parseFloat(u.value)) || parseFloat(u.value) !== parseFloat(o))) || l(u), s.push(u), r.push(u);
                        }
                    (C = s), (x = r), a();
                }
                function a() {
                    ...
                    x.forEach(function (e) {
                        ...
                        t ||
                            (e.group
                                ? ((t = document.createElement("div")), t.classList.add("tabulator-edit-select-list-group"), (t.tabIndex = 0), (t.innerHTML = "" === e.label ? "&nbsp;" : e.label))
                                : ((t = document.createElement("div")),
                                  t.classList.add("tabulator-edit-select-list-item"),
                                  (t.tabIndex = 0),
                                  (t.innerHTML = "" === e.label ? "&nbsp;" : e.label),
                                  t.addEventListener("click", function () {
                                      l(e), c();
                                  }),
                                  e === R && t.classList.add("active")),
                ...
                function l(e) {
                    R && R.element && R.element.classList.remove("active"), (R = e), (w.value = "&nbsp;" === e.label ? "" : e.label), e.element && e.element.classList.add("active");
                }
                function c() {
                    p(), b !== R.value ? ((b = R.value), o(R.value)) : i();
                }
                function d() {
                    p(), i();
                }
                function h() {
                    if (!E.parentNode) {
                        !0 === n.values ? r(s(), y) : "string" == typeof n.values ? r(s(n.values), y) : r(n.values || [], y);
                        var e = u.prototype.helpers.elOffset(g);
                        (E.style.minWidth = g.offsetWidth + "px"),
                            (E.style.top = e.top + g.offsetHeight + "px"),
                ...
                function p() {
                    E.parentNode && E.parentNode.removeChild(E), m();
                }
                function m() {
                    f.table.rowManager.element.removeEventListener("scroll", d);
                }
                var f = this,
                    g = e.getElement(),
                    b = e.getValue(),
                    v = n.verticalNavigation || "editor",
                    y = void 0 !== b || null === b ? b : void 0 !== n.defaultValue ? n.defaultValue : "",
                    ...
                    M = !0;
                if (
                    (this.table.rowManager.element.addEventListener("scroll", d),
                    (Array.isArray(n) || (!Array.isArray(n) && "object" === (void 0 === n ? "undefined" : _typeof(n)) && !n.values)) &&
                        (console.warn("DEPRECATION WARNING - values for the select editor must now be passed into the values property of the editorParams object, not as the editorParams object"), (n = { values: n })),
                    w.setAttribute("type", "text"),
                    (w.style.padding = "4px"),
                    (w.style.width = "100%"),
                    (w.style.boxSizing = "border-box"),
                    (w.style.cursor = "default"),
                    (w.readOnly = 0 != this.currentCell),
                    n.elementAttributes && "object" == _typeof(n.elementAttributes))
                )
                    for (var L in n.elementAttributes) "+" == L.charAt(0) ? ((L = L.slice(1)), w.setAttribute(L, w.getAttribute(L) + n.elementAttributes["+" + L])) : w.setAttribute(L, n.elementAttributes[L]);
                return (
                    (w.value = void 0 !== b || null === b ? b : ""),
                    w.addEventListener("keydown", function (e) {
                        var t;
                        switch (e.keyCode) {
                            case 38:
                                (t = C.indexOf(R)), ("editor" == v || ("hybrid" == v && t)) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t > 0 && l(C[t - 1]));
                                break;
                            case 40:
                                (t = C.indexOf(R)), ("editor" == v || ("hybrid" == v && t < C.length - 1)) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t < C.length - 1 && l(-1 == t ? C[0] : C[t + 1]));
                                break;
                            case 37:
                            case 39:
                    ...
                    (E = document.createElement("div")),
                    E.classList.add("tabulator-edit-select-list"),
                    t(function () {
                        (w.style.height = "100%"), w.focus({ preventScroll: !0 });
                    }),
                    w
                );
            },
            autocomplete: function (e, t, o, i, n) {
                function s(t) {
                    var o,
                        ...
                        s = y.table.getData();
                    return (
                        (o = t ? y.table.columnManager.getColumnByField(t) : e.getColumn()._getSelf()),
                        o
                            ? (s.forEach(function (e) {
                                  var t = o.getFieldValue(e);
                                  null !== t && void 0 !== t && "" !== t && (i[t] = !0);
                ...
                function r(e, t) {
                    var o,
                        i,
                        r = [];
                    (o = !0 === n.values ? s() : "string" == typeof n.values ? s(n.values) : n.values || []),
                        n.searchFunc
                            ? ((r = n.searchFunc(e, o)),
                              r instanceof Promise
                                  ? (a(void 0 !== n.searchingPlaceholder ? n.searchingPlaceholder : "Searching..."),
                                    r
                                        .then(function (e) {
                                            d(l(e), t);
                                        })
                            ...
                            : ((i = l(o)),
                              "" === e
                                  ...
                                  : i.forEach(function (t) {
                                        (null === t.value && void 0 === t.value) || ((String(t.value).toLowerCase().indexOf(String(e).toLowerCase()) > -1 || String(t.title).toLowerCase().indexOf(String(e).toLowerCase()) > -1) && r.push(t));
                                    }),
                              d(r, t));
                }
                function a(e) {
                    var t = document.createElement("div");
                    c(), !1 !== e && (t.classList.add("tabulator-edit-select-list-notice"), (t.tabIndex = 0), e instanceof Node ? t.appendChild(e) : (t.innerHTML = e), M.appendChild(t));
                }
                function l(e) {
                    var t = [];
                    if (Array.isArray(e))
                        e.forEach(function (e) {
                            var o = { title: n.listItemFormatter ? n.listItemFormatter(e, e) : e, value: e };
                            t.push(o);
                        });
                    else
                        for (var o in e) {
                ...
                function d(e, t) {
                    e.length ? h(e, t) : n.emptyPlaceholder && a(n.emptyPlaceholder);
                }
                function h(e, t) {
                    var o = !1;
                    c(),
                        ...
                        L.forEach(function (e) {
                            ...
                            i ||
                                ...
                                (e.element = i),
                                t && e.value == E && ((R.value = e.title), e.element.classList.add("active"), (o = !0)),
                                e === T && (e.element.classList.add("active"), (o = !0))),
                                M.appendChild(i);
                        }),
                        o || f(!1);
                }
                function p() {
                    g(), T ? (E !== T.value ? ((E = T.value), (R.value = T.title), o(T.value)) : i()) : n.freetext ? ((E = R.value), o(R.value)) : n.allowEmpty && "" === R.value ? ((E = R.value), o(R.value)) : i();
                }
                function m() {
                    if (!M.parentNode) {
                        for (; M.firstChild; ) M.removeChild(M.firstChild);
                        var e = u.prototype.helpers.elOffset(w);
                        (M.style.minWidth = w.offsetWidth + "px"), (M.style.top = e.top + w.offsetHeight + "px"), (M.style.left = e.left + "px"), document.body.appendChild(M);
                    }
                }
                function f(e, t) {
                    T && T.element && T.element.classList.remove("active"), (T = e), e && e.element && e.element.classList.add("active");
                }
                function g() {
                    M.parentNode && M.parentNode.removeChild(M), v();
                }
                function b() {
                    g(), i();
                }
                function v() {
                    y.table.rowManager.element.removeEventListener("scroll", b);
                }
                var y = this,
                    w = e.getElement(),
                    E = e.getValue(),
                    C = n.verticalNavigation || "editor",
                    x = void 0 !== E || null === E ? E : void 0 !== n.defaultValue ? n.defaultValue : "",
                    ...
                    D = !0;
                if (
                    (this.table.rowManager.element.addEventListener("scroll", b),
                    ...
                    for (var k in n.elementAttributes) "+" == k.charAt(0) ? ((k = k.slice(1)), R.setAttribute(k, R.getAttribute(k) + n.elementAttributes["+" + k])) : R.setAttribute(k, n.elementAttributes[k]);
                return (
                    M.classList.add("tabulator-edit-select-list"),
                    ...
                    R.addEventListener("keydown", function (e) {
                        ...
                        switch (e.keyCode) {
                            case 38:
                                (t = L.indexOf(T)), ("editor" == C || ("hybrid" == C && t)) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), f(t > 0 ? L[t - 1] : !1));
                                break;
                            case 40:
                                (t = L.indexOf(T)), ("editor" == C || ("hybrid" == C && t < L.length - 1)) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t < L.length - 1 && f(-1 == t ? L[0] : L[t + 1]));
                                break;
                            case 37:
                            case 39:
                                e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault();
                    ...
                    R.addEventListener("search", function (e) {
                        r(R.value);
                    }),
                    ...
                    t(function () {
                        (R.style.height = "100%"), R.focus({ preventScroll: !0 });
                    }),
            ...
            star: function (e, t, o, i, n) {
                function s(e) {
                    h.forEach(function (t, o) {
                        o < e
                            ? ("ie" == a.table.browser ? t.setAttribute("class", "tabulator-star-active") : t.classList.replace("tabulator-star-inactive", "tabulator-star-active"),
                              (t.innerHTML =
                            ...
                            : ("ie" == a.table.browser ? t.setAttribute("class", "tabulator-star-inactive") : t.classList.replace("tabulator-star-active", "tabulator-star-inactive"),
                              (t.innerHTML =
                    ...
                    !(function (e) {
                        ...
                        h.push(i),
                            ...
                            t.addEventListener("click", function (t) {
                                t.stopPropagation(), t.stopImmediatePropagation(), o(e);
                            }),
                            t.appendChild(i),
                            p.appendChild(t);
                    })(g);
            ...
            tickCross: function (e, t, o, i, n) {
                ...
                if ((a.setAttribute("type", "checkbox"), (a.style.marginTop = "5px"), (a.style.boxSizing = "border-box"), n.elementAttributes && "object" == _typeof(n.elementAttributes)))
                    for (var d in n.elementAttributes) "+" == d.charAt(0) ? ((d = d.slice(1)), a.setAttribute(d, a.getAttribute(d) + n.elementAttributes["+" + d])) : a.setAttribute(d, n.elementAttributes[d]);
                return (
                    (a.value = r),
                    !l || (void 0 !== r && r !== c && "" !== r) || ((u = !0), (a.indeterminate = !0)),
                    "firefox" != this.table.browser &&
                        t(function () {
                            a.focus({ preventScroll: !0 });
                        }),
                    (a.checked = !0 === r || "true" === r || "True" === r || 1 === r),
    ...
    (E.prototype.genereateTable = function (e, t, o, i) {
        (this.cloneTableStyle = t), (this.config = e || {}), (this.colVisProp = i);
        var n = document.createElement("table");
        return (
            n.classList.add("tabulator-print-table"),
            !1 !== this.config.columnHeaders && n.appendChild(this.generateHeaderElements()),
            n.appendChild(this.generateBodyElements(this.rowLookup(o))),
            this.mapElementStyles(this.table.element, n, ["border-top", "border-left", "border-right", "border-bottom"]),
            n
        );
    }),
        (E.prototype.rowLookup = function (e) {
            var t = this,
                o = [];
        ...
        (E.prototype.generateColumnGroupHeaders = function () {
            var e = this,
                t = [];
            return (
        ...
        (E.prototype.processColumnGroup = function (e) {
            var t = this,
                o = e.columns,
                i = 0,
                n = { title: e.definition.title, column: e, depth: 1 };
            if (o.length) {
                if (
                    ((n.subGroups = []),
                    (n.width = 0),
        ...
        (E.prototype.groupHeadersToRows = function (e) {
            function t(e, n) {
                var s = i - n;
                void 0 === o[n] && (o[n] = []),
        ...
        (E.prototype.generateHeaderElements = function () {
            var e = this,
                t = document.createElement("thead");
            return (
                this.groupHeadersToRows(this.generateColumnGroupHeaders()).forEach(function (o) {
                    var i = document.createElement("tr");
                    e.mapElementStyles(e.table.columnManager.getHeadersElement(), t, ["border-top", "border-left", "border-right", "border-bottom", "background-color", "color", "font-weight", "font-family", "font-size"]),
                        o.forEach(function (t) {
                            var o = document.createElement("th"),
                                n = t.column.definition.cssClass ? t.column.definition.cssClass.split(" ") : [];
                            (o.colSpan = t.width),
                                (o.rowSpan = t.height),
                                (o.innerHTML = t.column.definition.title),
                                e.cloneTableStyle && (o.style.boxSizing = "border-box"),
                                n.forEach(function (e) {
                                    o.classList.add(e);
                                }),
                                e.mapElementStyles(t.column.getElement(), o, ["text-align", "border-top", "border-left", "border-right", "border-bottom", "background-color", "color", "font-weight", "font-family", "font-size"]),
                                e.mapElementStyles(t.column.contentElement, o, ["padding-top", "padding-left", "padding-right", "padding-bottom"]),
                                t.column.visible ? e.mapElementStyles(t.column.getElement(), o, ["width"]) : t.column.definition.width && (o.style.width = t.column.definition.width + "px"),
                                t.column.parent && e.mapElementStyles(t.column.parent.groupElement, o, ["border-top"]),
                                i.appendChild(o);
                        }),
                        t.appendChild(i);
                }),
        ...
        (E.prototype.generateBodyElements = function (e) {}),
        (E.prototype.generateBodyElements = function (e) {
            var t,
                o,
                i,
                ...
                u,
                d = this;
            (u = this.table.options["rowFormatter" + (this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1))]),
                (u = null !== u ? u : this.table.options.rowFormatter),
                this.cloneTableStyle &&
                    window.getComputedStyle &&
                    ((t = this.table.element.querySelector(".tabulator-row-odd:not(.tabulator-group):not(.tabulator-calcs)")),
                    (o = this.table.element.querySelector(".tabulator-row-even:not(.tabulator-group):not(.tabulator-calcs)")),
                    (i = this.table.element.querySelector(".tabulator-row.tabulator-calcs")),
                    (n = this.table.element.querySelector(".tabulator-row:not(.tabulator-group):not(.tabulator-calcs)")),
                    (r = this.table.element.getElementsByClassName("tabulator-group")[0]),
                    n && ((a = n.getElementsByClassName("tabulator-cell")), (s = a[0]), a[a.length - 1]));
            var h = document.createElement("tbody"),
                p = [];
            return (
                !1 !== this.config.columnCalcs &&
                    this.table.modExists("columnCalcs") &&
                    (this.table.modules.columnCalcs.topInitialized && e.unshift(this.table.modules.columnCalcs.topRow), this.table.modules.columnCalcs.botInitialized && e.push(this.table.modules.columnCalcs.botRow)),
                this.table.columnManager.columnsByIndex.forEach(function (e) {
                    d.columnVisCheck(e) && p.push(e);
                }),
                this.table.options.dataTree && !1 !== this.config.dataTree && this.table.modExists("columnCalcs") && (c = this.table.modules.dataTree.elementField),
                (e = e.filter(function (e) {
                    switch (e.type) {
                        case "group":
                            return !1 !== d.config.rowGroups;
                        case "calc":
                            return !1 !== d.config.columnCalcs;
                    }
                    return !0;
                })),
                e.length > 1e3 && console.warn("It may take a long time to render an HTML table with more than 1000 rows"),
                e.forEach(function (e, n) {
                    var a = e.getData(d.colVisProp),
                        m = document.createElement("tr");
                    switch ((m.classList.add("tabulator-print-table-row"), e.type)) {
                        case "group":
                            var f = document.createElement("td");
                            (f.colSpan = p.length),
                                (f.innerHTML = e.key),
                                m.classList.add("tabulator-print-table-group"),
                                d.mapElementStyles(r, m, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]),
                                d.mapElementStyles(r, f, ["padding-top", "padding-left", "padding-right", "padding-bottom"]),
                                m.appendChild(f);
                            break;
                        case "calc":
                            m.classList.add("tabulator-print-table-calcs");
                        case "row":
                            if (d.table.options.dataTree && !1 === d.config.dataTree && e.modules.dataTree.parent) return;
                            if (
                                (p.forEach(function (t, o) {
                                    ...
                                    if (
                                        ((t.definition.cssClass ? t.definition.cssClass.split(" ") : []).forEach(function (e) {
                                            i.classList.add(e);
                                        }),
                                        d.table.modExists("format") && !1 !== d.config.formatCells)
                                    )
                                        n = d.table.modules.format.formatExportValue(r, d.colVisProp);
                                    else
                                    ...
                                    n instanceof Node ? i.appendChild(n) : (i.innerHTML = n),
                                        s &&
                                            ...
                                            t.definition.align && (i.style.textAlign = t.definition.align)),
                                        d.table.options.dataTree &&
                                            !1 !== d.config.dataTree &&
                                            ((c && c == t.field) || (!c && 0 == o)) &&
                                            (e.modules.dataTree.controlEl && i.insertBefore(e.modules.dataTree.controlEl.cloneNode(!0), i.firstChild),
                                            e.modules.dataTree.branchEl && i.insertBefore(e.modules.dataTree.branchEl.cloneNode(!0), i.firstChild)),
                                        m.appendChild(i),
                                        r.modules.format && r.modules.format.renderedCallback && r.modules.format.renderedCallback();
                                }),
                                (l = "calc" == e.type ? i : n % 2 && o ? o : t),
                                d.mapElementStyles(l, m, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]),
                                u && !1 !== d.config.formatCells)
                            ) {
                                var g = e.getComponent();
        ...
        (E.prototype.columnVisCheck = function (e) {
            return !1 !== e.definition[this.colVisProp] && (e.visible || (!e.visible && e.definition[this.colVisProp]));
        }),
        (E.prototype.getHtml = function (e, t, o, i) {
            var n = document.createElement("div");
            return n.appendChild(this.genereateTable(o || this.table.options.htmlOutputConfig, t, e, i || "htmlOutput")), n.innerHTML;
        }),
        (E.prototype.mapElementStyles = function (e, t, o) {
        ...
        u.prototype.registerModule("export", E);
    var C = function (e) {
    ...
    (C.prototype.initializeColumn = function (e, t) {
        function o(t) {
            var o,
                s = ("input" == e.modules.filter.tagType && "text" == e.modules.filter.attrType) || "textarea" == e.modules.filter.tagType ? "partial" : "match",
                r = "",
                a = "";
            if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
                if (((e.modules.filter.prevSuccess = t), e.modules.filter.emptyFunc(t))) delete i.headerFilters[n];
                else {
                                ...
                                ? ((r = e.definition.headerFilterFunc),
                                  (o = function (o) {
                                      var n = e.definition.headerFilterFuncParams || {},
                                          s = e.getFieldValue(o);
                                      return (n = "function" == typeof n ? n(t, s, o) : n), i.filters[e.definition.headerFilterFunc](t, s, o, n);
                                  }))
                    ...
                    i.headerFilters[n] = { value: t, func: o, type: r };
                }
                (a = JSON.stringify(i.headerFilters)), i.prevHeaderFilterChangeCheck !== a && ((i.prevHeaderFilterChangeCheck = a), (i.changed = !0), i.table.rowManager.filterRefresh());
            }
            return !0;
        }
        var i = this,
        ...
        (C.prototype.generateHeaderFilterElement = function (e, t, o) {
            function i() {}
            var n,
                s,
                r,
            ...
            if ((e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), m)) {
                ...
                if (s) {
                    if (
                        ...
                        !(r = s.call(this.table.modules.edit, a, function () {}, p, i, u)))
                    )
                        return void console.warn("Filter Error - Cannot add filter to " + m + " column, editor returned a value of false");
                    if (!(r instanceof Node)) return void console.warn("Filter Error - Cannot add filter to " + m + " column, editor should return an instance of Node, the editor returned:", r);
                    m
                        ...
                        (e.modules.filter.headerElement = r),
                        (e.modules.filter.attrType = r.hasAttribute("type") ? r.getAttribute("type").toLowerCase() : ""),
                        (e.modules.filter.tagType = r.tagName.toLowerCase()),
                        !1 !== e.definition.headerFilterLiveFilter &&
                            ("autocomplete" !== e.definition.headerFilter &&
                                ...
                                (r.addEventListener("keyup", c),
                                r.addEventListener("search", c),
                                "number" == e.modules.filter.attrType &&
                                    r.addEventListener("change", function (e) {
                                        p(r.value);
                                    }),
                                "text" == e.modules.filter.attrType && "ie" !== this.table.browser && r.setAttribute("type", "search")),
        ...
        (C.prototype.hideHeaderFilterElements = function () {
        ...
        (C.prototype.getHeaderFilterValue = function (e) {
        ...
        (C.prototype.setHeaderFilterValue = function (e, t) {
        ...
        (C.prototype.reloadHeaderFilter = function (e) {
        ...
        (C.prototype.setFilter = function (e, t, o) {
            var i = this;
            (i.filterList = []), Array.isArray(e) || (e = [{ field: e, type: t, value: o }]), i.addFilter(e);
        }),
        (C.prototype.addFilter = function (e, t, o) {
            var i = this;
            Array.isArray(e) || (e = [{ field: e, type: t, value: o }]),
                e.forEach(function (e) {
                    (e = i.findFilter(e)) && (i.filterList.push(e), (i.changed = !0));
                }),
        ...
        (C.prototype.findFilter = function (e) {
            var t,
                o = this;
            ...
            return (
                "function" == typeof e.field
                    ...
                    ? ((t = o.table.columnManager.getColumnByField(e.field)),
                      (i = t
                          ? function (i) {
                                return o.filters[e.type](e.value, t.getFieldValue(i));
                            }
                          : function (t) {
                                return o.filters[e.type](e.value, t[e.field]);
                            }))
        ...
        (C.prototype.findSubFilters = function (e) {
            var t = this,
                o = [];
            return (
                e.forEach(function (e) {
        ...
        (C.prototype.getFilters = function (e, t) {
            var o = [];
            return (
        ...
        (C.prototype.filtersToArray = function (e, t) {
            var o = this,
                i = [];
            return (
                e.forEach(function (e) {
        ...
        (C.prototype.clearFilter = function (e) {
            (this.filterList = []),
                e && this.clearHeaderFilter(),
                (this.changed = !0),
                this.table.options.persistence && this.table.modExists("persistence", !0) && this.table.modules.persistence.config.filter && this.table.modules.persistence.save("filter");
        }),
        (C.prototype.clearHeaderFilter = function () {
            var e = this;
            (this.headerFilters = {}),
        ...
        (C.prototype.search = function (e, t, o, i) {
            var n = this,
                s = [],
                r = [];
            return (
        ...
        (C.prototype.filterRow = function (e, t) {
            var o = this,
                i = !0,
                n = e.getData();
        ...
        (C.prototype.filterRecurse = function (e, t) {
            var o = this,
                i = !1;
            return (
                Array.isArray(e)
        ...
        u.prototype.registerModule("filter", C);
    var x = function (e) {
        this.table = e;
    };
    (x.prototype.initializeColumn = function (e) {
        ...
        (x.prototype.lookupFormatter = function (e, t) {
        ...
        (x.prototype.formatExportValue = function (e, t) {
            var o,
        ...
        (x.prototype.sanitizeHTML = function (e) {
            if (e) {
                var t = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;", "`": "&#x60;", "=": "&#x3D;" };
        ...
        (x.prototype.emptyToSpace = function (e) {
            return null === e || void 0 === e || "" === e ? "&nbsp;" : e;
        }),
        (x.prototype.getFormatter = function (e) {
            var e;
            switch (void 0 === e ? "undefined" : _typeof(e)) {
                case "string":
        ...
        (x.prototype.formatters = {
            ...
            money: function (e, t, o) {
                ...
                for (i = !1 !== h ? a.toFixed(h) : a, i = String(i).split("."), n = i[0], s = i.length > 1 ? l + i[1] : "", r = /(\d+)(\d{3})/; r.test(n); ) n = n.replace(r, "$1" + c + "$2");
            ...
            link: function (e, t, o) {
                ...
                if (a) {
                    ...
                    return (
                        ...
                        t.download && ((r = "function" == typeof r ? r(e) : !0 === r ? "" : r), l.setAttribute("download", r)),
            ...
            tickCross: function (e, t, o) {
                ...
                return (r && i) || !0 === i || "true" === i || "True" === i || 1 === i || "1" === i
            ...
            datetime: function (e, t, o) {
                var i = t.inputFormat || "YYYY-MM-DD hh:mm:ss",
                    ...
                    r = e.getValue(),
                    a = moment(r, i);
                return a.isValid() ? a.format(n) : !0 === s ? r : "function" == typeof s ? s(r) : s;
            },
            ...
            traffic: function (e, t, o) {
                ...
                if (!isNaN(s) && void 0 !== e.getValue()) {
                    switch (
                        ...
                        (n = parseFloat(s) <= a ? parseFloat(s) : a),
            ...
            progress: function (e, t, o) {
                    ...
                    case "object":
                        if (Array.isArray(t.legendColor)) {
                            var m = 100 / t.legendColor.length,
                                f = Math.floor(n / m);
                            (f = Math.min(f, t.legendColor.length - 1)), (f = Math.max(f, 0)), (l = t.legendColor[f]);
                        }
                        break;
                    default:
                        l = "#000";
                ...
                if (
                    ((g.style.display = "inline-block"), (g.style.position = "relative"), (g.style.width = n + "%"), (g.style.backgroundColor = s), (g.style.height = "100%"), g.setAttribute("data-max", d), g.setAttribute("data-min", h), r)
                ) {
                    var b = document.createElement("div");
                    (b.style.position = "absolute"), (b.style.top = "4px"), (b.style.left = 0), (b.style.textAlign = p), (b.style.width = "100%"), (b.style.color = l), (b.innerHTML = r);
                }
                return (
                    o(function () {
                        if (!(e instanceof a)) {
        ...
        u.prototype.registerModule("format", x);
    var R = function (e) {
    ...
    (R.prototype.reset = function () {
        ...
        (R.prototype.frozenCheck = function (e) {
            return (
        ...
        (R.prototype.scrollHorizontal = function () {
            var e,
                t = this;
            this.active &&
        ...
        (R.prototype.calcMargins = function () {
        ...
        (R.prototype.layoutCalcRows = function () {
            this.table.modExists("columnCalcs") &&
        ...
        (R.prototype.layoutColumnPosition = function (e) {
            var t = this,
                o = [];
        ...
        (R.prototype.getColGroupParentElement = function (e) {
        ...
        (R.prototype.layoutRow = function (e) {
            var t = this;
        ...
        (R.prototype.layoutElement = function (e, t) {
        ...
        (R.prototype._calcSpace = function (e, t) {
            for (var o = 0, i = 0; i < t; i++) e[i].visible && (o += e[i].getWidth());
            return o;
        }),
        u.prototype.registerModule("frozenColumns", R);
    var M = function (e) {
    ...
    (M.prototype.initialize = function () {
        ...
        (M.prototype.freezeRow = function (e) {
            e.modules.frozen
        ...
        (M.prototype.unfreezeRow = function (e) {
        ...
        (M.prototype.styleRows = function (e) {
            var t = this;
            this.rows.forEach(function (e, o) {
                t.table.rowManager.styleRow(e, o);
            });
        }),
        u.prototype.registerModule("frozenRows", M);
    var L = function (e) {
    ...
    (L.prototype.getKey = function () {
        ...
        (L.prototype.getSubGroups = function () {
            return this._group.getSubGroups(!0);
        }),
        (L.prototype.getParentGroup = function () {
            return !!this._group.parent && this._group.parent.getComponent();
        }),
        (L.prototype.getVisibility = function () {
    ...
    (T.prototype.wipe = function () {
        ...
        (T.prototype.createValueGroups = function () {
            var e = this,
                t = this.level + 1;
        ...
        (T.prototype._createGroup = function (e, t) {
            var o = t + "_" + e,
                i = new T(this.groupManager, this, t, e, this.groupManager.groupIDLookups[t].field, this.groupManager.headerGenerator[t] || this.groupManager.headerGenerator[0], !!this.old && this.old.groups[o]);
            (this.groups[o] = i), this.groupList.push(i);
        }),
        (T.prototype._addRowToGroup = function (e) {
            var t = this.level + 1;
        ...
        (T.prototype._addRow = function (e) {
            this.rows.push(e), (e.modules.group = this);
        }),
        (T.prototype.insertRow = function (e, t, o) {
        ...
        (T.prototype.scrollHeader = function (e) {
        ...
        (T.prototype.conformRowData = function (e) {
        ...
        (T.prototype.getHeadersAndRows = function (e) {
            var t = [];
            return (
                t.push(this),
                this._visSet(),
                this.visible
                    ? this.groupList.length
                        ...
                        : (!e &&
                              ...
                              (this.calcs.top && (this.calcs.top.detachElement(), this.calcs.top.deleteCells()), (this.calcs.top = this.groupManager.table.modules.columnCalcs.generateTopRow(this.rows)), t.push(this.calcs.top)),
        ...
        (T.prototype.getRowGroup = function (e) {
            var t = !1;
            return (
                this.groupList.length
                    ? this.groupList.forEach(function (o) {
        ...
        (T.prototype.getSubGroups = function (e) {
            var t = [];
            return (
                this.groupList.forEach(function (o) {
        ...
        (T.prototype.generateGroupHeaderContents = function () {
            var e = [];
            for (
                this.rows.forEach(function (t) {
                    e.push(t.getData());
        ...
        (T.prototype.detachElement = function () {
            this.element && this.element.parentNode && this.element.parentNode.removeChild(this.element);
        }),
        (T.prototype.normalizeHeight = function () {
        ...
        (T.prototype.reinitializeHeight = function () {}),
        (T.prototype.calcHeight = function () {}),
        (T.prototype.setCellHeight = function () {}),
        (T.prototype.clearCellHeight = function () {}),
    ...
    (D.prototype.initialize = function () {
        ...
        (D.prototype.getRows = function (e) {
            return this.groupIDLookups.length
                ? (this.table.options.dataGrouping.call(this.table), this.generateGroups(e), this.table.options.dataGrouped && this.table.options.dataGrouped.call(this.table, this.getGroups(!0)), this.updateGroupRows())
                : e.slice(0);
        }),
        ...
        (D.prototype.getChildGroups = function (e) {
            var t = this,
                o = [];
            return (
                e || (e = this),
        ...
        (D.prototype.pullGroupListData = function (e) {
            var t = this,
                o = [];
            return (
                e.forEach(function (e) {
                    ...
                    var n = [];
                    e.hasSubGroups
                        ? ((n = t.pullGroupListData(e.groupList)), (i.level = e.level), (i.rowCount = n.length - e.groupList.length), (i.headerContent = e.generator(e.key, i.rowCount, e.rows, e)), o.push(i), (o = o.concat(n)))
                        : ((i.level = e.level),
        ...
        (D.prototype.getRowGroup = function (e) {
            var t = !1;
            return (
                this.groupList.forEach(function (o) {
                    var i = o.getRowGroup(e);
        ...
        (D.prototype.countGroups = function () {
            return this.groupList.length;
        }),
        (D.prototype.generateGroups = function (e) {
            var t = this,
                o = t.groups;
            (t.groups = {}),
                (t.groupList = []),
        ...
        (D.prototype.createGroup = function (e, t, o) {
            var i,
                n = t + "_" + e;
            (o = o || []), (i = new T(this, !1, t, e, this.groupIDLookups[0].field, this.headerGenerator[0], o[n])), (this.groups[n] = i), this.groupList.push(i);
        }),
        (D.prototype.assignRowToExistingGroup = function (e, t) {
            var o = this.groupIDLookups[0].func(e.getData()),
                i = "0_" + o;
            this.groups[i] && this.groups[i].addRow(e);
        }),
        (D.prototype.assignRowToGroup = function (e, t) {
            var o = this.groupIDLookups[0].func(e.getData()),
                i = !this.groups["0_" + o];
            return i && this.createGroup(o, 0, t), this.groups["0_" + o].addRow(e), !i;
        }),
        (D.prototype.updateGroupRows = function (e) {
            var t = this,
                o = [];
            if (
        ...
        (D.prototype.scrollHeaders = function (e) {
            (e += "px"),
                this.groupList.forEach(function (t) {
                    t.scrollHeader(e);
                });
        }),
        (D.prototype.removeGroup = function (e) {
            var t,
                o = e.level + "_" + e.key;
            this.groups[o] && (delete this.groups[o], (t = this.groupList.indexOf(e)) > -1 && this.groupList.splice(t, 1));
        }),
        u.prototype.registerModule("groupRows", D);
    var k = function (e) {
    ...
    (k.prototype.clear = function () {
        ...
        (k.prototype.action = function (e, t, o) {
            (this.history = this.history.slice(0, this.index + 1)), this.history.push({ type: e, component: t, data: o }), this.index++;
        }),
        (k.prototype.getHistoryUndoSize = function () {
            return this.index + 1;
        }),
        (k.prototype.getHistoryRedoSize = function () {
    ...
    (S.prototype.parseTable = function () {
        ...
        (S.prototype._extractOptions = function (e, t, o) {
            var i = e.attributes,
        ...
        (S.prototype._attribValue = function (e) {
            return "true" === e || ("false" !== e && e);
        }),
        (S.prototype._findCol = function (e) {
            return (
        ...
        (S.prototype._extractHeaders = function (e, t) {
            for (var o = 0; o < e.length; o++) {
                var n,
                    s = e[o],
                    r = !1,
                    a = this._findCol(s.textContent);
                a ? (r = !0) : (a = { title: s.textContent.trim() }),
                    a.field || (a.field = s.textContent.trim().toLowerCase().replace(" ", "_")),
                    (n = s.getAttribute("width")),
                    n && !a.width && (a.width = n),
                    s.attributes,
                    this._extractOptions(s, a, i.prototype.defaultOptionList),
                    (this.fieldIndex[o] = a.field),
                    a.field == this.table.options.index && (this.hasIndex = !0),
                    r || this.table.options.columns.push(a);
            }
        }),
        (S.prototype._generateBlankHeaders = function (e, t) {
            for (var o = 0; o < e.length; o++) {
                var i = e[o],
                    n = { title: "", field: "col" + o };
        ...
        u.prototype.registerModule("htmlTableImport", S);
    var z = function (e) {
    ...
    (z.prototype.initialize = function () {
        ...
        (z.prototype.mapBindings = function (e) {
            var t = this,
                o = this;
            for (var i in e)
                !(function (i) {
        ...
        (z.prototype.mapBinding = function (e, t) {
            var o = this,
        ...
        (z.prototype.bindEvents = function () {
            var e = this;
        ...
        (z.prototype.clearBindings = function () {
        ...
        (z.prototype.checkBinding = function (e, t) {
            var o = this,
                i = !0;
            return (
                e.ctrlKey == t.ctrl &&
        ...
        (z.prototype.bindings = { navPrev: "shift + 9", navNext: 9, navUp: 38, navDown: 40, scrollPageUp: 33, scrollPageDown: 34, scrollToStart: 36, scrollToEnd: 35, undo: "ctrl + 90", redo: "ctrl + 89", copyToClipboard: "ctrl + 67" }),
        (z.prototype.actions = {
            keyBlock: function (e) {
                ...
                this.table.modExists("edit") &&
                    ...
                    t.next() ||
                        (i &&
                            ...
                            (i = !0 === i ? this.table.addRow({}) : "function" == typeof i ? this.table.addRow(i(o.row.getComponent())) : this.table.addRow(i)),
                            i.then(function () {
                                setTimeout(function () {
                                    t.next();
                                });
        ...
        u.prototype.registerModule("keybindings", z);
    var H = function (e) {
        (this.table = e), (this.menuEl = !1), (this.blurEvent = this.hideMenu.bind(this));
    };
    (H.prototype.initializeColumnHeader = function (e) {
        var t,
            o = this;
        ...
        (H.prototype.initializeCell = function (e) {
            var t = this;
            e.getElement().addEventListener("contextmenu", function (o) {
                ...
                o.preventDefault(), t.loadMenu(o, e, i);
            });
        }),
        (H.prototype.initializeRow = function (e) {
            var t = this;
            e.getElement().addEventListener("contextmenu", function (o) {
        ...
        (H.prototype.loadMenu = function (e, t, o) {
            var i = this,
        ...
        (H.prototype.hideMenu = function () {
            this.menuEl.parentNode && this.menuEl.parentNode.removeChild(this.menuEl),
                this.blurEvent && (document.body.removeEventListener("click", this.blurEvent), document.body.removeEventListener("contextmenu", this.blurEvent), this.table.rowManager.element.removeEventListener("scroll", this.blurEvent));
        }),
        (H.prototype.menus = {}),
        u.prototype.registerModule("menu", H);
    var F = function (e) {
        (this.table = e),
    ...
    (F.prototype.createPlaceholderElement = function () {
            ...
            e.modules.frozen ||
                ...
                (i.mousemove = function (i) {
                    e.parent === o.moving.parent &&
                        ((o.touchMove ? i.touches[0].pageX : i.pageX) - u.prototype.helpers.elOffset(t).left + o.table.columnManager.element.scrollLeft > e.getWidth() / 2
                ...
                c.addEventListener(
                    ...
                    function (c) {
                        ...
                        l.moving &&
                            ...
                            d > 0
                                ? o && d - r > n && (h = o) !== e && ((u = c.touches[0].pageX), h.getElement().parentNode.insertBefore(l.placeholderElement, h.getElement().nextSibling), l.moveColumn(h, !0))
                                : i && -d - a > s && (h = i) !== e && ((u = c.touches[0].pageX), h.getElement().parentNode.insertBefore(l.placeholderElement, h.getElement()), l.moveColumn(h, !1)),
                            h && ((t = h), (o = h.nextColumn()), (r = n), (n = o ? o.getWidth() / 2 : 0), (i = h.prevColumn()), (a = s), (s = i ? i.getWidth() / 2 : 0)));
                    },
                    { passive: !0 }
                ),
        ...
        (F.prototype.startMove = function (e, t) {
            var o = t.getElement();
            (this.moving = t),
                (this.startX = (this.touchMove ? e.touches[0].pageX : e.pageX) - u.prototype.helpers.elOffset(o).left),
        ...
        (F.prototype.moveHover = function (e) {
            var t,
                ...
                n = i.scrollLeft,
                s = (o.touchMove ? e.touches[0].pageX : e.pageX) - u.prototype.helpers.elOffset(i).left + n;
        ...
        u.prototype.registerModule("moveColumn", F);
    var A = function (e) {
        (this.table = e),
            (this.placeholderElement = this.createPlaceholderElement()),
            (this.hoverElement = !1),
    ...
    (A.prototype.createPlaceholderElement = function () {
        var e = document.createElement("div");
        ...
        (A.prototype.setHandle = function (e) {
            this.hasHandle = e;
        }),
        (A.prototype.initializeGroupHeader = function (e) {
            var t = this,
                o = {};
            (o.mouseup = function (e) {
                ...
                (o.mousemove = function (o) {
                    if (o.pageY - u.prototype.helpers.elOffset(e.element).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2) {
        ...
        (A.prototype.initializeRow = function (e) {
            ...
            (i.mouseup = function (t) {
                ...
                (i.mousemove = function (t) {
                    if (t.pageY - u.prototype.helpers.elOffset(e.element).top + o.table.rowManager.element.scrollTop > e.getHeight() / 2) {
        ...
        (A.prototype.initializeCell = function (e) {
            var t = this,
                o = e.getElement();
        ...
        (A.prototype.bindTouchEvents = function (e, t) {
            var o,
                i,
                n,
                s,
            ...
            t.addEventListener(
                ...
                t.addEventListener("touchmove", function (t) {
                    ...
                    c.moving &&
                        ...
                        d > 0
                            ? i && d - a > s && (h = i) !== e && ((u = t.touches[0].pageY), h.getElement().parentNode.insertBefore(c.placeholderElement, h.getElement().nextSibling), c.moveRow(h, !0))
                            : n && -d - l > r && (h = n) !== e && ((u = t.touches[0].pageY), h.getElement().parentNode.insertBefore(c.placeholderElement, h.getElement()), c.moveRow(h, !1)),
                        h && ((o = h), (i = h.nextRow()), (a = s), (s = i ? i.getHeight() / 2 : 0), (n = h.prevRow()), (l = r), (r = n ? n.getHeight() / 2 : 0)));
                }),
                t.addEventListener("touchend", function (e) {
                    c.checkTimeout && clearTimeout(c.checkTimeout), c.moving && (c.endMove(e), (c.touchMove = !1));
                });
        }),
        (A.prototype._bindMouseMove = function () {
        ...
        (A.prototype._unbindMouseMove = function () {
            this.table.rowManager.getDisplayRows().forEach(function (e) {
        ...
        (A.prototype.startMove = function (e, t) {
            var o = t.getElement();
            this.setStartPosition(e, t),
                ...
                (this.placeholderElement.style.width = t.getWidth() + "px"),
                (this.placeholderElement.style.height = t.getHeight() + "px"),
                this.connection ? (this.table.element.classList.add("tabulator-movingrow-sending"), this.connectToTables(t)) : (o.parentNode.insertBefore(this.placeholderElement, o), o.parentNode.removeChild(o)),
                (this.hoverElement = o.cloneNode(!0)),
                this.hoverElement.classList.add("tabulator-moving"),
                this.connection
        ...
        (A.prototype.setStartPosition = function (e, t) {
            var o,
                i,
        ...
        (A.prototype.endMove = function (e) {
        ...
        (A.prototype.moveHoverConnections = function (e) {
        ...
        (A.prototype.connectToTables = function (e) {
            var t = this.table.modules.comms.getConnections(this.connection);
            this.table.options.movableRowsSendingStart.call(this.table, t), this.table.modules.comms.send(this.connection, "moveRow", "connect", { row: e });
        }),
        (A.prototype.disconnectFromTables = function () {
            var e = this.table.modules.comms.getConnections(this.connection);
            this.table.options.movableRowsSendingStop.call(this.table, e), this.table.modules.comms.send(this.connection, "moveRow", "disconnect");
        }),
        ...
        (A.prototype.disconnect = function (e) {
            var t = this;
        ...
        (A.prototype.dropComplete = function (e, t, o) {
            var i = !1;
            if (o) {
        ...
        (A.prototype.tableRowDrop = function (e, t) {
            var o = !1,
                i = !1;
            switch ((e.stopImmediatePropagation(), _typeof(this.table.options.movableRowsReceiver))) {
                case "string":
        ...
        (A.prototype.commsReceived = function (e, t, o) {
            switch (t) {
                case "connect":
        ...
        u.prototype.registerModule("moveRow", A);
    var P = function (e) {
    ...
    (P.prototype.initializeColumn = function (e) {
        ...
        this.allowedTypes.forEach(function (n) {
            ...
            e.definition[r] && (s = t.lookupMutator(e.definition[r])) && ((o = !0), (i[r] = { mutator: s, params: e.definition[r + "Params"] || {} }));
        }),
            o && (e.modules.mutate = i);
    }),
        (P.prototype.lookupMutator = function (e) {
            var t = !1;
            switch (void 0 === e ? "undefined" : _typeof(e)) {
                case "string":
        ...
        (P.prototype.transformRow = function (e, t, o) {
            var i,
                n = this,
            ...
            return (
                this.enabled &&
                    n.table.columnManager.traverse(function (n) {
                        var r, a, l;
                        n.modules.mutate &&
                            (r = n.modules.mutate[s] || n.modules.mutate.mutator || !1) &&
                            ((i = n.getFieldValue(void 0 !== o ? o : e)),
                            ("data" != t && void 0 === i) || ((l = n.getComponent()), (a = "function" == typeof r.params ? r.params(i, e, t, l) : r.params), n.setFieldValue(e, r.mutator(i, e, t, a, l))));
                    }),
                e
            );
        }),
        (P.prototype.transformCell = function (e, t) {
        ...
        (P.prototype.mutators = {}),
        u.prototype.registerModule("mutator", P);
    var _ = function (e) {
        (this.table = e),
            (this.mode = "local"),
            (this.progressiveLoad = !1),
    ...
    (_.prototype.createElements = function () {
        ...
        (_.prototype.generatePageSizeSelectList = function () {
            var e = this,
                t = [];
            if (this.pageSizeSelect) {
                ...
                t.forEach(function (t) {
                    ...
                    (o.value = t), (o.innerHTML = t), e.pageSizeSelect.appendChild(o);
                }),
            ...
            (this.dataSentNames = Object.assign({}, this.paginationDataSentNames)),
                ...
                this.pageSizeSelect &&
                    ...
                    n.pageSizeSelect.addEventListener("change", function (e) {
                        n.setPageSize(n.pageSizeSelect.value),
                            n
                                .setPage(1)
                                .then(function () {})
                                .catch(function () {});
        ...
        (_.prototype.initializeProgressive = function (e) {
        ...
        (_.prototype.setMaxRows = function (e) {
            (this.max = e ? Math.ceil(e / this.size) : 1), this.page > this.max && (this.page = this.max);
        }),
        (_.prototype.reset = function (e, t) {
            return ("local" == this.mode || e) && (this.page = 1), t && (this.initialLoad = !0), !0;
        }),
        (_.prototype.setMaxPage = function (e) {
        ...
        (_.prototype.setPageToRow = function (e) {
            var t = this;
            return new Promise(function (o, i) {
                var n = t.table.rowManager.getDisplayRows(t.displayIndex - 1),
                    s = n.indexOf(e);
                if (s > -1) {
                    var r = Math.ceil((s + 1) / t.size);
                    t.setPage(r)
                        .then(function () {
                            o();
                        })
        ...
        (_.prototype.setPageSize = function (e) {
            (e = parseInt(e)),
                e > 0 && (this.size = e),
        ...
        (_.prototype._setPageButtons = function () {
            for (
                var e = this,
        ...
        (_.prototype._generatePageButton = function (e) {
            var t = this,
            ...
            return (
                ...
                o.setAttribute("aria-label", "Show Page " + e),
                o.setAttribute("title", "Show Page " + e),
        ...
        (_.prototype.previousPage = function () {
            var e = this;
            return new Promise(function (t, o) {
                e.page > 1
                    ? (e.page--,
        ...
        (_.prototype.getPage = function () {
            return this.page;
        }),
        (_.prototype.getPageMax = function () {
            return this.max;
        }),
        (_.prototype.getPageSize = function (e) {
            return this.size;
        }),
        ...
        (_.prototype.getRows = function (e) {
            var t, o, i;
            if ("local" == this.mode) {
                (t = []), (o = this.size * (this.page - 1)), (i = o + parseInt(this.size)), this._setPageButtons();
        ...
        (_.prototype._getRemotePage = function () {
            var e,
                t,
                o = this,
                i = this;
            return new Promise(function (n, s) {
                if (
                    ...
                    (e = u.prototype.helpers.deepClone(i.table.modules.ajax.getParams() || {})),
        ...
        (_.prototype._parseRemoteData = function (e) {
            var t,
                e,
                o,
                i = this;
        ...
        (_.prototype.footerRedraw = function () {
        ...
        (_.prototype.paginationDataSentNames = { page: "page", size: "size", sorters: "sorters", filters: "filters" }),
        (_.prototype.paginationDataReceivedNames = { current_page: "current_page", last_page: "last_page", data: "data" }),
        u.prototype.registerModule("page", _);
    var N = function (e) {
        (this.table = e), (this.mode = ""), (this.id = ""), (this.defWatcherBlock = !1), (this.config = {}), (this.readFunc = !1), (this.writeFunc = !1);
    };
    (N.prototype.localStorageTest = function () {
        ...
        (N.prototype.initializeColumn = function (e) {
            var t,
                o,
                i = this;
            this.config.columns &&
        ...
        (N.prototype.retreiveData = function (e) {
            return !!this.readFunc && this.readFunc(this.id, e);
        }),
        (N.prototype.mergeDefinition = function (e, t) {
            var o = this,
                i = [];
            return (
                (t = t || []),
                t.forEach(function (t, n) {
                    var s,
                        r = o._findColumn(e, t);
                    r &&
                        (!0 === o.config.columns || void 0 == o.config.columns ? ((s = Object.keys(r)), s.push("width")) : (s = o.config.columns),
                        s.forEach(function (e) {
                            void 0 !== t[e] && (r[e] = t[e]);
                        }),
                        r.columns && (r.columns = o.mergeDefinition(r.columns, t.columns)),
                        i.push(r));
                }),
                e.forEach(function (e, n) {
        ...
        (N.prototype._findColumn = function (e, t) {
        ...
        (N.prototype.validateSorters = function (e) {
            return (
                e.forEach(function (e) {
        ...
        (N.prototype.getGroupConfig = function () {
            return (
                this.config.group &&
        ...
        (N.prototype.getPageConfig = function () {
            var e = {};
            return (
                this.config.page &&
        ...
        (N.prototype.parseColumns = function (e) {
            var t = this,
                o = [];
            return (
                e.forEach(function (e) {
        ...
        u.prototype.registerModule("persistence", N);
    var B = function (e) {
    ...
    (B.prototype.initialize = function () {
        ...
        (B.prototype.replaceTable = function () {
            this.manualBlock ||
                ((this.element = document.createElement("div")),
        ...
        (B.prototype.printFullscreen = function (e, t, o) {
            var i,
                n,
                s = window.scrollX,
                r = window.scrollY,
            ...
            (this.manualBlock = !0),
                ...
                this.table.options.printHeader &&
                    ...
                    "string" == typeof i ? (a.innerHTML = i) : a.appendChild(i),
    ...
    (I.prototype.watchData = function (e) {
        ...
        (I.prototype.unwatchData = function () {
        ...
        (I.prototype.watchRow = function (e) {
            var t = e.getData();
            this.blocked = !0;
            for (var o in t) this.watchKey(e, t, o);
            this.blocked = !1;
        }),
        (I.prototype.watchKey = function (e, t, o) {
            var i = this,
        ...
        (I.prototype.unwatchRow = function (e) {
            var t = e.getData();
            for (var o in t) Object.defineProperty(t, o, { value: t[o] });
        }),
        (I.prototype.block = function () {
            this.blocked = !0;
        }),
        (I.prototype.unblock = function () {
            this.blocked = !1;
        }),
        u.prototype.registerModule("reactiveData", I);
    var O = function (e) {
        (this.table = e), (this.startColumn = !1), (this.startX = !1), (this.startWidth = !1), (this.handle = null), (this.prevHandle = null);
    };
    (O.prototype.initializeColumn = function (e, t, o) {
        var i = this,
            n = !1,
        ...
        if (("header" === e && ((n = "textarea" == t.definition.formatter || t.definition.variableHeight), (t.modules.resize = { variableHeight: n })), !0 === s || s == e)) {
            ...
            r.addEventListener("mousedown", l),
                r.addEventListener("touchstart", l, { passive: !0 }),
            ...
            a.addEventListener("mousedown", c),
                a.addEventListener("touchstart", c, { passive: !0 }),
        ...
        u.prototype.registerModule("resizeColumns", O);
    var j = function (e) {
    ...
    (j.prototype.initializeRow = function (e) {
        ...
        n.addEventListener("mousedown", r), n.addEventListener("touchstart", r, { passive: !0 }), o.appendChild(i), o.appendChild(n);
    }),
        ...
        u.prototype.registerModule("resizeRows", j);
    var V = function (e) {
    ...
    (V.prototype.initialize = function (e) {
                  ...
                  (this.observer = new ResizeObserver(function (e) {
                      if (!i.browserMobile || (i.browserMobile && !i.modules.edit.currentCell)) {
                          ...
                          (o.tableHeight == t && o.tableWidth == n) ||
                              ((o.tableHeight = t), (o.tableWidth = n), i.element.parentNode && ((o.containerHeight = i.element.parentNode.clientHeight), (o.containerWidth = i.element.parentNode.clientWidth)), i.redraw());
                      }
                  })),
        ...
        (V.prototype.clearBindings = function (e) {
        ...
        u.prototype.registerModule("resizeTable", V);
    var G = function (e) {
    ...
    (G.prototype.initialize = function () {
        ...
        (G.prototype.initializeRow = function (e) {
            var t;
            "calc" !== e.type &&
                ((t = document.createElement("div")), t.classList.add("tabulator-responsive-collapse"), (e.modules.responsiveLayout = { element: t, open: this.collapseStartOpen }), this.collapseStartOpen || (t.style.display = "none"));
        }),
        (G.prototype.layoutRow = function (e) {
            var t = e.getElement();
            e.modules.responsiveLayout && (t.appendChild(e.modules.responsiveLayout.element), this.generateCollapsedRowContent(e));
        }),
        (G.prototype.updateColumnVisibility = function (e, t) {
        ...
        (G.prototype.showColumn = function (e) {
            ...
            e.show(!1, !0),
                ...
                "collapse" === this.mode &&
                    ((t = this.hiddenColumns.indexOf(e)), t > -1 && this.hiddenColumns.splice(t, 1), this.generateCollapsedContent(), this.collapseHandleColumn && !this.hiddenColumns.length && this.collapseHandleColumn.hide());
        }),
        ...
        (G.prototype.generateCollapsedContent = function () {
            var e = this;
            this.table.rowManager.getDisplayRows().forEach(function (t) {
                e.generateCollapsedRowContent(t);
            });
        }),
        (G.prototype.generateCollapsedRowContent = function (e) {
            var t, o;
        ...
        (G.prototype.generateCollapsedRowData = function (e) {
            var t,
                o = this,
                i = e.getData(),
                n = [];
                ...
                this.hiddenColumns.forEach(function (s) {
                    ...
                    s.definition.title &&
                        ...
                        (s.modules.format && o.table.options.responsiveLayoutCollapseUseFormatters
                            ...
                            : n.push({ title: s.definition.title, value: r }));
                }),
                n
            );
        }),
        (G.prototype.formatCollapsedData = function (e) {
    ...
    (W.prototype.clearSelectionData = function (e) {
        ...
        (W.prototype.toggleRow = function (e) {
        ...
        (W.prototype.selectRows = function (e) {
            var t,
                o = this;
            switch (void 0 === e ? "undefined" : _typeof(e)) {
                case "undefined":
        ...
        (W.prototype._selectRow = function (e, t, o) {
        ...
        (W.prototype.isRowSelected = function (e) {
            return -1 !== this.selectedRows.indexOf(e);
        }),
        (W.prototype.deselectRows = function (e, t) {
            var o,
                i = this;
            if (void 0 === e) {
        ...
        (W.prototype._deselectRow = function (e, t) {
            var o,
                i = this,
        ...
        (W.prototype.getSelectedData = function () {
            var e = [];
            return (
        ...
        (W.prototype.getSelectedRows = function () {
            var e = [];
            return (
                this.selectedRows.forEach(function (t) {
                    e.push(t.getComponent());
        ...
        (W.prototype._rowSelectionChanged = function (e) {
        ...
        (W.prototype.registerRowSelectCheckbox = function (e, t) {
            e._row.modules.select || (e._row.modules.select = {}), (e._row.modules.select.checkboxEl = t);
        }),
        (W.prototype.registerHeaderSelectCheckbox = function (e) {
            this.headerCheckboxElement = e;
        }),
        (W.prototype.childRowSelection = function (e, t) {
        ...
        u.prototype.registerModule("selectRow", W);
    var U = function (e) {
        (this.table = e), (this.sortList = []), (this.changed = !1);
    };
    (U.prototype.initializeColumn = function (e, t) {
        var o,
            i,
            n = this,
            s = !1;
            ...
            (void 0 === e.definition.headerSort ? !1 !== this.table.options.headerSort : !1 !== e.definition.headerSort) &&
                ...
                o.addEventListener("click", function (t) {
                    var o = "",
                        ...
                        s = !1;
                    if (e.modules.sort) {
                        if (e.modules.sort.tristate) o = "none" == e.modules.sort.dir ? e.modules.sort.startingDir : e.modules.sort.dir == e.modules.sort.startingDir ? ("asc" == e.modules.sort.dir ? "desc" : "asc") : "none";
                        else
        ...
        (U.prototype.hasChanged = function () {
            var e = this.changed;
            return (this.changed = !1), e;
        }),
        (U.prototype.getSort = function () {
            var e = this,
                t = [];
            return (
        ...
        (U.prototype.findSorter = function (e) {
            var t,
        ...
        (U.prototype.sort = function (e) {
            ...
            t.table.options.dataSorting && t.table.options.dataSorting.call(t.table, t.getSort()),
                ...
                t.table.options.dataSorted && t.table.options.dataSorted.call(t.table, t.getSort(), t.table.rowManager.getComponents("active"));
        }),
        (U.prototype.clearColumnHeaders = function () {
        ...
        (U.prototype.setColumnHeader = function (e, t) {
            (e.modules.sort.dir = t), e.getElement().setAttribute("aria-sort", t);
        }),
        (U.prototype._sortItems = function (e, t) {
            var o = this,
                i = t.length - 1;
            e.sort(function (e, n) {
                for (var s, r = i; r >= 0; r--) {
                    var a = t[r];
                    if (0 !== (s = o._sortRow(e, n, a.column, a.dir, a.params))) break;
                }
                return s;
            });
        }),
        (U.prototype._sortRow = function (e, t, o, i, n) {
            var s,
                r,
                a = "asc" == i ? e : t,
                l = "asc" == i ? t : e;
            return (
                (e = o.getFieldValue(a.getData())),
                (t = o.getFieldValue(l.getData())),
                (e = void 0 !== e ? e : ""),
                (t = void 0 !== t ? t : ""),
                (s = a.getComponent()),
                (r = l.getComponent()),
                o.modules.sort.sorter.call(this, e, t, s, r, o.getComponent(), i, n)
            );
        }),
        (U.prototype.sorters = {
            ...
            array: function (e, t, o, i, n, s, r) {
                ...
                var l = 0,
                    ...
                    h = 0;
                if (Array.isArray(e)) {
                    if (Array.isArray(t)) return (l = e ? a(e) : 0), (c = t ? a(t) : 0), l - c;
                    d = 1;
            ...
            alphanum: function (e, t, o, i, n, s, r) {
                ...
                if (e || 0 === e) {
                    if (t || 0 === t) {
                        ...
                        if (((a = String(e).toLowerCase()), (l = String(t).toLowerCase()), a === l)) return 0;
                        if (!m.test(a) || !m.test(l)) return a > l ? 1 : -1;
                        for (a = a.match(p), l = l.match(p), d = a.length > l.length ? l.length : a.length; h < d; )
                            if (((c = a[h]), (u = l[h++]), c !== u)) return isFinite(c) && isFinite(u) ? ("0" === c.charAt(0) && (c = "." + c), "0" === u.charAt(0) && (u = "." + u), c - u) : c > u ? 1 : -1;
        ...
        u.prototype.registerModule("sort", U);
    var Y = function (e) {
        this.table = e;
    };
    return (
        ...
        (Y.prototype._extractValidator = function (e) {
            var t, o, i;
            switch (void 0 === e ? "undefined" : _typeof(e)) {
                case "string":
        ...
        (Y.prototype._buildValidator = function (e, t) {
        ...
        (Y.prototype.validate = function (e, t, o) {
            var i = this,
                n = [];
            return (
                e &&
                    e.forEach(function (e) {
                        e.func.call(i, t, o, e.params) || n.push({ type: e.type, parameters: e.params });
                    }),
                !n.length || n
            );
        }),
        (Y.prototype.validators = {
        ...
        u.prototype.registerModule("validate", Y),
        u
    );
});
