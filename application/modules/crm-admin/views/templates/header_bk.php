...
<html>
  <head>
    ...
    <title><?php echo isset($page_title) ? $page_title : "default"; ?></title>
    ...
    <!-- Date Picker -->
   <!--  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/common/css/bootstrap-datepicker.min.css"> -->
    <!-- Daterange picker -->
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/frontend/css/style_php.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/common/css/dataTables.min.css">    
