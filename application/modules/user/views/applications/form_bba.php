...
if (!empty($applicant_schooling_list)) {
    ...
    if (!empty($applicant_schooling_list[1])) {
        $cur_qual_completed = $applicant_schooling_list[1]['result_declared'];
    }
}
...
if (isset($applicant_schooling_list)) {
    foreach ($applicant_schooling_list as $school) {
        ...
        ${ "attemptsetstenth_" . $schooltypename} = $school['attemptsetstenth'];
        ${ "attemptstwelth_" . $schooltypename} = $school['attemptstwelth'];
        ${ "completion_year_" . $schooltypename} = $school['completion_year'];
        
    }
}
$attemptsetstenth_tenth = isset($attemptsetstenth_tenth) ? $attemptsetstenth_tenth : '';
$attemptstwelth_twelfth = isset($attemptstwelth_twelfth) ? $attemptstwelth_twelfth : '';
                    ...
                    <div class="row mg-b-25 mt-3">
                        <div class="col-lg-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control " name="studied_from_india" id="studied_from_india" title="Select Status - Yes or No" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_GRAD_STATUS_MSG;?>" data-parsley-errors-container="#custom-studied_from_india-parsley-error">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mg-b-10-force" id="resident_status" style="display:none;">
                                ...
                                <select class="form-control " name="non_indian_resident" id="non_indian_resident" title="Select Resident Status" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_SELECT_RESIDENT_STATUS_MSG;?>" data-parsley-errors-container="#custom-non_indian_resident-parsley-error">
                    ...
                    <div class="row mg-b-25 mt-3">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group formAreaCols"  id="non-indian" style="display:none;">
                                <p>Foreign/ NRI /OCI/PIO Students please go to the below link to proceed further.</p>
                                <a target="_blank"
...
<input type="hidden" name="appln_status" id="appln_status" value="<?php echo $application_status_id; ?>">
        ...
        <fieldset>
                    ...
                    <div class="row mg-b-25 mt-3">
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label">Campus Preference 1 <span
                                        class="tx-danger">*</span></label>
                                <select class="form-control  study" data-placeholder="Select Campus Preference 1" tabindex="-1" aria-hidden="true" name="campus_pref_1" id="campus_pref_1" title="Select Campus Preference 1" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_CAMPUS_PREFERENCE1_MSG;?>" data-parsley-errors-container="#custom-campus_pref_1-parsley-error" data-parsley-trigger="change">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                ...
                                <span id="custom-field-error"></span>
            ...
            <hr/>
            <div class="w-100 pd-20 pd-sm-40">
                <h5 class="text-primary mb-3 mt-4">Personal Details</h5>
                <div class="form-layout">
                        ...
                        <div class="col-lg-4">
                            <div class="wd-200 w-100">
                                ...
                                <div class="input-group"><span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
                                    <input class="form-control hasDatepicker" name="pd_dob" id="pd_dob" placeholder="DD/MM/YYYY" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_DOB_MSG;?>" data-parsley-errors-container="#custom-pd_dob-parsley-error" value="<?php echo $dob; ?>">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4" id="main_div_social_status">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control select2" data-placeholder="Select Community" tabindex="-1" aria-hidden="true" name="pd_social_status" id="pd_social_status" title="Select Community" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_COMMUNITY_MSG;?>" data-parsley-errors-container="#custom-pd_social_status-parsley-error" data-parsley-trigger="change"> 
                                    <option value="">Select Your Community Status</option>                            
                                </select>
            ...
            <div id="selectForm" class="w-100">
                ...
                <div class="row">
                    <div class="col-lg-12 mb-3">
                        Only one attempt after first appearance is allowed.</div>
                </div>
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-4 pr-0">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="appering" name="current_qualification_status" class="custom-control-input"  data-parsley-required="true" data-parsley-required-message="Please Select Current Education Qualification Status" data-parsley-errors-container="#custom-current_qualification_status-parsley-error" data-parsley-trigger="change" value="1" <?php echo ($cur_qual_completed == 'f') ? 'checked' : ''; ?>>
                                        <label class="custom-control-label" for="appering">12th Appearing</label>
                                    </div>
                                </div>
                                <div class="col-lg-4 pl-0">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="completed" name="current_qualification_status" class="custom-control-input" value="2" <?php echo ($cur_qual_completed == 't') ? 'checked' : ''; ?>>
                    ...
                    <div class="col-lg-6 ">
                        <div class="form-group wd-xs-300 mr-5 w-100">
                            <label class="form-control-label">Candidate Name as in 10th Certificate
                                <span class="tx-danger">*</span></label>
                            <div class="form-group mg-b-10-force">                        
                                <input class="form-control" type="text" name="candidate_name" id="candidate_name" placeholder="Candidate's Name" maxlength="<?php echo APLCT_CAND_NAME_MAXLENGTH;?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CANDIDATE_NAME_MSG;?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_ONLY_MSG;?>" data-parsley-length="[<?php echo APLCT_CAND_NAME_MINLENGTH;?>, <?php echo APLCT_CAND_NAME_MAXLENGTH;?>]" value="<?php echo $name_as_in_marksheet; ?>">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input class="form-control" type="text" name="academic_tenth_inst" id="academic_tenth_inst" maxlength="<?php echo APLCT_INSTITUTE_NAME_MAXLENGTH;?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_INSTITUTE_NAME_MSG;?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_ONLY_MSG;?>" data-parsley-length="[<?php echo APLCT_INSTITUTE_NAME_MINLENGTH;?>, <?php echo APLCT_INSTITUTE_NAME_MAXLENGTH;?>]" value="<?php echo $inst_name_tenth; ?>">
                        </td>
                        <td>
                            <div class="form-group mg-b-10-force">
                            ...
                            <div class="form-group" id="other_board1" style="display:none;">
                                <input type="text" class="form-control" name="other_tenth_board" id="other_tenth_board" placeholder="If Other, please enter here.." maxlength="<?php echo APLCT_OTHER_BOARD_MAXLENGTH;?>"  value="<?php echo $other_board_name_tenth; ?>">
                            </div>
                        </td>				
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input class="form-control" type="text" name="academic_twelfth_inst" id="academic_twelfth_inst" maxlength="<?php echo APLCT_INSTITUTE_NAME_MAXLENGTH;?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_INSTITUTE_NAME_MSG;?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_ONLY_MSG;?>" data-parsley-length="[<?php echo APLCT_INSTITUTE_NAME_MINLENGTH;?>, <?php echo APLCT_INSTITUTE_NAME_MAXLENGTH;?>]" value="<?php echo $inst_name_twelfth; ?>">
                        </td>
                        <td>
                            <div class="form-group mg-b-10-force">
                        ...
                        <td>
                            <div class="form-group mg-b-10-force markdiv" > 
                        ...
                        <td>
                            <div class="markdiv">
                                <input class="form-control" type="text" name="academic_obtain_cgpa_twelfth" id="academic_obtain_cgpa_twelfth" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_PERCENT_CGPA_MSG;?>"  data-parsley-type-message="<?php echo REQD_PERCENT_CGPA_VALID_MSG;?>" min="<?php echo APLCT_MARK_MINLENGTH;?>" max="<?php echo APLCT_MARK_MAXLENGTH;?>" data-parsley-trigger="keyup" data-parsley-type="number" value="<?php echo $mark_percentage_twelfth; ?>" maxlength="<?php echo APLCT_PERCENT_CGPA_MAXLENGTH;?>">
                            </div>
                        </td>
                        <td>
                            <div class="form-group mg-b-10-force markdiv">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="digilocker_id" id="digilocker_id" placeholder="Enter Your NAD ID / Digilocker ID " data-parsley-required="false"  value="<?php echo $digilocker_id; ?>"  data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_NADID_MSG;?>" maxlength="<?php echo APLCT_NADID_MAXLENGTH;?>" >
                        </div>
                    </div>

                    <div class="col-lg-4">
                        <div class="form-group attempts" id="Attempts1" style="display: none;">
                            <label class="">No. Of Attempts For 10th  </label>
                            <div class="form-group mg-b-10-force">
                                <?php $attemps = 5; ?>
                                <select class="form-control " name="tenth_attempt" id="tenth_attempt">
                                    <option value="">Select</option>
                                    <?php                                  
                                    for ($i = 1; $i <= 5; $i++) {
                                        $selected = "";
                                        if ($i == $attemptsetstenth_tenth) {
                                            $selected = "selected";
                                        }
                                        ?>
                    ...
                    <div class="col-lg-4">
                        <div class="form-group attempts" id="Attempts-2" style="display: none;">
                            <label class="">No. Of Attempts For 12th </label>
                            <div class="form-group mg-b-10-force">
                            <?php $attemps = 5;?>
                                <select class="form-control " id="twelfth_attempt" name="twelfth_attempt">
                                    <option value="">Select</option>
                                    <?php
                                    for ($i = 1; $i <= 5; $i++) {
                                        $selected = "";
                                        if ($i == $attemptstwelth_twelfth) {
                                            $selected = "selected";
                                        }
                                        ?>
                                      <option <?php echo $selected; ?> value="<?php echo $i; ?>"><?php echo $i; ?></option>
                      ...
                      <div id="payment_details" style="display: none;">
                          ...
                          <div class="col-md-12 mt-3">
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <input class="form-control" type="text" name="DDDate" id="DDDate" placeholder="DD Date" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_DD_DATE_MSG;?>" value="<?php echo $dd_cheque_date; ?>">
                                  </div>
...
<?php if (isset($docs[$document_id_photograph])) { ?>
                                       ...
                                       <a href="javascript:void(0)" data-del-file-id="<?php if (isset($docs[$document_id_photograph])) {
        echo $docs[$document_id_photograph]['id'];
    } ?>" data-doc-id="<?php echo $document_id_photograph; ?>" data-toggle="modal" data-target="#contentDeletePop" data-field="photograph" data-required="true" onclick="removeClick(this)"><i class="fa fa-trash" aria-hidden="true"></i></a>-->
...
<?php if (isset($docs[$document_id_signature])) { ?>
          ...
          <a href="javascript:void(0)" data-del-file-id="<?php if (isset($docs[$document_id_signature])) {
        echo $docs[$document_id_signature]['id'];
    } ?>" data-doc-id="<?php echo $document_id_signature; ?>" data-toggle="modal" data-target="#contentDeletePop" data-field="signature" data-required="true" onclick="removeClick(this)"><i class="fa fa-trash" aria-hidden="true"></i></a> -->
...
<?php } ?>
                        ...
                        <div class="row w-100">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="applicant_name" id="applicant_name" placeholder="Enter Applicant Name" maxlength="<?php echo APLCT_DECLR_NAME_MAXLENGTH;?>" data-parsley-required="true" data-parsley-nameonly="true" data-parsley-required-message="<?php echo REQD_APPLT_NAME_MSG;?>" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG;?>" data-parsley-length="[<?php echo APLCT_DECLR_NAME_MINLENGTH;?>, <?php echo APLCT_DECLR_NAME_MAXLENGTH;?>]" value="<?php echo $applicant_name; ?>">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row w-100 mt-3">
                            <!--  <div class="col-md-6">
                                <a target="_blank" href="<?php echo base_url(); ?>bba_preview">
