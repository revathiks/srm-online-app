...
class Curl
{
    ...
    public $last_response;                 // URL of the session
    protected $_ci;   // Populates curl_setopt_array
    protected $response = '';   // Populates extra HTTP headers
    protected $session;             // Error code returned as an int
    protected $url;           // Error message returned as a string
    protected $options = array ();                   // Returned after request (elapsed time, etc)
    ...
    public function execute ()
    {
        ...
        if ( $this->response === FALSE ) {
            ...
            /* $this->last_response = [
                  ...
                  $this->last_response = json_encode($this->last_response);
