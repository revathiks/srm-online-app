    <h4 class="font-size-18 text-center">International Admission <?php echo date('Y');?></h4>
    <p class="text-muted text-center">Sign in to continue with SRM Admission.</p>    
    <?php
        $attributes = array('class' => 'loginForm custom-validation', 'id' => 'internationalloginForm' , 'name' => 'internationalloginForm');
    ...
    <div class="form-group mt-2 mb-0 row">
        <div class="col-12 mt-3">
            <a href="<?php echo base_url();?>forgot_pwd_international"><i class="mdi mdi-lock"></i> Forgot password?</a>
        </div>
    </div>
    <?php form_close();?>

    <div class="mt-4 pt-2 text-center">
        <p>Don't have an account ? <?php if($pgm_name == ''){ ?> <a href="<?php echo base_url('international-form/register');?>" class="font-weight-medium text-primary"> Signup now </a> <?php } else { ?>  <a href="<?php echo base_url('register/'.$pgm_name);?>" class="font-weight-medium text-primary"> Signup now </a> <?php } ?> </p>    
    </div>
