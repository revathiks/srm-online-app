...
$url = base_url().'mtechresearch?startIndex='.$startIndex;
if($mode_edit == ADMIN_MODE_EDIT)
{
  $url = base_url().'mtechresearch/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
}
/*CRM ADMIN Edit form start*/
?>
...
<div class="disable_div_preview" id="mtechresearch_form">
<div class="row">
   <div class="col-sm-12">
      <div class="" id="MtechresearchPreviewToPrint">
         <div class="card-body">
