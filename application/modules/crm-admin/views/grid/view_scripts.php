...
<script>
	$(document).ready(function () {
		...
		/** Column as JSON **/
		var columns = [{ title: "Form Name", field: "appln_form_name"},{ title: "Applicant Name", field: "applicant_name_declaration",formatter:name },{ title: "Payment Mode", field: "form_payment_mode" ,formatter:payment_mode},{ title: "Payment Start Date", field: "created_at",formatter:payment_created_at},{ title: "Completed %", field: "completion_percent",formatter:progress}];
