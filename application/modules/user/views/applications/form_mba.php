...
$result_declare_date = isset($applicant_other_details_list['expectedmonthyearresult']) ? date('m/Y', strtotime($applicant_other_details_list['expectedmonthyearresult'])) : '';
...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'mba_form', 'name' => 'mba_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
?>
<div class="row">
 <div class="col-sm-12">
                    ...
                    <div class="row mg-b-25 mt-3">
                        <div class="col-lg-6">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label">Graduation from India ? <span
...
<div class="w-100 pd-20 pd-sm-40">
	<h5 class="text-primary mb-3">Select Course and Campus Preference</h5><hr/>
	<div class="form-layout">		
		<div class="row mg-b-25 mt-3 campus_course_div">			
			...
			<div class="col-lg-6" id="main_div_course_prefer_1" style="display:none;">
				<div class="form-group mg-b-10-force">
                            ...
                            <select class="form-control custom-select study" data-placeholder="Select Course Preference 1" tabindex="-1" aria-hidden="true" name="course_pref_1" id="course_pref_1" title="Select Course Preference 1" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_COURSE_PREFERENCE1_MSG; ?>" data-parsley-errors-container="#custom-course_pref_1-parsley-error" data-parsley-trigger="change">
		...
		<div class="row mg-b-25 mt-3 campus_course_div">
			<div class="col-lg-6">
				<div class="form-group mg-b-10-force">
                    <label class="form-control-label">Campus Preference 2 </label>
                           <select class="form-control custom-select study" data-placeholder="Select Campus Preference 2" tabindex="-1" aria-hidden="true" name="campus_pref_2" id="campus_pref_2" title="Select Campus Preference" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_CAMPUS_PREFERENCE2_MSG; ?>" data-parsley-errors-container="#custom-campus_pref_2-parsley-error" data-parsley-trigger="change">
			...
			<div class="col-lg-6" id="main_div_course_prefer_2" style="display:none;">
				 <div class="form-group mg-b-10-force">
                            ...
                            <select class="form-control custom-select study" data-placeholder="Select Course Preference 2" tabindex="-1" aria-hidden="true" name="course_pref_2" id="course_pref_2" title="Select Course Preference 2" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_COURSE_PREFERENCE2_MSG; ?>" data-parsley-errors-container="#custom-course_pref_2-parsley-error" data-parsley-trigger="change">
		...
		<div class="row mg-b-25 mt-3 campus_course_div">
				...
				<div class="form-group mg-b-10-force">
                    <label class="form-control-label">Campus Preference 3
                         ...
                         <select class="form-control custom-select study" data-placeholder="Select Campus Preference 3" tabindex="-1" aria-hidden="true" name="campus_pref_3" id="campus_pref_3" title="Select Campus Preference" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_SELECT_CAMPUS_PREFERENCE3_MSG; ?>" data-parsley-errors-container="#custom-campus_pref_3-parsley-error" data-parsley-trigger="change">
                            ...
                            <span class="custom-field-error" id="custom-field-campus-error" ></span>
			...
			<div class="col-lg-6" id="main_div_course_prefer_3" style="display:none;">
				   <div class="form-group mg-b-10-force">
                            ...
                            <select class="form-control custom-select study" data-placeholder="Select Course Preference 3" tabindex="-1" aria-hidden="true" name="course_pref_3" id="course_pref_3" title="Select Course Preference 3" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_SELECT_COURSE_PREFERENCE3_MSG; ?>" data-parsley-errors-container="#custom-course_pref_3-parsley-error" data-parsley-trigger="change">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="pincode" id="pincode" placeholder="Enter Pincode" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_PINCODE_MSG;?>" value="<?php echo $pin_code; ?>" data-parsley-maxlength="6" data-parsley-type="digits" data-parsley-type-message="<?php echo VALID_PINCODE_MSG;?>" data-parsley-minlength="6" data-parsley-maxlength="6" maxlength="<?php echo APLCT_PINCODE_MAXLENGTH; ?>" onkeypress="return isNumber(event);"
                    </div>
                </div><!-- col-4 -->		  
            </div>
            <div class="row">	  
...
<fieldset>
        <div id="accordion" class="accordion w-100" role="tablist" aria-multiselectable="true" >
            <div class="card ">
                <div class="card-header p-0 " role="tab" id="headingOne">
                    <h6 class="p-2 ml-3">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="tx-gray-800 transition collapsed instruction_accordion"><i class="fas fa-info-circle"></i>Instructions</a>
                    </h6>
                </div><!-- card-header -->
				<div id="collapseOne" class="collapse bg-light" role="tabpanel" aria-labelledby="headingOne" style="">
                   <div class="card-body" style="font-size: 13px;">
                ...
                <div class="col-lg-6 ">
                    <div class="form-group wd-xs-300 mr-5 w-100">
                        ...
                        <div class="form-group mg-b-10-force">
                            ...
                            <small id="emailHelp" class="form-text text-muted">Kindly type "NA" in case Certificate is not available with you.</small>
                        </div>
                    </div><!-- form-group -->
                </div>
            </div>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                      ...
                      <input class="form-control" type="text" name="institute_name" id="institute_name" placeholder="Enter Institute Name" data-parsley-required="true" data-parsley-nameonly="true" data-parsley-required-message="<?php echo REQD_INSTITUTE_NAME_MSG;?>" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG;?>" data-parsley-length="[<?php echo APLCT_CAND_NAME_MINLENGTH; ?>, <?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>]" value="<?php echo $applicant_grad_det_insti_name; ?>" maxlength="<?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>" data-parsley-trigger="change">
                      <span class="tx-danger required_asterisk">*</span>
                    </td>
                    <td>
                      <div class="form-group mg-b-10-force">
                        <select class="form-control custom-select" id="institute_university" name="institute_university" data-placeholder="Select University" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_UNIVERSITY_MSG; ?>" data-parsley-errors-container="#custom-institute_university-parsley-error">
                          <option value="">Select</option>
                        </select>
                        <span class="tx-danger required_asterisk">*</span>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="nad_id_digilocker_id" id="nad_id_digilocker_id" placeholder="<?php echo REQD_NADID_MSG; ?>" value="<?php echo $nad_id_digilocker_id; ?>" maxlength="<?php echo APLCT_NADID_MAXLENGTH; ?>" data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_NADID_MSG; ?>">
                    ...
                    <table class="table table-bordered mt-5">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="reg_width">
                            <input class="form-control" type="text" name="registration_no_1" id="registration_no_1" placeholder="Registration No" maxlength="<?php echo APLCT_REG_NO_MAXLENGTH; ?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_COMP_REGNO_MSG;?>" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_registration_no[0]; ?>" data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_REG_NO_MSG; ?>" data-parsley-length="[<?php echo APLCT_REG_NO_MINLENGTH; ?>, <?php echo APLCT_REG_NO_MAXLENGTH; ?>]">
                            <span class="tx-danger required_asterisk">*</span>
                          </td>
                          <td>
                            <input class="form-control" type="text" name="score_obtained_1" id="score_obtained_1" placeholder="Score Obtained" maxlength="<?php echo APLCT_SCORE_MAXLENGTH; ?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SCORE_MSG; ?>" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_score_obtained[0]; ?>" data-parsley-type="number">
                            <span class="tx-danger required_asterisk">*</span>
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_1" id="max_score_1" placeholder="Max Score" maxlength="<?php echo APLCT_MAX_SCORE_MAXLENGTH; ?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_MAX_SCORE_MSG; ?>" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_max_score[0]; ?>" data-parsley-type="number">
                            <span class="tx-danger required_asterisk">*</span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
							<div class="form-group mg-b-10-force">
								...
								<input type="hidden" placeholder="" id="comp_exam_pk_id_2" name="comp_exam_pk_id_2" value="<?php echo $applicant_comp_exam_pk_id[1]; ?>">
							</div>
                          </td>
                          <td class="reg_width">
                          ...
                          <td>
                            <input class="form-control" type="text" name="score_obtained_2" id="score_obtained_2" placeholder="Score Obtained" maxlength="<?php echo APLCT_SCORE_MAXLENGTH; ?>" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_SCORE_MSG;?>" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_score_obtained[1]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_2" id="max_score_2" placeholder="Max Score" maxlength="<?php echo APLCT_MAX_SCORE_MAXLENGTH; ?>" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_MAX_SCORE_MSG;?>" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_max_score[1]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                          ...
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_2" id="air_overall_rank_2" placeholder="AIR / Overall Rank" maxlength="<?php echo APLCT_OVERALL_RANK_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_all_india_rank[1]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                          </td>
                          <td>
							<div class="form-group mg-b-10-force">
                            <select class="form-control custom-select study" id="qualified_not_qualified_2" name="qualified_not_qualified_2" data-parsley-errors-container="#custom-qualified_not_qualified_2-parsley-error">
                                <option value="">Select Qualified / Not Qualified</option>
                                <option value="qualified">Qualified</option>
                                <option value="not_qualified">Not Qualified</option>
                            </select>
                        ...
                        <tr>
                          <td>
                            <input type="hidden" placeholder="" id="comp_exam_pk_id_3" name="comp_exam_pk_id_3" value="<?php echo $applicant_comp_exam_pk_id[2]; ?>">
                          ...
                          <td class="reg_width">
                            <input class="form-control" type="text" name="registration_no_3" id="registration_no_3" placeholder="Registration No" maxlength="<?php echo APLCT_REG_NO_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_registration_no[2]; ?>" data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_REG_NO_MSG; ?>" data-parsley-length="[<?php echo APLCT_REG_NO_MINLENGTH; ?>, <?php echo APLCT_REG_NO_MAXLENGTH; ?>]">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="score_obtained_3" id="score_obtained_3" placeholder="Score Obtained" maxlength="<?php echo APLCT_SCORE_MAXLENGTH; ?>"value="<?php echo $applicant_comp_exam_score_obtained[2]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_3" id="max_score_3" placeholder="Max Score" maxlength="<?php echo APLCT_MAX_SCORE_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_max_score[2]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                          ...
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_3" id="air_overall_rank_3" placeholder="AIR / Overall Rank" maxlength="<?php echo APLCT_OVERALL_RANK_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_all_india_rank[2]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                          </td>
                          <td>
							<div class="form-group mg-b-10-force">
                            <select class="form-control custom-select study" id="qualified_not_qualified_3" name="qualified_not_qualified_3" data-parsley-errors-container="#custom-qualified_not_qualified_3-parsley-error">
                                <option value="">Select Qualified / Not Qualified</option>
                                <option value="qualified">Qualified</option>
                                <option value="not_qualified">Not Qualified</option>
                            </select>
                        ...
                        <tr>
                          <td>
                            <input type="hidden" placeholder="" id="comp_exam_pk_id_4" name="comp_exam_pk_id_4" value="<?php echo $applicant_comp_exam_pk_id[3]; ?>">
                            <select class="form-control custom-select study" id="competitive_exam_4" name="competitive_exam_4" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_COMP_EXAM_MSG; ?>" data-parsley-errors-container="#custom-competitive_exam_4-parsley-error" data-parsley-trigger="change"></select>
                            <span id="custom-competitive_exam_4-parsley-error"></span>
                          </td>
                          <td class="reg_width">
                            <input class="form-control" type="text" name="registration_no_4" id="registration_no_4" placeholder="Registration No" maxlength="<?php echo APLCT_REG_NO_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_registration_no[3]; ?>" data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_REG_NO_MSG;?>">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="score_obtained_4" id="score_obtained_4" placeholder="Score Obtained" maxlength="<?php echo APLCT_SCORE_MAXLENGTH; ?>"value="<?php echo $applicant_comp_exam_score_obtained[3]; ?>" data-parsley-type="number" data-parsley-length="[<?php echo APLCT_REG_NO_MINLENGTH; ?>, <?php echo APLCT_REG_NO_MAXLENGTH; ?>]">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_4" id="max_score_4" placeholder="Max Score" maxlength="<?php echo APLCT_MAX_SCORE_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_max_score[3]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                              <input class="form-control" type="text" name="year_appeared_4" id="year_appeared_4" placeholder="YYYY" maxlength="<?php echo APLCT_YEAR_APPEAR_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_exam_year[3]; ?>" readonly>
                          </td>
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_4" id="air_overall_rank_4" placeholder="AIR / Overall Rank" maxlength="<?php echo APLCT_OVERALL_RANK_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_all_india_rank[3]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                          </td>
                          <td>
							<div class="form-group mg-b-10-force">
                            <select class="form-control custom-select study" id="qualified_not_qualified_4" name="qualified_not_qualified_4" data-parsley-errors-container="#custom-qualified_not_qualified_4-parsley-error">
                                <option value="">Select Qualified / Not Qualified</option>
                                <option value="qualified">Qualified</option>
                                <option value="not_qualified">Not Qualified</option>
                            </select>
							<span id="custom-qualified_not_qualified_4-parsley-error"></span>
							</div>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <input class="form-control" type="hidden" placeholder="" id="comp_exam_pk_id_5" name="comp_exam_pk_id_5" value="<?php echo $applicant_comp_exam_pk_id[4]; ?>">
                            <select class="form-control custom-select study" id="competitive_exam_5" name="competitive_exam_5" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_COMP_EXAM_MSG; ?>" data-parsley-errors-container="#custom-competitive_exam_5-parsley-error" data-parsley-trigger="change"></select>
                            <span id="custom-competitive_exam_5-parsley-error"></span>
                          </td>
                          <td class="reg_width">
                            <input class="form-control" type="text" name="registration_no_5" id="registration_no_5" placeholder="Registration No" maxlength="<?php echo APLCT_REG_NO_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_registration_no[4]; ?>" data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_REG_NO_MSG; ?>" data-parsley-length="[<?php echo APLCT_REG_NO_MINLENGTH; ?>, <?php echo APLCT_REG_NO_MAXLENGTH; ?>]">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="score_obtained_5" id="score_obtained_5" placeholder="Score Obtained" maxlength="<?php echo APLCT_SCORE_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_score_obtained[4]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_5" id="max_score_5" placeholder="Max Score" maxlength="<?php echo APLCT_MAX_SCORE_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_max_score[4]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                              <input class="form-control" type="text" name="year_appeared_5" id="year_appeared_5" placeholder="YYYY" maxlength="<?php echo APLCT_YEAR_APPEAR_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_exam_year[4]; ?>" readonly>
                          </td>
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_5" id="air_overall_rank_5" placeholder="AIR / Overall Rank" maxlength="<?php echo APLCT_OVERALL_RANK_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_all_india_rank[4]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                          </td>
                          <td>
							<div class="form-group mg-b-10-force">
                            <select class="form-control custom-select study" id="qualified_not_qualified_5" name="qualified_not_qualified_5" data-parsley-errors-container="#custom-qualified_not_qualified_5-parsley-error">
                                <option value="">Select Qualified / Not Qualified</option>
                                <option value="qualified">Qualified</option>
                                <option value="not_qualified">Not Qualified</option>
                            </select>
							<span id="custom-qualified_not_qualified_5-parsley-error"></span>
							</div>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td>
                            <input type="hidden" placeholder="" id="comp_exam_pk_id_6" name="comp_exam_pk_id_6" value="<?php echo $applicant_comp_exam_pk_id[5]; ?>">
                            <select class="form-control custom-select study" id="competitive_exam_6" name="competitive_exam_6" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_COMP_EXAM_MSG; ?>" data-parsley-errors-container="#custom-competitive_exam_6-parsley-error" data-parsley-trigger="change"></select>
                            <span id="custom-competitive_exam_6-parsley-error"></span>
                          </td>
                          <td class="reg_width">
                            <input class="form-control" type="text" name="registration_no_6" id="registration_no_6" placeholder="Registration No" maxlength="<?php echo APLCT_REG_NO_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_registration_no[5]; ?>" data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_REG_NO_MSG; ?>">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="score_obtained_6" id="score_obtained_6" placeholder="Score Obtained" maxlength="<?php echo APLCT_SCORE_MAXLENGTH; ?>"value="<?php echo $applicant_comp_exam_score_obtained[5]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_6" id="max_score_6" placeholder="Max Score" maxlength="<?php echo APLCT_MAX_SCORE_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_max_score[5]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                              <input class="form-control" type="text" name="year_appeared_6" id="year_appeared_6" placeholder="YYYY" maxlength="<?php echo APLCT_YEAR_APPEAR_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_exam_year[5]; ?>" readonly>
                          </td>
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_6" id="air_overall_rank_6" placeholder="AIR / Overall Rank" maxlength="<?php echo APLCT_OVERALL_RANK_MAXLENGTH; ?>" value="<?php echo $applicant_comp_exam_all_india_rank[5]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);" onkeypress="return isNumber(event);">
                          </td>
                          <td>
							<div class="form-group mg-b-10-force">
                            <select class="form-control custom-select study" id="qualified_not_qualified_6" name="qualified_not_qualified_6" data-parsley-errors-container="#custom-qualified_not_qualified_6-parsley-error">
                                <option value="">Select Qualified / Not Qualified</option>
                                <option value="qualified">Qualified</option>
                                <option value="not_qualified">Not Qualified</option>
                            </select>
							<span id="custom-qualified_not_qualified_6-parsley-error"></span>
							</div>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <table class="table table-striped table-bordered" id="table5">
                      ...
                      <tbody>
                         <tr>
                            ...
                            <td>
                               <div class="form-group">                               
                               <select class="form-control custom-select study" id="sector_0" name="sector_0" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SECTOR_MSG;?>" data-parsley-errors-container="#custom-sector_0-parsley-error" data-parsley-trigger="change">
                               <option value="">Select</option>                               
                               </select>
                                <span id="custom-sector_0-parsley-error"></span>
                               <span class="tx-danger required_asterisk">*</span>
                               <div id="othersector_0" style="display:none;" class="form-group mt-1">
                                <input class="form-control" type="text" name="other_sector_0" id="other_sector_0"  placeholder="If Other, please enter here..." data-parsley-required="false"   data-parsley-errors-container="#custom-other_sector_0-parsley-error" value="<?php echo $other_sector[0]; ?>" maxlength="<?php echo APLCT_OTHER_SECTOR_MAXLENGTH; ?>">
                         ...
                         <tr>
                            ...
                            <td>
                               <div class="form-group">
                               <select class="form-control custom-select study" id="sector_1" name="sector_1" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_SECTOR_MSG;?>" data-parsley-errors-container="#custom-sector_1-parsley-error" data-parsley-trigger="change">
                               <option value="">Select</option>
                               </select>
                               <span id="custom-sector_1-parsley-error"></span>
                               <div id="othersector_1" style="display:none;" class="form-group mt-1">
                                <input class="form-control" type="text" name="other_sector_1" id="other_sector_1"  placeholder="If Other, please enter here..." data-parsley-required="false"   data-parsley-errors-container="#custom-other_sector_1-parsley-error" value="<?php echo $other_sector[1]; ?>"  maxlength="<?php echo APLCT_OTHER_SECTOR_MAXLENGTH; ?>">
                         ...
                         <tr>
                            ...
                            <td>
                               <div class="form-group">
                               <select class="form-control custom-select study" id="sector_2" name="sector_2" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_SECTOR_MSG;?>" data-parsley-errors-container="#custom-sector_2-parsley-error" data-parsley-trigger="change">
                               <option value="">Select</option>
                               </select>
                               <span id="custom-sector_2-parsley-error"></span>
                               <div id="othersector_2" style="display:none;" class="form-group mt-1">
                                <input class="form-control" type="text" name="other_sector_2" id="other_sector_2"  placeholder="If Other, please enter here..." data-parsley-required="false"   data-parsley-errors-container="#custom-other_sector_2-parsley-error" value="<?php echo $other_sector[2]; ?>"  maxlength="<?php echo APLCT_OTHER_SECTOR_MAXLENGTH; ?>">
						...
						<div class="mt-3">
							<div class="row">
								<div class="col-md-6">
									...
									<select class="form-control select2" name="BankName" id="BankName" title="Choose Bank Name" data-parsley-required="true" data-parsley-required-message="<?phpecho REQD_CHOOSE_BANK_MSG; ?>" data-parsley-errors-container="#custom-BankName-parsley-error">
										<option value=""  selected="selected">Select Bank Name</option>
									</select>
									<span id="custom-BankName-parsley-error"></span>									
								</div>
								<div class="col-md-6">
									<input class="form-control" type="text" name="BranchName" placeholder="Branch Name" id="BranchName" data-parsley-required="true" data-parsley-required-message="Required" maxlength="<?php echo APLCT_BRANCH_NAME_MAXLENGTH; ?>" value="<?php echo $branch_name; ?>" data-parsley-nameonly='true'  data-parsley-nameonly-message="<?php echo VALID_BANK_NAME_MSG;?>">
								</div>
							</div>
				...
				<div class="row w-100">
					 <div class="form-group col-md-6 ">
                        ...
                        <div class="form-group col-md-6 ">
                                ...
                                <input type="file" class="filestyle" name="score_card" id="score_card" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_UPLOAD_WORK_EXP_SHEET_MSG; ?>" data-parsley-errors-container="#custom-score_card-parsley-error"data-parsley-max-file-size="<?php echo MAX_FILE_SIZE; ?>" data-max-file-size-js="<?php echo MAX_FILE_SIZE_JS; ?>" data-parsley-file-extension="<?php echo $file_allowed_type; ?>" onchange="upload_file(this.id)" data-file-id="<?php if (isset($docs[$document_id_score_card])) {
                                    echo $docs[$document_id_score_card]['id'];
...
<fieldset>
	<div id="accordion" class="accordion w-100" role="tablist" aria-multiselectable="true" >
          <div class="card ">
              <div class="card-header p-0 " role="tab" id="headingOne">
                  <h6 class="p-2 ml-3">
                      <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="tx-gray-800 transition collapsed"><i class="fas fa-info-circle"></i>
                          Instructions</a>
                  </h6>
              </div><!-- card-header -->
