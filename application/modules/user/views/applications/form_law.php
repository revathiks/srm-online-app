...
if($applicant_schooling_details_list)
{
  ...
  $applicant_school_stream_name[]=$v['other_stream_name'];
  }
}
...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 
  'id' => 'law_form', 'name' => 'law_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
                ...
                <div class="row mg-b-25 mt-3">
                   <div class="col-lg-4">
                      <div class="form-group mg-b-10-force">
                         ...
                         name="graduation_india" data-placeholder="Select Status - Yes or No" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_GRAD_STATUS_MSG; ?>" 
                         data-parsley-errors-container="#custom-graduation_india-parsley-error" data-parsley-trigger="change">
                   ...
                   <div class="col-lg-4">
                      <div class="form-group mg-b-10-force" id="resident">
                         ...
                         <span class="tx-danger">*</span></label>
                         <select class="form-control custom-select " id="resident_info" data-parsley-required="true" title="Choose Resident Status" data-parsley-required-message="<?php echo REQD_SELECT_RESIDENT_STATUS_MSG; ?>" data-parsley-errors-container="#custom-resident_status-parsley-error">
                         </select>
                   ...
                   <div class="col-lg-12" id="study_info">
                      <p class="checkbox_instructions">
                        <?php echo IS_AGREE_INFO; ?>
                      </p>
                      <label class="rdiobox">
          ...
          <div class="card w-100 pd-20 pd-sm-40">
             ...
             <div class="form-layout">
                <div class="row mg-b-25 mt-3">
                   ...
                   <!-- col-4 -->
                   <div class="col-lg-4" id="main_div_course_pref" style="display:none">
                      <div class="form-group mg-b-10-force">
                         <label class="form-control-label">Course Perference 
                            <span class="tx-danger">*</span></label>
                     <select class="form-control custom-select" id="course_pref" name="course_pref"
                     data-placeholder="Choose Course Preference" tabindex="-1" aria-hidden="true" title="Choose Course Preference 1" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_COURSE_PREFERENCE1_MSG; ?>" data-parsley-errors-container="#custom-course_pref-parsley-error" data-parsley-trigger="change" 
                     >
                         </select>
             ...
             <tbody>
              <tr>
                ...
                <td>
                    ...
                    data-parsley-required-message="<?php echo REQD_PERCENT_CGPA_MSG; ?>
                    " min="<?php echo APLCT_MARK_MINLENGTH; ?>" max="<?php echo APLCT_MARK_MAXLENGTH; ?>" data-parsley-trigger="keyup" data-parsley-errors-container="#custom-obtained_percentage_cgpa0-parsley-error" value="<?php echo $applicant_obtained_percentage_cgpa[0]; ?>"> 
  ...
  <table class="table table-bordered mt-0 ">
    ...
    <tbody>
      <tr>
              ...
              <input type="text" class="form-control" name="academic_stream_other" id="academic_stream_other" placeholder="If Other, please enter here.." maxlength="<?php echo APLCT_OTHER_STREAM_MAXLENGTH; ?>" value="<?php echo $applicant_school_stream_name[0]; ?>" data-parsley-required-message="<?php echo REQD_OTHER_STREAM_MSG;?>">
              </div>
              </div>
        </td>
              </tr>
      ...
      <div class="row mg-b-25 mt-3">
        ...
        <div class="row w-100">
          <div class="col-md-6">
            ...
            <input class="form-control" type="text" name="applicant_name" id="applicant_name" placeholder="Applicant Name" value="<?php echo $applicant_name_declaration ;?>" maxlength="<?php echo APLCT_DECLR_NAME_MAXLENGTH; ?>" data-parsley-required="true" data-parsley-nameonly="true" data-parsley-required-message="<?php echo REQD_APPLT_NAME_MSG; ?>" data-parsley-nameonly-message="<?php echo REQD_ALPHA_ONLY_MSG;?>" 
            data-parsley-length="[<?php echo APLCT_DECLR_NAME_MINLENGTH; ?>, <?php echo APLCT_DECLR_NAME_MAXLENGTH; ?>]" value="<?php echo $applicant_name; ?>" data-parsley-trigger="change">
          </div>
          <div class="col-md-6">
