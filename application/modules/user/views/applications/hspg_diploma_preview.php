...
$qualificationStyle="display:none;";
$twelfthmarkStyle="";
$ugtableCol="display:none;";
...
if($grad_id==DIPLOMA_GRAD){
    $twelfthreq="display:none";
    $ugreq="display:none";
}
if($grad_id==UG_GRAD){
    $ugreq="display:none";
}
if($grad_id==UG_GRAD && $qual_status_id!=HSPG_DIP_EDU_HSC_PASSED){
...
$applicant_grad_det_id_pg==isset($applicant_grad_det_id_pg) ? $applicant_grad_det_id_pg : '';
 ...
 $high_edu_ug = isset($grad_type_id_ug) ? $grad_type_id_ug : '';
$high_edu_ug_name=$high_edu[GRADUATION_UG_ID][$high_edu_ug];
$high_edu_ug_name=isset($high_edu_ug_name)?$high_edu_ug_name:'Select';
...
$url = base_url().'hspg_diploma?startIndex='.$startIndex;
if($mode_edit == ADMIN_MODE_EDIT)
{
    $url = base_url().'hspg_diploma/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
}
...
<div class="row disable_div_preview" id="hspg_diploma_form">
    <div class="col-sm-12">
        <div class="card " id="hspgPreviewToPrint">
            <div class="card-body">
                    ...
                    <div class="form-group mr-5">
                      ...
                      ?>
                          ...
                          <span id="custom-current_education_qual_status-parsley-error"></span>
                                    ...
                                    <div class="col-lg-6 print_margin_top_3">
                                    ...
                                    <table class="table table-bordered mt-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> <select class="form-control select2" name="tenth_highest_edu" id="tenth_highest_edu" title="Select" data-parsley-required="true" data-parsley-required-message="Please Select Current Highest Education" data-parsley-errors-container="#custom-tenth_highest_edu-parsley-error">
                                                 <option value=""><?php echo $high_edu_tenth_name;?></option>
                                                </select>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <p>Class 12th <span class="tx-danger" style="<?php echo $twelfthreq;?>">*</span></p>
                                                </td>
                                                <td>
                                                <select class="form-control select2" name="twelfth_highest_edu" id="twelfth_highest_edu" title="Select" data-parsley-required="true" data-parsley-required-message="Please Select Current Highest Education" data-parsley-errors-container="#custom-twelfth_highest_edu-parsley-error">
                                                 <option value=""><?php echo $high_edu_twelfth_name;?></option>
                                                </select>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                            <td><p>Diploma/ Graduation <span class="tx-danger" style="<?php echo $ugreq;?>">*</span></p></td>
                                            <td>
                                            <div style="<?php echo $ugtableCol;?>">
                                            <select class="form-control select2" name="ug_highest_edu" id="ug_highest_edu" title="Select" data-parsley-required="true" data-parsley-required-message="Please Select Current Highest Education" data-parsley-errors-container="#custom-ug_highest_edu-parsley-error">
                                             <option value=""><?php echo $high_edu_ug_name;?></option>
                                            </select>
                                            ...
                                            <td>
                                              <div class="form-group mg-b-10-force ugtableCol" style="<?php echo $ugtableCol;?>">
                                              ...
                                              <?php if($univ_id_ug==OTHER_UNIVERSITY) { ?>
                                                <div class="form-group ugtableCol" id="other_univ_ug" style="<?php echo $ugtableCol;?>">
