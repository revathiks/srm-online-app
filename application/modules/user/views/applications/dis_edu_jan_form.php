<?php 
   ...
   $attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'dist_edu_jan_form', 'name' => 'dist_edu_jan_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
      ...
      <table class="table table-bordered mt-0">
         ...
         <tbody>
            <tr>
               ...
               <td>
                  <div class="form-group mg-b-10-force">
                     <div class="form-group"><input type="text" name="academic_yr_passing" id="academic_yr_passing" class="form-control datepicker" placeholder="YYYY" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_YEAR_OF_PASSING_MSG; ?>" data-parsley-trigger="change" value="<?php echo $completion_year_tenth; ?>"maxlength="<?php echo APLCT_YEAR_OF_PASSING_MAXLENGTH; ?>" onkeypress="return isNumber(event);" autocomplete="off"></div>
