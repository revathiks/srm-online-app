...
$course_1 = isset($course_1) ? $course_1 : 'Select';
$course_2 = isset($course_2) ? $course_2 : 'Select';
$course_3 = isset($course_3) ? $course_3 : 'Select';
...
$campus_1 = isset($campus_1) ? $campus_1 : 'Select';
//end campus fetch
//set personal detail
...
$high_edu_tenth_name = $high_edu[SCHOOLING_ID_TENTH][$high_edu_tenth];
$high_edu_tenth_name = isset($high_edu_tenth_name) ? $high_edu_tenth_name : 'Select';
...
$high_edu_twelfth_name = $high_edu[SCHOOLING_ID_TWELFTH][$high_edu_twelfth];
$high_edu_twelfth_name = isset($high_edu_twelfth_name) ? $high_edu_twelfth_name : 'Select';
...
if ($applicant_graduations_list) {
    foreach ($applicant_graduations_list as $k => $v) {
        ...
        ${ "grad_type_id_" . $graduatioName} = $v['graduation_type_id'];
...
$yr_of_pass_pg = isset($yr_of_pass_pg) ? $yr_of_pass_pg : 'Select';
...
$url = base_url().'hspg_ee?startIndex='.$startIndex;
if($mode_edit == ADMIN_MODE_EDIT)
{
    $url = base_url().'hspg_ee/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
}
...
<div class="row disable_div_preview" id="hspg_ee_form">
    <div class="col-sm-12">
        <div class="card " id="HspgeePreviewToPrint">
            <div class="card-body">
                            ...
                            <div class="card-body">
                                <section class="row">
                                    <div class="w-100 pd-20 pd-sm-40">
                                        ...
                                        <div class="form-layout">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mg-b-10-force">
                                                        <label class="form-control-label">Campus <span
                                                                class="tx-danger">*</span></label>
                                                        <select class="form-control  study" data-placeholder="Select Campus Preference 1" tabindex="-1" aria-hidden="true" name="campus_pref_1" id="campus_pref_1" title="Select Campus Preference 1" data-parsley-required="true" data-parsley-required-message="Please Select Campus" data-parsley-errors-container="#custom-campus_pref_1-parsley-error" data-parsley-trigger="change">
                                                            <option value=""><?php echo $campus_1; ?> </option>
                                                        </select>
                                                        <div class="help_text"><b><?php echo HSPG_EE_CAMPUS_MSG;?></b></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mg-b-25 mt-3 campus_course_div">			
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group mg-b-10-force">
                                                        ...
                                                        <select class="form-control  study" data-placeholder="Select Course Preference 2" tabindex="-1" aria-hidden="true" name="course_pref_2" id="course_pref_2" title="Select Course Preference 2" data-parsley-required="false" data-parsley-required-message="Please Select Course Preference 2" data-parsley-errors-container="#custom-course_pref_2-parsley-error" data-parsley-trigger="change">
                                    ...
                                    <div class="row w-100">
                                        ...
                                        <?php
                                        if ($nation_id == COUNTRY_VALUE_DEFAULT) {
                                            ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                       <?php echo ATTEMPT_MSG;?>
                                    </div>
                                </div>
                                <div class="row w-100">
                                    <div class="col-lg-6" id="qualification_status" style="<?php echo $qualificationStyle; ?>">
                                        <div class="form-group mr-5">
                                            ...
                                            <div class="row">
                                                ...
                                                if ($qualification_list) {
                                                    foreach ($qualification_list as $list) {
                                                        $status_id = $list['qual_status_id'];

                                                        $qual_status_name = $list['qual_status_name'];
                                                        $is_passed = $list['is_passed'];
                                                        $status = "appering";
                                                        $value = $status_id;
                                                        ...
                                                        $checked = "";
                                                        if ($status_id == $qual_status_id) {
                                                            $checked = "checked";
                                                        }
                                                        ?>
                                                        <div class="col-lg-6 pr-0">
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" id="<?php echo $status; ?>" name="current_education_qual_status" class="custom-control-input"  data-parsley-required="true" data-parsley-required-message="Please Select Current Education Qualification Status" data-parsley-errors-container="#custom-current_education_qual_status-parsley-error" data-parsley-trigger="change" value="<?php echo $value; ?>" <?php echo $checked; ?>>
                                                                <label class="custom-control-label" for="<?php echo $status; ?>"><?php echo $qual_status_name; ?></label>
                                                            </div>
                                                        </div>
                                                        <?php
                                                    }
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group wd-xs-300 mr-5 w-100">
                                            <label class="form-control-label">Candidate's Name as per qualifying examination marksheet
                                                <span class="tx-danger">*</span></label>
                                            <div class="form-group mg-b-10-force">                        
                                ...
                                <section class="row">
                                        ...
                                        <table class="table table-bordered mt-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group mg-b-10-force">
                                                            <input class="form-control" type="text" value="<?php echo $completion_year_tenth; ?>">
                                                ...
                                                <tr>
                                                    <td>
                                                        <p>12th <span class="tx-danger">*</span></p>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><p>Graduation <span class="tx-danger">*</span></p></td>
                                                    <td>
                                                        <div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if ($univ_id_ug == OTHER_UNIVERSITY) { ?>
                                                            <div class="form-group ugtableCol" id="other_univ_ug" >
                                                    ...
                                                    <td>
                                                        <div class="ugtableCol form-group mg-b-10-force" id="appering_info_1" style="<?php echo $ugmarkStyle; ?>">
                                                    ...
                                                    <td>
                                                        <div class="form-group mg-b-10-force" id="appering_info_2" style="<?php echo $ugmarkStyle; ?>">
                                                            <input class="form-control" type="text" name="obtained_percentage_cgpa" placeholder="Obtained Percentage/CGPA" id="obtained_percentage_cgpa" maxlength="5" data-parsley-required="true" data-parsley-required-message="Please Enter Obtained Percentage/CGPA"  data-parsley-trigger="keyup" data-parsley-trigger="change" data-parsley-errors-container="#custom-obtained_percentage_cgpa-parsley-error" value="<?php echo $obtained_percentage_cgpa_ug; ?>"> 
                                    ...
                                    <div><h5 class="text-primary mb-3 mt-4 pgtable">For M.Phil Applicants Only </h5></div>
                                    <div class="table-responsive">
                                        <table class="table table-bordered  mt-0 pgtable" id="pgtable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group mg-b-10-force">
                                                            <select class="form-control " id="university_pg" name="university_pg" data-parsley-required="false" data-parsley-required-message="Please select university" title="Select university" data-parsley-errors-container="#custom-university_pg-parsley-error" data-parsley-trigger="change">
                                                    ...
                                                    <td>
                                                        <div class="form-group mg-b-10-force markpg">
                                                            <select class="form-control " id="user_marking_scheme_pg" name="user_marking_scheme_pg" data-parsley-required="false"  data-parsley-required-message="Please select marking schema" data-parsley-errors-container="#custom-user_marking_scheme_pg-error" data-parsley-trigger="change">
                                                    ...
                                                    <td>
                                                        <div class="form-group mg-b-10-force markpg">
                                                            <input class="form-control" type="text" placeholder="" id="obtained_percentage_cgpa_pg" name="obtained_percentage_cgpa_pg" maxlength="6" value="<?php echo $obtained_percentage_cgpa_pg; ?>" data-parsley-required="false"  data-parsley-required-message="Please Enter Percentage/CGPA" data-parsley-errors-container="#custom-obtained_percentage_cgpa_pg-error">
                                                    ...
                                                    <td>
                                                        <div class="form-group mg-b-10-force">						
                                                            <div>
                                                                <input class="form-control" type="text" name="yr_passing_pg" id="yr_passing_pg" class="form-control datepicker" placeholder="YYYY" data-parsley-required="false" data-parsley-required-message="Please select Year of Passing" data-parsley-trigger="change" value="<?php echo $yr_of_pass_pg; ?>" maxlength="4" onkeypress="return isNumber(event);">
                                                            </div>
                                            ...
                                            <div class="card mb-3 base_details_card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-lg-2">
                                                            <label class="rdiobox">
                                                                <input name="rdio" type="radio" id="online" data-parsley-required="true" data-parsley-required-message="Please Check The Value" data-parsley-errors-container="#custom-online-parsley-error" data-parsley-trigger="change" <?php
                                                        ...
                                                        <div class="col-lg-2">
                                                            <label class="rdiobox">
                                                                <input name="rdio" type="radio" id="dd" value="on" data-parsley-required="true" data-parsley-required-message="Please Check The Value" data-parsley-errors-container="#custom-dd-parsley-error" data-parsley-trigger="change" <?php
                                                                if ($payment_mode_id == PAYMENT_MODE_DEMAND_DRAFT_ID) {
                                                                    echo "checked";
                                                                }
                                                                ?>>
                                                                <span>DD</span>
                                        ...
                                        <div class="form-layout">
                                            <div class="row mg-b-25 mt-3">
                                                ...
                                                <div class="form-group col-md-6 ">
                                                    ...
                                                    <input type="file" class="filestyle" name="graduation_marksheet" id="graduation_marksheet" data-parsley-required="false" data-parsley-required-message="Please upload graduation marksheet" data-parsley-errors-container="#custom-graduation_marksheet-parsley-error"data-parsley-max-file-size="<?php echo MAX_FILE_SIZE; ?>" data-max-file-size-js="<?php echo MAX_FILE_SIZE_JS; ?>" data-parsley-file-extension="<?php echo $file_allowed_type; ?>" onchange="upload_file(this.id)" data-file-id="<?php if (isset($docs[$document_id_graduation_marksheet])) {
                                                        echo $docs[$document_id_graduation_marksheet]['id'];
                                                    } ?>"accept="<?php echo allow_extension($file_allowed_type); ?>">
                    									<?php if (isset($docs[$document_id_graduation_marksheet])) { ?>
                                                           ...
                                                           <a href="javascript:void(0)" data-del-file-id="<?php if (isset($docs[$document_id_graduation_marksheet])) {
                                                            echo $docs[$document_id_graduation_marksheet]['id'];
                                                        } ?>" data-doc-id="<?php echo $document_id_graduation_marksheet; ?>" data-toggle="modal" data-target="#contentDeletePop" data-field="graduation_marksheet" data-required="true" onclick="removeClick(this)"><i class="fa fa-trash" aria-hidden="true"></i></a>-->
