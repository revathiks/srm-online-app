...
/* if($grad_id==UG_GRAD || $grad_id==PG_GRAD){
    $ssclMaxYop=date("Y", strtotime(date("Y") . " - 24 months"));
} */
...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'hspg_diploma_form', 'name' => 'hspg_diploma_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
	...
	<div class="form-layout">
		<div class="row">
			<div class="col-lg-4">
				<div class="form-group mg-b-10-force">
					<label class="form-control-label">Program  <span class="tx-danger">*</span></label>
						<select class="form-control select2" data-placeholder="Select Program" tabindex="-1" aria-hidden="true" name="pd_program" id="pd_program" title="Select Program" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_PRG_MSG;?>" data-parsley-errors-container="#custom-pd_program-parsley-error">
			...
			<div class="col-lg-4" id="campus_div" style="display:none;">
                ...
                <div class="help_text"><b>Health Science Dip. PG Dip, Cert. Is Only Available In Main Campus Kattankulathur</b></div>
                </div>
            </div>
		</div>
		<div class="row mg-b-25 mt-3" id="course_div" style="display:none;">	
			...
			<div class="col-lg-4">
				 <div class="form-group mg-b-10-force">
                            ...
                            <select class="form-control custom-select study" data-placeholder="Select Course Preference 2" tabindex="-1" aria-hidden="true" name="course_pref_2" id="course_pref_2" title="Select Course Preference 2" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_SELECT_COURSE_PREFERENCE2_MSG;?>" data-parsley-errors-container="#custom-course_pref_2-parsley-error" data-parsley-trigger="change">
		...
		<div class="row">
           ...
           <div class="col-lg-6 ">
                    <div class="form-group wd-xs-300 mr-5 w-100">
                        ...
                        <div class="form-group mg-b-10-force">
                            <input class="form-control" type="text" name="candidate_name" id="candidate_name" placeholder="Enter Name" data-parsley-required="true" data-parsley-nameonly="true" data-parsley-required-message="<?php echo REQD_CANDIDATE_NAME_MSG;?>" data-parsley-nameonly-message="<?php echo REQD_ALPHA_ONLY_MSG;?>" data-parsley-length="[<?php echo APLCT_CAND_NAME_MINLENGTH;?>, <?php echo APLCT_CAND_NAME_MAXLENGTH;?>]" value="<?php echo $name_as_in_marksheet; ?>" maxlength="<?php echo APLCT_CAND_NAME_MAXLENGTH;?>" data-parsley-trigger="change">
                            <small id="emailHelp"
            ...
            <table class="table table-bordered mt-1">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="align-middle">Current / Highest Education</th>
                ...
                <tbody>
                    <tr>
                        <td>
                            <p>Class 10th <span class="tx-danger">*</span> </p>
                        </td>
                        <td>
                        <select class="form-control select2" name="tenth_highest_edu" id="tenth_highest_edu" title="Select" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CUR_HIGH_EDU_MSG;?>" data-parsley-errors-container="#custom-tenth_highest_edu-parsley-error">
                         <option value="">Select</option>
                        </select>
                        <span id="custom-tenth_highest_edu-parsley-error"></span>
                        </td>
                        <td>
                    ...
                    <tr class="table_twelfth">
                        <td>
                            <p>Class 12th <span class="tx-danger twelfthreq">*</span> </p>
                        </td>
                        <td>
                        <select class="form-control select2" name="twelfth_highest_edu" id="twelfth_highest_edu" title="Select" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CUR_HIGH_EDU_MSG;?>" data-parsley-errors-container="#custom-twelfth_highest_edu-parsley-error">
                         <option value="">Select</option>
                        </select>
                        <span id="custom-twelfth_highest_edu-parsley-error"></span>
                        </td>
                        <td>
                    ...
                    <tr class="ugtable">
                        <td>
                            <p>Diploma /Graduation <span class="tx-danger ugreq">*</span></p>
                        </td>
                        <td>
                        <div class="ugtableCol">
                        <select class="form-control select2" name="ug_highest_edu" id="ug_highest_edu" title="Select" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CUR_HIGH_EDU_MSG;?>" data-parsley-errors-container="#custom-ug_highest_edu-parsley-error">
                         <option value="">Select</option>
                        </select>
                        <span id="custom-ug_highest_edu-parsley-error"></span>
                        </div>
                        </td>
                        <td>
                        <div class="ugtableCol">
                        ...
                        <div class="form-group mg-b-10-force ugtableCol">
                          ...
                          <option value="">Select</option>
        					...
        					<input type="text" class="form-control" name="university_other_ug" id="university_other_ug" placeholder="If Other, please enter here.." maxlength="<?php echo APLCT_OTHER_UG_MAXLENGTH;?>" value="<?php echo $university_other_ug; ?>">
        				   </div>
                        ...
                        <td>
                            <div class="form-group mg-b-10-force markug ugtableCol" style="display:none;">
       ...
       <div class="col-lg-6">
                <div class="form-group">
                    <label class="form-control-label">NAD ID / Digilocker ID </label>
                     <input class="form-control" type="text" name="digilocker_id" id="digilocker_id" placeholder="Enter Your NAD ID / Digilocker ID " data-parsley-required="false"  data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_NADID_MSG;?>" value="<?php echo $digilocker_id;?>" maxlength="<?php echo APLCT_NADID_MAXLENGTH;?>">
	...
	<div class="col-md-12">
		<div class="form-layout">
			<div class="row mg-b-25 mt-3">
				...
				<div class="row w-100">
                      <div class="form-group col-md-6">
                          <label for="exampleFormControlTextarea1">Any Other Document 1 </label>
                      ...
                      <!-- other document 2 -->
                       <div class="form-group col-md-6">
                          <label for="exampleFormControlTextarea1">Any Other Document 2 </label>
