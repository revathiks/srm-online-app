 ...
 *
 */
class Mtech_research extends API_Controller {
    ...
    public function mtechresearch_parent_detail_post() {
		...
		if($parent_res)
		{
			$wizard_update = $this->common_wizardupdate($applicant_personal_det_id , APP_FORM_ID_MTECH_RESEARCH , FORM_WIZARD_PARENT_ADDRESS_ID);
    ...
    public function mtechresearch_acdemic_dtl_post()
	{
		...
		if($graduation_details_res) {
			$wizard_update = $this->common_wizardupdate($applicant_personal_det_id , APP_FORM_ID_MTECH_RESEARCH , FORM_WIZARD_ACADEMIC_ID);
	...
	public function mtechresearch_declaration_dtl_post()
	{
		...
		$wizard_update = $this->common_wizardupdate($applicant_personal_det_id , APP_FORM_ID_MTECH_RESEARCH , FORM_WIZARD_DECLARATION_ID);
