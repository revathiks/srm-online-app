...
(function () {
    ...
    SwaggerOperation.prototype.urlify = function (args) {
        this.resource.basePath = this.resource.basePath.replace('docs/json','api/');
        var url = this.resource.basePath + this.pathJson();

        console.log('SwaggerOperation url => '+url);
        console.log(this.resource);
        // console.log('SwaggerOperation pathJson => '+this.pathJson());
