...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'fellowship_form', 'name' => 'fellowship_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
...
<fieldset>
	...
	<div class="w-100 pd-20 pd-sm-40">
		...
		<div class="form-layout">
			...
			<div id="international_bsc_hons_am" style="display:none;"><p><?php echo NRI_FOREIGN; ?></p><a href="<?php echo NRI_FOREIGN_URL; ?>"><?php echo NRI_FOREIGN_URL; ?></a></div>
...
<fieldset>
		...
		<div class="row">
			<div class="col-lg-6">
				...
				<div class="row mt-2">
                  ...
                  <div class="col-lg-5 qa_status">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="apperingpg" name="current_education_qual_status" class="custom-control-input" value="3" <?php echo ($current_education_qual_status == 'apg')?'checked':''; ?>>
                      <label class="custom-control-label" for="apperingpg">Post Graduation Appearing</label>
                    </div>
                  </div>				  
                 <div class="col-lg-5 qa_status">
                    <div class="custom-control custom-radio custom-control-inline">
                      <input type="radio" id="completedpg" name="current_education_qual_status" class="custom-control-input" value="4" <?php echo ($current_education_qual_status == 'cpg')?'checked':''; ?>>
                      <label class="custom-control-label" for="completedpg">Post Graduation Completed</label>
                    </div>
                  </div>				  				  
                </div>
			...
			<div class="col-lg-6 ">
				<div class="form-group wd-xs-300 mr-5 w-100">
					...
					<div class="form-group mg-b-10-force">
						<input class="form-control" type="text" name="candidate_name" id="candidate_name" placeholder="Candidate's Name" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CANDIDATE_NAME_MSG;?>" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>" data-parsley-length="[<?php echo APLCT_CAND_NAME_MINLENGTH; ?>, <?php echo APLCT_CAND_NAME_MAXLENGTH; ?>]" data-parsley-nameonly="true" value="<?php echo $name_as_in_marksheet[$tenth_schooling_id]; ?>" maxlength="<?php echo APLCT_CAND_NAME_MAXLENGTH; ?>" data-parsley-trigger="change">
	...
	<table class="table table-bordered table-responsive mt-3" id="academc_common">
		...
		<tbody>
			<tr>
				...
				<td>
					<input class="form-control" type="text" name="academic_tenth_inst" id="academic_tenth_inst" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_INSTITUTE_NAME_MSG; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>" data-parsley-length="[<?php echo APLCT_1_MAXLENGTH; ?>, <?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>]" maxlength="<?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>" value="<?php echo $inst_name[$tenth_schooling_id]; ?>">
				</td>
				<td>
					<div class="form-group mg-b-10-force">
			...
			<tr>
				<td>
					<p>XII / Diploma <span class="tx-danger">*</span></p>
				</td>
				<td>
				...
				<td>
					<div class="form-group mg-b-10-force"  id="td_twelfth_ms">
			...
			<tr>
			<td id="row_ug">Graduation </td>
				<td><input class="form-control" type="text" name="academic_graduation_inst" id="academic_graduation_inst" maxlength="<?php echo APLCT_INSTITUTE_NAME_MAXLENGTH;?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_INSTITUTE_NAME_MSG;?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG;?>" data-parsley-length="[<?php echo APLCT_1_MAXLENGTH; ?>, <?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>]" value="<?php echo $inst_name[$graduation_type_id_ug]; ?>">
				<input type="hidden" name="is_graduation" id="is_graduation" value="1">
				</td>
				<td>
					<div class="form-group mg-b-10-force">
						<select class="form-control select2 academic_graduation_board" name="academic_graduation_board" id="academic_graduation_board" title="Choose University" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_UNIVERSITY_MSG; ?>" data-parsley-errors-container="#custom-academic_graduation_board-parsley-error">
							<option value="">Select</option>
						</select>
						<span id="custom-academic_graduation_board-parsley-error"></span>
					</div>
					<div id="ob_graduation" style="display:none;">
						<input class="form-control" type="text" name="other_board_graduation" id="other_board_graduation" maxlength="<?php echo APLCT_OTHER_BOARD_MAXLENGTH; ?>" value="<?php echo $other_board_name[$graduation_type_id_ug]; ?>" placeholder="Enter any other board/university" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>">					
					</div>
				</td>
				<td>
					<div class="form-group mg-b-10-force"  id="td_graduation_ms" style="display:none;">
				...
				<td>
					<div  id="td_graduation_cgpa" style="display:none;">
						<input class="form-control" type="text" name="academic_obtain_cgpa_graduation" id=	"academic_obtain_cgpa_graduation" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_PERCENT_CGPA_MSG; ?>"  data-parsley-type-message="<?php echo REQD_PERCENT_CGPA_VALID_MSG; ?>" data-parsley-trigger="keyup" data-parsley-type="number" value="<?php echo $mark_percentage[$graduation_type_id_ug]; ?>" maxlength="<?php echo APLCT_PERCENT_CGPA_MAXLENGTH; ?>" min="<?php echo APLCT_MARK_MINLENGTH; ?>" max="<?php echo APLCT_MARK_MAXLENGTH; ?>">
					</div>
				</td>
				<td>
					<div class="form-group mg-b-10-force"  id="td_graduation_yop" style="display:none;">
						<input class="form-control" type="text" name="academic_yr_passing_graduation" id="academic_yr_passing_graduation" placeholder="" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_YEAR_OF_PASSING_MSG; ?>" data-parsley-trigger="change" data-parsley-errors-container="#custom-academic_yr_passing_graduation-parsley-error" value="<?php echo $yr_of_pass[$graduation_type_id_ug]; ?>" maxlength="<?php echo APLCT_YEAR_OF_PASSING_MAXLENGTH; ?>" onkeypress="return isNumber(event);" autocomplete="off">
						<span id="custom-academic_yr_passing_graduation-parsley-error"></span>	
					</div>				
				</td>
				<td>
					<div  id="td_graduation_reg_no" style="display:none;">
						<input class="form-control" type="text" name="academic_reg_no_graduation" id="academic_reg_no_graduation" maxlength="<?php echo APLCT_REG_NO_MAXLENGTH; ?>" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_REG_NO_MSG; ?>" data-parsley-length="[<?php echo APLCT_1_MAXLENGTH; ?>, <?php echo APLCT_REG_NO_MAXLENGTH; ?>]" value="<?php echo $reg_no[$graduation_type_id_ug]; ?>" data-parsley-type='alphanum' data-parsley-type-message="<?php echo VALID_REG_NO_MSG; ?>" autocomplete="off">
					</div>				
				</td>
			</tr>
			<tr id="row_pg" style="display:none;">
					<td>Post Graduation</td>
					<td><input class="form-control" type="text" name="academic_pg_graduation_inst" id="academic_pg_graduation_inst" maxlength="<?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_INSTITUTE_NAME_MSG; ?>" data-parsley-nameonly="false" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>" data-parsley-length="[1, <?php echo APLCT_INSTITUTE_NAME_MAXLENGTH; ?>]" value="<?php echo $inst_name[$graduation_type_id_pg]; ?>">
					<input type="hidden" name="is_pg_graduation" id="is_pg_graduation" value="1">
					</td>
					<td>
						<div class="form-group mg-b-10-force">
							<select class="form-control select2 academic_pg_graduation_board" name="academic_pg_graduation_board" id="academic_pg_graduation_board" title="Choose University" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_UNIVERSITY_MSG; ?>" data-parsley-errors-container="#custom-academic_pg_graduation_board-parsley-error">
								<option value="">Select</option>
							</select>
							<span id="custom-academic_pg_graduation_board-parsley-error"></span>
						</div>
						<div id="ob_pg_graduation" style="display:none;">
							<input class="form-control" type="text" name="other_board_pg_graduation" id="other_board_pg_graduation" maxlength="<?php echo APLCT_OTHER_BOARD_MAXLENGTH; ?>" value="<?php echo $other_board_name[$graduation_type_id_pg]; ?>" placeholder="Enter any other board/university" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>">
						</div>
					</td>
					<td>
						<div class="form-group mg-b-10-force"  id="td_pg_graduation_ms">
							<select class="form-control select2" name="academic_marking_scheme_pg_graduation" id="academic_marking_scheme_pg_graduation" title="Choose Academic Marking Scheme" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_MARK_SCHEME_MSG; ?>" data-parsley-errors-container="#custom-academic_marking_scheme_pg_graduation-parsley-error">
							</select>
							<span id="custom-academic_marking_scheme_pg_graduation-parsley-error"></span>
						</div>
					</td>
					<td>
						<div  id="td_pg_graduation_cgpa">
							<input class="form-control" type="text" name="academic_obtain_cgpa_pg_graduation" id=	"academic_obtain_cgpa_pg_graduation" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_PERCENT_CGPA_MSG; ?>"  data-parsley-type-message="<?php echo REQD_PERCENT_CGPA_VALID_MSG; ?>" data-parsley-trigger="keyup" data-parsley-type="number" value="<?php echo $mark_percentage[$graduation_type_id_pg]; ?>" maxlength="<?php echo APLCT_PERCENT_CGPA_MAXLENGTH; ?>">
						</div>
					</td>
					<td>
						<div class="form-group mg-b-10-force"  id="td_pg_graduation_yop">
							<input class="form-control" type="text" name="academic_yr_passing_pg_graduation" id="academic_yr_passing_pg_graduation" placeholder="" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_YEAR_OF_PASSING_MSG; ?>" data-parsley-trigger="change" data-parsley-errors-container="#custom-academic_yr_passing_pg_graduation-parsley-error" value="<?php echo $yr_of_pass[$graduation_type_id_pg]; ?>" maxlength="<?php echo APLCT_YEAR_OF_PASSING_MAXLENGTH; ?>" onkeypress="return isNumber(event);" autocomplete="off">
							<span id="custom-academic_yr_passing_pg_graduation-parsley-error"></span>	
						</div>				
					</td>
					<td>
						<div  id="td_pg_graduation_reg_no">
							<input class="form-control" type="text" name="academic_reg_no_pg_graduation" id="academic_reg_no_pg_graduation" maxlength="<?php echo APLCT_REG_NO_MAXLENGTH; ?>" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_REG_NO_MSG; ?>" data-parsley-length="[1, <?php echo APLCT_REG_NO_MAXLENGTH; ?>]" value="<?php echo $reg_no[$graduation_type_id_pg]; ?>" data-parsley-type='alphanum' data-parsley-type-message="<?php echo VALID_REG_NO_MSG; ?>" autocomplete="off">
						</div>				
					</td>
			</tr>			
		</tbody>
	...
	<div class="row">
		<div class="col-lg-12">
			<h5 class="title-head">Additiol Qualification</h5>
					  ...
					  <tbody>
						  <tr>
							  ...
							  <td>
								  ...
								  <input class="form-control" type="text" name="name_of_the_program_0" id="name_of_the_program_0" placeholder="" maxlength="<?php echo APLCT_100_MAXLENGTH; ?>" value="<?php echo $is_addi_qualification[0]['program_name']; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>">
							  </td>
							  <td>
								  <input class="form-control" type="text" name="program_cy_0" id="program_cy_0" placeholder="YYYY" maxlength="<?php echo APLCT_YEAR_OF_PASSING_MAXLENGTH; ?>" value="<?php echo $is_addi_qualification[0]['yr_of_pass']; ?>">
							  </td>
						  </tr>
						  <tr>
							  <td>
							  ...
							  <td>
								  ...
								  <input class="form-control" type="text" name="name_of_the_program_1" id="name_of_the_program_1" placeholder="" maxlength="<?php echo APLCT_100_MAXLENGTH; ?>" value="<?php echo $is_addi_qualification[1]['program_name']; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>">
							  </td>
							  <td>
								  <input class="form-control" type="text" name="program_cy_1" id="program_cy_1" placeholder="YYYY" maxlength="<?php echo APLCT_YEAR_OF_PASSING_MAXLENGTH; ?>" value="<?php echo $is_addi_qualification[1]['yr_of_pass']; ?>">
							  </td>
						  </tr>
						  <tr>
							  <td>
							  ...
							  <td>
								  ...
								  <input class="form-control" type="text" name="name_of_the_program_2" id="name_of_the_program_2" placeholder="" maxlength="<?php echo APLCT_100_MAXLENGTH; ?>" value="<?php echo $is_addi_qualification[2]['program_name']; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>">
							  </td>
							  <td>
								  <input class="form-control" type="text" name="program_cy_2" id="program_cy_2" placeholder="YYYY" maxlength="<?php echo APLCT_YEAR_OF_PASSING_MAXLENGTH; ?>" value="<?php echo $is_addi_qualification[2]['yr_of_pass']; ?>">
							  </td>
						  </tr>
					  </tbody>
				  </table>
		...
		<div class="form-layout">
			<div class="row mg-b-25 mt-3">
				...
				if($applicant_appln_details_list_qual==3){
					...
					$condpg = 'false';
					$condug = ((isset($docs[$document_id_graduation_marksheet]))?'false':'true');
				}elseif($applicant_appln_details_list_qual==4){
					$condpg = ((isset($docs[$document_id_post_graduation_marksheet]))?'false':'true');
					$condug = ((isset($docs[$document_id_graduation_marksheet]))?'false':'true');
				...
				<div class="row w-100" style="<?php echo $ugpggrad_upload; ?>">
					...
					<div class="form-group col-md-6" id="main_pg_graduation_sheets" style="<?php echo $pggrad_upload; ?>">
					   <label for="exampleFormControlTextarea1">Upload Your Post Graduation Marksheet <span class="tx-danger"> *</span></label>
					   <input type="file" class="filestyle" name="post_graduation_marksheet" id="post_graduation_marksheet" data-parsley-required="<?php echo $condpg; ?>" data-parsley-required-message="<?php echo REQD_UPLOAD_PG_GRAD_MARK_MSG; ?>" data-parsley-errors-container="#custom-post_graduation_marksheet-parsley-error"data-parsley-max-file-size="<?php echo MAX_FILE_SIZE_500_KB; ?>" data-max-file-size-js="<?php echo MAX_FILE_SIZE_500_KB_JS; ?>" data-parsley-file-extension="<?php echo $file_allowed_type; ?>" onchange="upload_file(this.id)" data-file-id="<?php if(isset($docs[$document_id_post_graduation_marksheet])){ echo $docs[$document_id_post_graduation_marksheet]['id']; } ?>"accept="<?php  echo allow_extension($file_allowed_type); ?>">
