...
$inst_name_pg = isset($applicant_graduations_list[1]['insti_name']) ? $applicant_graduations_list[1]['insti_name'] : '';
$mark_percentage_pg = isset($applicant_graduations_list[1]['mark_percentage']) ? number_format($applicant_graduations_list[1]['mark_percentage']) : '';
$registration_no_pg = isset($applicant_graduations_list[1]['reg_no']) ? $applicant_graduations_list[1]['reg_no'] : '';
$other_board_name_pg = isset($applicant_graduations_list[1]['other_univ_name']) ? $applicant_graduations_list[1]['other_univ_name'] : '';
$board_pg = isset($applicant_graduations_list[1]['univ_name']) ? $applicant_graduations_list[1]['univ_name'] : 'Select';
$board_id_pg = isset($applicant_graduations_list[1]['univ_id']) ? $applicant_graduations_list[1]['univ_id'] : '';
$marking_scheme_pg = isset($applicant_graduations_list[1]['mark_scheme_name']) ? $applicant_graduations_list[1]['mark_scheme_name'] : 'Select';
$completion_year_pg = isset($applicant_graduations_list[1]['yr_of_pass']) ? $applicant_graduations_list[1]['yr_of_pass'] : 'Select';
...
$url = base_url().'pgdplifescience?startIndex='.$startIndex;
if($mode_edit == ADMIN_MODE_EDIT)
{
  $url = base_url().'pgdplifescience/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
}
/*CRM ADMIN Edit form start*/ 
?>
<div class="row">
...
<div class="row" style="pointer-events:none">
    <div class="col-sm-12" id="PGDPLSPreviewToPrint">
        <div class="card ">
            <div class="card-body">
                                		...
                                		<div class="col-lg-6">
                                			<div class="form-group mg-b-10-force">
                                				<label class="form-control-label">Campus Preferences <span class="tx-danger">*</span></label>
													...
													<h6 class="print_campus_small" style="color:#626ed4!important;"><?php echo ADPGDLS_CAMPUS_AVAILABLE_AT; ?></h6>
												</div>
                                		</div><!-- col-4 -->
										<div class="col-lg-6">
                                            <div class="form-group mg-b-10-force">
                                    ...
                                    <table class="table table-bordered  mt-0">
                                        ...
                                        <tbody>
											...
											<tr>
                                                ...
                                                <td>
                                                    <div class="form-group mg-b-10-force markdiv" id="markdiv" style="<?php echo $styleGrad; ?>"> 
                                                        <select class="form-control select2" name="academic_marking_scheme_twelfth" id="academic_marking_scheme_twelfth" title="Select Academic Marking Scheme" data-parsley-required="true" data-parsley-required-message="Please Select  Marking Scheme" data-parsley-errors-container="#custom-academic_marking_scheme_twelfth-parsley-error">
                                                ...
                                                <td>
                                                    <div class="markdiv" style="<?php echo $styleGrad; ?>">
