                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding:10px">
                                    ...
                                    <p class="m-1">One Time Password (OTP) to reset your password is <strong><?php echo $otp;?></strong>.</p>
                                    <!-- <p class="m-1">This OTP is valid upto <strong><?php echo $otpendTime;?></strong>. Please do not share this One Time Password with
                                        anyone.</p> -->
                                    <p class="m-1">In case you have not requested for OTP, please contact SRM Group Of Institutions</p>
                                </td>
                            </tr>
                            <tr>
