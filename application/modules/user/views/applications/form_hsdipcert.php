                            ...
                            <div class="col-sm-12">
                                        <form id="form-horizontal" class="form-horizontal form-wizard-wrapper">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="w-100 pd-20 pd-sm-40">
                                                    ...
                                                    <div class="form-layout">
                                                        <div class="row mg-b-25 mt-3">
                                                            <div class="col-lg-6">
                                                                <div class="form-group mg-b-10-force">
                                                                    <label class="">Resident status? <span
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group mg-b-10-force">
                                                                    <label class="">Have you studied 10+2 from India?<span
                                                                            class="tx-danger">*</span></label>
                                                                    <select class="form-control custom-select nationality"
                                                                        id="exampleFormControlSelect1">
                                                                        <option value="">Select Status - Yes or No</option>
                                                        ...
                                                        <div class="form-group formAreaCols" id="indian2">Please
                                                            understand that as per UGC guidelines , the PCP (
                                                            Person contact programs) and semester exams for
                                                            SRMIST DDE will be conducted only within Tamil Nadu
                                                        </div>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="w-100 pd-20 pd-sm-40">
                                                    <h5 class="card-body-title text-primary mt-4">Select Course And Campus Preferences</h5>
                                                    <div class="form-layout">
                                                        <div class="row mg-b-25 mt-3">
                                                            <div class="col-lg-4">
                                                                <div class="form-group mg-b-10-force">
                                                                    ...
                                                                    <select class="form-control custom-select Course"
                                                                        id="exampleFormControlSelect1">
                                                                        <option value="">Select Level of Program</option>
                                                                        <option value="Diploma">Diploma
                                                                        </option>
                                                                        <option value="Under Graduate">Under Graduate
                                                                        </option>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group mg-b-10-force">
                                                                    <label class="">Campus Perference 1
                                                                        <span class="tx-danger">*</span></label>
                                                                    <select class="form-control custom-select" id="exampleFormControlSelect1">
                                                                        <option value="">Select Specialization Perference</option>
                                                                        <option value="SRM IST, Main Campus (Kattankulathur, Chennai)" style="display: block;">SRM IST, Main
                                                                            Campus (Kattankulathur, Chennai) </option>
                                                                        <option value="SRM IST, Ramapuram Campus, Chennai">SRM IST, Ramapuram Campus, Chennai </option>
                                                                    </select>
                                                                </div>
                                                            </div><!-- col-4 -->
                                                            </div>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group mg-b-10-force">
                                                                    <label class="">Course Preference
                                                                        <span class="tx-danger">*</span></label>
                                                                    <select class="form-control custom-select Campus"
                                                                        id="exampleFormControlSelect1">
                                                                        <option value="">Select</option>
                                                                        <option value="M.A Journalism">M.A Journalism and
                                                                            Mass Communication</option>
                                                                        <option value="M.Com">M.Com</option>
                                                                        <option value="M.Sc Yoga">M.Sc Yoga for Human
                                                                            Excellence</option>
                                                                        <option value="MA (English)">MA (English)
                                                                        </option>
                                                ...
                                                <div class="w-100 pd-20 pd-sm-40">
                                                    <h5 class="card-body-title text-primary mt-4">Personal Details</h5>
                                                    <div class="form-layout">
                                                        <div class="row mg-b-25">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <label class="">Mobile NO <span
                                                                        ...
                                                                        </span><input id="demo2" type="text" placeholder="Mobile No" name="demo2" class="form-control">
                                                                    </div>
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    <label class="">Alternate Email ID
                                                                    </label>
                                                                    <input class="form-control" type="text" name="email"
                                                                        value="johnpaul@yourdomain.com"
                                                                        placeholder="Enter email address">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="w-100 pd-20 pd-sm-40">
                                                    <h5 class="card-body-title text-primary mt-4">Father's Details</h5>
                                                    <div class="form-layout">
                                                        <div class="row mg-b-25 mt-3">
                                                            <div class="col-lg-4">
                                                                <div class="form-group mg-b-10-force">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <label class="">Father's Mobile Number
                                                                </label>
                                                                <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected"><span class="input-group-addon bootstrap-touchspin-prefix input-group-prepend">
                                                                    <select class="form-control input-group-text" id="exampleFormControlSelect1">
                                                                        <option value="">+91</option>
                                                ...
                                                <div class="w-100 pd-20 pd-sm-40">
                                                    <h5 class="card-body-title text-primary mt-4">Mother's Details</h5>
                                                    <div class="form-layout">
                                                        <div class="row mg-b-25 mt-3">
                                                            <div class="col-lg-4">
                                                                <div class="form-group mg-b-10-force">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <label class="">Mother's Mobile Number
                                                                </label>
                                                                <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected"><span class="input-group-addon bootstrap-touchspin-prefix input-group-prepend">
                                                                    <select class="form-control input-group-text" id="exampleFormControlSelect1">
                                                                        <option value="">+91</option>
                                                ...
                                                <div class="w-100 pd-20 pd-sm-40">
                                                    <h5 class="card-body-title text-primary mt-4">Guardian's Details</h5>
                                                    <div class="form-layout">
                                                        <div class="row mg-b-25 mt-3">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    <label class="">Guardian's Email ID:
                                                                        <span class="tx-danger">*</span></label>
                                                                    <input class="form-control" type="text" name="email"
                                                                        value="johnpaul@yourdomain.com"
                                                                        placeholder="Enter email address">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="w-100 pd-20 pd-sm-40">
                                                <h5 class="card-body-title text-primary mt-4">Address for Communication</h5>
                                                <div class="form-layout">
                                                    <div class="row mg-b-25">
                                                        <div class="col-lg-4">
                                                            <div class="form-group mg-b-10-force">
                                            ...
                                            <fieldset>
                                                ...
                                                <div action="form-validation.html" id="selectForm" class="w-100">
                                                    <div class="row">                                     
                                                        ...
                                                        <div class="col-lg-6 ">
                                                            <div class="form-group wd-xs-300 mr-5 w-100">
                                                                <label class="">Candidate's Name as in 10th Certificate
                                                                    <span class="tx-danger">*</span></label>
                                                                <div class="form-group mg-b-10-force">
                                                  ...
                                                  <table class="table  table-bordered mt-3">
                                                    <label class="">Tenth Details
                                                    </label>
                                                    <thead class="thead-light">
                                                        <tr>
                                                            <th>
                                                            </th>
                                                            <th>Current/Highest Education </th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control" type="text" name="Institute Name"
                                                                    placeholder="">
                                                            </td>
                                                            <td>
                                                                <div class="form-group mg-b-10-force">
                                                            ...
                                                            <td>
                                                                <input class="form-control" id="Appearing_info_2"
                                                                    type="text" name="CGPA"
                                                                    placeholder="" id="appering_info_2">
                                                            </td>
                                                            <td>
                                                                <div class="form-group mg-b-10-force">
                                                                    <select class="form-control custom-select"
                                                            ...
                                                            <td>
                                                                <input class="form-control" id="Appearing_info_4"
                                                                    type="text" name="Regno"
                                                                    placeholder="" id="appering_info_4">
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    <tbody>
                                                ...
                                                <div class="mt-3 w-100">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label class="">NAD ID / Digilocker ID <span
                                                                        class="tx-danger">*</span></label>
                                                                <input class="form-control" type="text" name="lastname"
                                                ...
                                                <div class="row w-100">
                                                    <div class="col-lg-7 mb-3">
                                                        <div class="card mb-3 base_details_card">
                                                            <div class="card-body">
                                                                <h5 class="card-title text-primary card_title">Personal Details</h5>
                                                        ...
                                                        <div class="card base_details_card">
                                                            <div class="card-body">
                                                                <h5 class="card-title text-primary card_title">Order Details</h5>
                                                    ...
                                                    <div class="col-lg-5">
                                                        <div class="card mb-3 base_details_card">
                                                            <div class="card-body">
                                                                <h5 class="card-title text-primary card_title">Payment Details</h5>
                                                                <div class="row mb-3">
	<div class="col-lg-3">
		<label class="rdiobox">
