<?php
   ...
   $pin_code = isset($applicant_address_details_list['pin_code']) ? $applicant_address_details_list['pin_code'] : '';
	...
	$url = base_url().'dis-education-jan?startIndex='.$startIndex;
	if($mode_edit == ADMIN_MODE_EDIT)
	{
	  $url = base_url().'dis-education-jan/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
	}
	/*CRM ADMIN Edit form start*/ 	
...
<div id="form_preview_de" class="disable-div">
   <div class="row">
      <div class="col-sm-12" id="DistanceJanPreviewToPrint">
      <div class="col-sm-12">
      <div class="col-sm-12" id="DDEPreviewToPrint">
         <div class="card-body">
