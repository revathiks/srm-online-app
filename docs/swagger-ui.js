...
(function () {
    ...
    templates['main'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        function program10(depth0, data) {
            ...
            if (stack1 = helpers.validatorUrl) {
                stack1 = stack1.call(depth0, {hash: {}, data: data});
            } else {
                stack1 = depth0.validatorUrl;
        ...
        buffer += escapeExpression(stack1)
            + "\n    ";
        stack2 = helpers['if'].call(depth0, ((stack1 = depth0.info), stack1 == null || stack1 === false ? stack1 : stack1.version), {
            hash: {},
            inverse: self.noop,
        ...
        buffer += "]\n    ";
        stack2 = helpers['if'].call(depth0, depth0.validatorUrl, {
            hash: {},
            inverse: self.noop,
...
(function () {
    ...
    templates['operation'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        helpers = this.merge(helpers, Handlebars.helpers);
        data = data || {};
        var buffer = "", stack1, options, functionType = "function", escapeExpression = this.escapeExpression,
        ...
        buffer += escapeExpression(stack1)
            + "' class=\"toggleOperation ";
        stack1 = helpers['if'].call(depth0, depth0.deprecated, {
            hash: {},
            inverse: self.noop,
            fn: self.program(1, program1, data),
            data: data
        ...
        buffer += "\n        ";
        stack1 = helpers['if'].call(depth0, depth0.description, {
            hash: {},
            inverse: self.noop,
...
(function () {
    ...
    templates['param'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        function program4(depth0, data) {
            ...
            var buffer = "", stack1;
            buffer += "\n			";
            stack1 = helpers['if'].call(depth0, depth0['default'], {
                hash: {},
...
(function () {
    ...
    templates['param_list'] = template(function (Handlebars, depth0, helpers, partials, data) {
        ...
        var buffer = "", stack1, stack2, options, self = this, helperMissing = helpers.helperMissing,
            functionType = "function", escapeExpression = this.escapeExpression;
...
(function () {
    var ContentTypeView, HeaderView, MainView, OperationView, ParameterContentTypeView, ParameterView, ResourceView,
        ResponseContentTypeView, SignatureView, StatusCodeView, SwaggerUi, _ref, _ref1, _ref10, _ref2, _ref3, _ref4,
    ...
    SwaggerUi = (function (_super) {
        ...
        SwaggerUi.prototype.updateSwaggerUi = function (data) {
            data.url = data.url.replace('docs/json','api/');
    ...
    OperationView = (function (_super) {
        ...
        OperationView.prototype.render = function () {
            var code, contentTypeModel, isMethodSubmissionSupported, k, o, param, ref, responseContentTypeView,
                responseSignatureView, schema, schemaObj, signatureModel, statusCode, type, v, value, _i, _j, _k, _l,
                _len, _len1, _len2, _len3, _ref5, _ref6, _ref7, _ref8, _ref9;
        ...
        OperationView.prototype.handleFileUpload = function (map, form) {
            ...
            console.log('this.invocationUrl => '+this.invocationUrl);
            obj = {
                type: this.model.method,
                url: (this.invocationUrl).replace('docs/json','api/'),
    ...
    ParameterView = (function (_super) {
        ...
        ParameterView.prototype.render = function () {
            var contentTypeModel, isParam, parameterContentTypeView, ref, responseContentTypeView, schema,
                signatureModel, signatureView, template, type;
