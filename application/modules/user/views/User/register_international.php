...
<h4 class="font-size-18 text-center">Admission International</h4>
<p class="text-muted text-center">Admission <?php echo date('Y'); ?></p>

<?php  $attributes = array('class' => 'internationaluserRegisterForm mt-4 custom-validation', 'id' => 'internationaluserRegisterForm');
  ...
  <div id="msgs"></div>
                             ...
                             <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                <select class="form-control select2" name="stream_id" id="stream_id" data-placeholder="Choose Stream" data-parsley-required="true"data-parsley-required-message="Please Choose Stream" data-parsley-errors-container="#custom-state-parsley-error">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                <select class="form-control select2" name="deg_id" id="deg_id" data-placeholder="Choose Degree" data-parsley-required="true" data-parsley-required-message="Please Choose Degree" data-parsley-errors-container="#custom-city-parsley-error">
...
<p>Already have an account ? <?php if($pgm_name == ''){ ?><a href="<?php echo base_url('international-form/login');?>" class="font-weight-medium text-primary"> Login </a> <?php } else { ?>
