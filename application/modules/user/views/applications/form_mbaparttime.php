...
$canditate_name = isset($applicant_schooling_list[0]['name_as_in_marksheet']) ? $applicant_schooling_list[0]['name_as_in_marksheet'] : '';
...
//set applicant name and parent name as decalaration name and parent name if empty
...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'mba_parttime_form', 'name' => 'mba_parttime_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
?>
<div class="row">
 <div class="col-sm-12">
...
<div class="w-100 pd-20 pd-sm-40">
	...
	<div class="form-layout">		
		<div class="row mg-b-25 mt-3 program_level_div">
		<div class="col-lg-3">
			<div class="form-group mg-b-10-force">
					<label class="form-control-label">Select Program Level <span class="tx-danger">*</span></label>
			...
			<div class="col-lg-3" id="course_div" style="display:none;">
				<div class="form-group mg-b-10-force">
                            <label class="form-control-label">Select Course <span class="tx-danger">*</span>
                                </label>                           
			...
			<div class="col-lg-3" id="specialization_div" style="display:none;">
				<div class="form-group mg-b-10-force">
                            <label class="form-control-label">Select Specialization <span class="tx-danger">*</span>
                                </label>
                            <select class="form-control custom-select study" data-placeholder="Select Specialization " tabindex="-1" aria-hidden="true" name="special_pref_1" id="special_pref_1" title="Select Specialization" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_SELECT_SPL_MSG;?>" data-parsley-errors-container="#custom-special_pref_1-parsley-error" data-parsley-trigger="change">
                                <option value="">Select Specialization</option>
                            </select>
                            <span id="custom-special_pref_1-parsley-error"></span>
                   <input type="hidden" name="specialization_choice_no_1" id="specialization_choice_no_1" value="<?php echo $specialization_choice_no_1; ?>" />
                   <input type="hidden" name="specialization_prefer_id_1" id="specialization_prefer_id_1" value="<?php echo $specialization_prefer_id_1 ?>" />
                  </div>
                       
			</div><!-- col-4 -->
			
			<div class="col-lg-3" id="campus_div" style="display:none;">
                <div class="form-group mg-b-10-force">
                    <label class="form-control-label">Select Campus <span
                            class="tx-danger">*</span></label>
                   <select class="form-control custom-select study" data-placeholder="Select Campus" tabindex="-1" aria-hidden="true" name="campus_pref_1" id="campus_pref_1" title="Select Campus Preference 1" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CHOOSE_CAMPUS_MSG;?>" data-parsley-errors-container="#custom-campus_pref_1-parsley-error" data-parsley-trigger="change">
...
<fieldset>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 ">
                    <div class="form-group wd-xs-300 mr-5 w-100">
                        ...
                        <div class="form-group mg-b-10-force">                            
                            <input class="form-control" type="text" name="canditate_name" id="canditate_name" placeholder="Candidate's Name" data-parsley-required="true" data-parsley-nameonly="true" data-parsley-required-message="<?php echo REQD_CANDIDATE_NAME_MSG;?>" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>" data-parsley-length="[<?php echo APLCT_CAND_NAME_MINLENGTH; ?>, <?php echo APLCT_CAND_NAME_MAXLENGTH; ?>]" value="<?php echo $name_as_in_marksheet; ?>" maxlength="<?php echo APLCT_CAND_NAME_MAXLENGTH; ?>" data-parsley-trigger="change">
                            <small id="emailHelp"
       ...
       <div class="row"><div class="col-lg-6 "><h5 class="mb-3">Academic Details</h5></div></div> 
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="reg_width">
                            <div class="">                              
                                ...
                                <div class="labelinfo"><small id="emailHelp" class="form-text text-muted"><?php echo TYPE_NA_NOT_AVAIL;?></small></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <div id="ob_univ" style="display:none;">                                
                       <input type="text" class="form-control" name="other_univ_grad" id="other_univ_grad" placeholder="If Other, please enter here.." maxlength="<?php echo APLCT_OTHER_BOARD_MAXLENGTH; ?>" value="<?php echo $university_other_ug; ?>">
                      </div>
                        </td>

                        <td>
                           <div class="form-group mg-b-10-force" id="appering_info_1">
                             <select class="form-control custom-select" id="marking_scheme" name="marking_scheme" data-parsley-required="true"  data-parsley-required-message="<?php echo REQD_MARK_SCHEME_MSG; ?>" data-parsley-errors-container="#custom-marking_scheme-error" data-parsley-trigger="change">
                                 <option value="">Select</option>
                              </select>                          
			...
			<div class="card mb-3 base_details_card">
				<div class="card-body">
					...
					<div class="row mb-0">
						<div class="col-lg-2">
							<label class="rdiobox">
								<input name="rdio" type="radio" id="online" data-parsley-required="true" data-parsley-required-message="Please select payment type" data-parsley-errors-container="#custom-online-parsley-error" data-parsley-trigger="change">
								<span>Online</span>
							</label>
						</div>
						<div class="col-lg-2">
							<label class="rdiobox">
								<input name="rdio" type="radio" id="dd" value="on" data-parsley-required="true" data-parsley-required-message="Please select payment type" data-parsley-errors-container="#custom-dd-parsley-error" data-parsley-trigger="change">
								<span>DD</span>
							</label>
						</div>
					</div>
