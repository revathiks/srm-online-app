...
class Bba extends FrontendController
{
	//
    public $CI;
    ...
    public function bba_form($mode = false , $applicant_login_id = false , $applicant_personal_det_id = false) {
        ...
        if ( $this->input->post () ){
            ...
            $user_data['app_form_id']=APP_FORM_ID_BBA;
            ...
            if($user_data['currentIndex']==1){
                ...
                $url = $api_urls[ 'bba_personal_detail' ];
                // Get Personal ApplicaNT ID
                $user_data['applicant_personal_det_id'] = $applicant_id;
            ...
            if($user_data['currentIndex']==2){
                $url = $api_urls[ 'bba_parent_detail' ];
            ...
            if($user_data['currentIndex']==4){
                ...
                // Twelfth Academic
                $user_data['cur_qual_completed_twelfth'] = ($cur_qual_completed==2)?'t':'f';
                ...
                $user_data['marking_scheme_twelfth'] = ($user_data['academic_twelfth_msv']!='null')? $user_data['academic_twelfth_msv'] :NULL;
                $user_data['cgpa_twelfth'] = ($user_data['academic_twelfth_cgpa']!='null') ? $user_data['academic_twelfth_cgpa'] :NULL;
                ...
                $user_data['tenth_attempt']=isset($user_data['tenth_attempt']) ?$user_data['tenth_attempt'] : '';
                $user_data['twelfth_attempt']=isset($user_data['twelfth_attempt']) ? $user_data['twelfth_attempt'] : '';
            ...
            $wizard_dt = $this->_get_wizard_details(APP_FORM_ID_BBA);
            ...
            $this->data['site_title'] = $this->data['page_title'] = 'Bachelor of Business Administration (BBA)';
            $this->template('applications/form_bba', $this->data, true);
        }  
        
    }
    public function bba_preview($mode = false , $applicant_login_id = false , $applicant_personal_det_id = false) {
        $this->is_exists_user_logged();
        /*CRM ADMIN Edit form start*/
        $this->data['get_admin_session'] = $get_crmadmin_session = $this->_get_crmadmin_session();
        $this->data['mode_edit'] = $mode;
      ...
      // Get Form ID
        ...
        $this->data['user_data'] = $this->user_details_data['user_details']['data'][0];
        $this->data['personal_detail_list'] = $this->personal_detail_list($applicant_id);
        $this->data['site_title'] = $this->data['page_title'] = 'Bachelor of Business Administration (BBA) Form Preview';
        /* applicant_address_details_list end */
        
        // Display page with the template function from REST_Controller
        $this->template('applications/bba_preview', $this->data, true);
    }
    
    public function bba_edu_status() {
        parent::_bba_edu_status(false, $this->is_admin);
    }
}