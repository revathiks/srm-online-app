 ...
 *
 */
class Hspgee extends API_Controller {
    ...
    public function basic_detail_post() {
        $app_form_id_hspg = APP_FORM_ID_HSPG_EE;
        ...
        $applicant_appln_det_res = $this->_get_appln_form_id($applicant_personal_det_id,$app_form_id_hspg);
        ...
        $_POST['active'] = TRUE;
        $_POST['appln_form_id'] = $app_form_id_hspg;
        ...
        if($applicant_appln_id == false) {
            $applicant_appln_det_res = $this->_insert_update_applicant_tables($function_name, $applicant_personal_det_id, $table_schema, $applicant_appln_det_table, $applicant_appln_det_columns,false,'applicant_appln_id',false,$app_form_id_hspg);
        } else {
            $applicant_appln_det_res = $this->_insert_update_applicant_tables($function_name, $applicant_personal_det_id, $table_schema, $applicant_appln_det_table, $applicant_appln_det_columns, 1, 'applicant_appln_id', $applicant_appln_id,$app_form_id_hspg);
        }
        ...
        if($applicant_appln_det_res) {
            if($applicant_appln_det_res['status'] == 'error') {
                ...
                $wizard_update = $this->common_wizardupdate($applicant_personal_det_id , $app_form_id_hspg , FORM_WIZARD_BASIC_ID);
    ...
    public function personal_detail_post() {
        ...
        $this->form_validation->set_rules('campus_pref', 'Campus Preference 1','trim|required');
        ...
        if($campus_pref) {
            ...
            $_POST['applicant_appln_id'] = $applicant_appln_id;
            if($applicant_campus_prefer_id) {
                $campus_pref_res[] = $this->_insert_update_applicant_tables($function_name, array('applicant_personal_det_id'=>$applicant_personal_det_id,'applicant_appln_id'=>$applicant_appln_id,'applicant_campus_prefer_id'=> $applicant_campus_prefer_id), $table_schema, $applicant_campus_prefer_table, $applicant_campus_prefer_columns, 2, 'applicant_campus_prefer_id', $applicant_campus_prefer_id);
        ...
        if($applicant_personal_det_res){
            $wizard_update = $this->common_wizardupdate($applicant_personal_det_id , $app_form_id_hspg , FORM_WIZARD_PERSONAL_ID);
        }
        $this->response ($applicant_personal_det_res , API_Controller::HTTP_OK);
    }
    public function parent_detail_post()
    {
        ...
        if($parent_res){
            $wizard_update = $this->common_wizardupdate($applicant_personal_det_id , $app_form_id_hspg , FORM_WIZARD_PARENT_ID);
        }
    ...
    public function academicdet_post()
    {
        ...
        $cur_qual_completed = $this->post('current_education_qual_status',true);
       ...
       // $_POST['created_by'] = $applicant_personal_det_id;
        ...
        $other_twelfth_board = $user_data['other_twelfth_board'];
          ...
          //end 12th
           ...
           //ug
            $applicant_graduation_columns = 'applicant_grad_det_id,applicant_personal_det_id,insti_name,completion_year,active,registration_no,applicant_appln_id,graduation_type_id,other_degree_name,other_university_name,mark_scheme_id,mark_percent,result_declared';
            ...
            //pg
            if($cur_qual_completed=='t'){
                $applicant_graduation_columns = 'applicant_grad_det_id,applicant_personal_det_id,completion_year,active,applicant_appln_id,graduation_type_id,other_university_name,mark_scheme_id,mark_percent,result_declared,univ_id,mark_scheme_id,mark_percent';
                ...
                $university_pg= ($user_data['university_pg']!=''&& $user_data['university_pg']!='null') ? $user_data['university_pg']:NULL;
        ...
        $qual_status_id = $this->post('qual_status_id',true);        
        $qual_status_id=isset($qual_status_id)?$qual_status_id:NULL;
        $_SERVER["REQUEST_METHOD"] = "POST";
        $_POST['active'] = TRUE;
        $_POST['appln_form_id'] = $app_form_id;
        $_POST['qual_status_id'] = $qual_status_id;
        $_POST['applicant_appln_id'] = $applicant_appln_id;
    ...
    public function declaration_post() {
        ...
        if($applicant_personal_det_res){
            $wizard_update = $this->common_wizardupdate($applicant_personal_det_id , $app_form_id_hspg , FORM_WIZARD_DECLARATION_ID);
        }
        $this->response ($applicant_personal_det_res , API_Controller::HTTP_OK);
    }
