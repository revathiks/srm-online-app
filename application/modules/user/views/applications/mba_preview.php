...
$mode_of_study=$applicant_graduations_list['mode_of_study'];
...
$mode_of_study=isset($mode_of_study) ? $mode_of_study :'Select';
...
$url = base_url().'mba?startIndex='.$startIndex;
if($mode_edit == ADMIN_MODE_EDIT)
{
    $url = base_url().'mba/'.$mode_edit.'/'.$crm_applicant_login_id.'/'.$crm_applicant_personal_det_id.'?startIndex='.$startIndex;;
}
...
<div class="row disable_div_preview" id="mba_form">
    <div class="col-sm-12">
                        ...
                        <div id="collapseTwo" class="collapse show bg-light" aria-labelledby="headingTwo" data-parent="#accordionExample">
                            <div class="card-body">
                               ...
                               <div class="w-100 pd-20 pd-sm-40">
                                ...
                                <div class="col-lg-6" id="main_div_course_prefer_1">
                                <div class="form-group mg-b-10-force">
                                ...
                                <div class="col-lg-6">
                                	<div class="form-group mg-b-10-force">
                                        <label class="form-control-label">Campus Preference 2 </label>
                                               <select class="form-control  study" data-placeholder="Select Campus Preference 2" tabindex="-1" aria-hidden="true" name="campus_pref_2" id="campus_pref_2" title="Select Campus Preference" data-parsley-required="true" data-parsley-required-message="Please Select Campus Preference 2" data-parsley-errors-container="#custom-campus_pref_2-parsley-error" data-parsley-trigger="change">
                                ...
                                <div class="col-lg-6" id="main_div_course_prefer_2" >
                                <div class="form-group mg-b-10-force">
                                ...
                                <div class="col-lg-6" id="main_div_course_prefer_3" >
                                <div class="form-group mg-b-10-force">
                            ...
                            <div class="row w-100">
                             ...
                             <h5 class="text-primary mb-3">Academic Details</h5>
                                ...
                                <div class="form-group wd-xs-300 mr-5 w-100">
                                 ...
                                 <div class="row w-100" style="<?php echo $resultDateStyle;?>">
                                 <div class="col-lg-6">
                                 <div class="wd-200 w-100">
                                ...
                                <section class="row mt-2">
                                    <h5 class="text-primary mb-0">Graduation Details</h5>
                                            ...
                                            <td>
                                              <div class="form-group mg-b-10-force">
                                                <select class="form-control " name="mode_of_study" id="mode_of_study" data-parsley-required="true" data-parsley-required-message="Please Select Mode of Study" data-parsley-trigger="change" data-parsley-errors-container="#custom-mode_of_study-parsley-error">
                                                  <option value=""><?php echo $mode_of_study;?></option>
                                                </select>
                                                <span class="tx-danger required_asterisk">*</span>
        ...
        <div class="mt-0 w-100">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select class="form-control  study" id="taken_any_competitive_exam" name="taken_any_competitive_exam" data-parsley-required="true" data-parsley-required-message="Please select the status" data-parsley-errors-container="#custom-taken_any_competitive_exam-parsley-error" data-parsley-trigger="change">
                            <option value=""><?php echo $is_competitive_exam_label;?></option>
            ...
            <div class="row" id="competitive_exam_dtl" style="<?php echo $examStyle;?>">
              <div class="col-md-12">
                <div class="form-group">
                      ...
                      <tbody>
                        <tr>
                          <td>
                             ...
                             <select class="form-control  study" id="competitive_exam_1" name="competitive_exam_1" data-parsley-required="true" data-parsley-required-message="Please select the competitive examination" data-parsley-errors-container="#custom-competitive_exam_1-parsley-error" data-parsley-trigger="change">
                             <option><?php echo ($applicant_comp_exam_name[0]) ? $applicant_comp_exam_name[0] : 'Select Competitive Examination';?></option>
                             </select>
                          ...
                          <td>
                            <input class="form-control" type="text" name="score_obtained_1" id="score_obtained_1" placeholder="Score Obtained" maxlength="7" data-parsley-required="true" data-parsley-required-message="Please Enter Score Obtained" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_score_obtained[0]; ?>" data-parsley-type="number">
                            <span class="tx-danger required_asterisk">*</span>
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_1" id="max_score_1" placeholder="Max Score" maxlength="9" data-parsley-required="true" data-parsley-required-message="Please Enter Max Score" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_max_score[0]; ?>" data-parsley-type="number">
                            <span class="tx-danger required_asterisk">*</span>
                          </td>
                          <td>
                          ...
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_1" id="air_overall_rank_1" placeholder="AIR / Overall Rank" maxlength="9" data-parsley-required="true" data-parsley-required-message="Please Enter AIR / Overall Rank" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_all_india_rank[0]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                              <span class="tx-danger required_asterisk">*</span>
                          </td>
                          <td>
                            <select class="form-control  study" id="qualified_not_qualified_1" name="qualified_not_qualified_1" data-parsley-required="true" data-parsley-required-message="Please select the Qualified / Not Qualified" data-parsley-errors-container="#custom-qualified_not_qualified_1-parsley-error" data-parsley-trigger="change">
                                <option value=""><?php echo ($applicant_comp_exam_qualified[0]) ? $applicant_comp_exam_qualified[0] :'Select Qualified / Not Qualified'; ?></option>
                            </select>
                            <span class="tx-danger required_asterisk">*</span>
                        ...
                        <tr>
                          <td>
                            ...
                            <select class="form-control  study" id="competitive_exam_2" name="competitive_exam_2" data-parsley-required="false" data-parsley-required-message="Please select the competitive examination" data-parsley-errors-container="#custom-competitive_exam_2-parsley-error" data-parsley-trigger="change">
                            <option><?php echo isset($applicant_comp_exam_name[1]) ? $applicant_comp_exam_name[1] : 'Select Competitive Examination';?></option>
                          ...
                          <td>
                            <input class="form-control" type="text" name="score_obtained_2" id="score_obtained_2" placeholder="Score Obtained" maxlength="7" data-parsley-required="false" data-parsley-required-message="Please Enter Score Obtained" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_score_obtained[1]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_2" id="max_score_2" placeholder="Max Score" maxlength="9" data-parsley-required="false" data-parsley-required-message="Please Enter Max Score" data-parsley-trigger="change" value="<?php echo $applicant_comp_exam_max_score[1]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                          ...
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_2" id="air_overall_rank_2" placeholder="AIR / Overall Rank" maxlength="9" value="<?php echo $applicant_comp_exam_all_india_rank[1]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                          </td>
                          <td>
                            <select class="form-control  study" id="qualified_not_qualified_2" name="qualified_not_qualified_2">
                              <option value=""><?php echo ($applicant_comp_exam_qualified[1]) ? $applicant_comp_exam_qualified[1] :'Select Qualified / Not Qualified'; ?></option>
                            </select>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            ...
                            <select class="form-control  study" id="competitive_exam_3" name="competitive_exam_3" data-parsley-required="false" data-parsley-required-message="Please select the competitive examination" data-parsley-errors-container="#custom-competitive_exam_3-parsley-error" data-parsley-trigger="change">
                            <option><?php echo isset($applicant_comp_exam_name[2]) ? $applicant_comp_exam_name[2] : 'Select Competitive Examination';?></option>
                          ...
                          <td>
                            <input class="form-control" type="text" name="score_obtained_3" id="score_obtained_3" placeholder="Score Obtained" maxlength="7"value="<?php echo $applicant_comp_exam_score_obtained[2]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_3" id="max_score_3" placeholder="Max Score" maxlength="9" value="<?php echo $applicant_comp_exam_max_score[2]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                          ...
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_3" id="air_overall_rank_3" placeholder="AIR / Overall Rank" maxlength="9" value="<?php echo $applicant_comp_exam_all_india_rank[2]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                          </td>
                          <td>
                            <select class="form-control  study" id="qualified_not_qualified_3" name="qualified_not_qualified_3">
                             <option value=""><?php echo ($applicant_comp_exam_qualified[2]) ? $applicant_comp_exam_qualified[2] :'Select Qualified / Not Qualified'; ?></option>
                        ...
                        <tr>
                          <td>
                            <input class="form-control" type="hidden" placeholder="" id="comp_exam_pk_id_4" name="comp_exam_pk_id_4" value="<?php echo $applicant_comp_exam_pk_id[3]; ?>">
                            <select class="form-control  study" id="competitive_exam_4" name="competitive_exam_4" data-parsley-required="false" data-parsley-required-message="Please select the competitive examination" data-parsley-errors-container="#custom-competitive_exam_4-parsley-error" data-parsley-trigger="change">
                            <option><?php echo isset($applicant_comp_exam_name[3]) ? $applicant_comp_exam_name[3] : 'Select Competitive Examination';?></option>
                            
                            </select>
                            <span id="custom-competitive_exam_4-parsley-error"></span>
                          </td>
                          <td class="reg_width">
                            <input class="form-control" type="text" name="registration_no_4" id="registration_no_4" placeholder="Registration No" maxlength="10" value="<?php echo $applicant_comp_exam_registration_no[3]; ?>">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="score_obtained_4" id="score_obtained_4" placeholder="Score Obtained" maxlength="7"value="<?php echo $applicant_comp_exam_score_obtained[3]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_4" id="max_score_4" placeholder="Max Score" maxlength="9" value="<?php echo $applicant_comp_exam_max_score[3]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                              <input class="form-control" type="text" name="year_appeared_4" id="year_appeared_4" placeholder="YYYY" maxlength="4" value="<?php echo $applicant_comp_exam_exam_year[3]; ?>" readonly>
                          </td>
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_4" id="air_overall_rank_4" placeholder="AIR / Overall Rank" maxlength="9" value="<?php echo $applicant_comp_exam_all_india_rank[3]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                          </td>
                          <td>
                            <select class="form-control  study" id="qualified_not_qualified_4" name="qualified_not_qualified_4">
                             <option value=""><?php echo ($applicant_comp_exam_qualified[3]) ? $applicant_comp_exam_qualified[3] :'Select Qualified / Not Qualified'; ?></option>
                        ...
                        <tr>
                          <td>
                            ...
                            <select class="form-control  study" id="competitive_exam_5" name="competitive_exam_5" data-parsley-required="false" data-parsley-required-message="Please select the competitive examination" data-parsley-errors-container="#custom-competitive_exam_5-parsley-error" data-parsley-trigger="change">
                           <option> <?php echo isset($applicant_comp_exam_name[4]) ? $applicant_comp_exam_name[4] : 'Select Competitive Examination';?></option>
                            
                            </select>
                            <span id="custom-competitive_exam_5-parsley-error"></span>
                          </td>
                          <td class="reg_width">
                            <input class="form-control" type="text" name="registration_no_5" id="registration_no_5" placeholder="Registration No" maxlength="10" value="<?php echo $applicant_comp_exam_registration_no[4]; ?>">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="score_obtained_5" id="score_obtained_5" placeholder="Score Obtained" maxlength="7" value="<?php echo $applicant_comp_exam_score_obtained[4]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_5" id="max_score_5" placeholder="Max Score" maxlength="9" value="<?php echo $applicant_comp_exam_max_score[4]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                              <input class="form-control" type="text" name="year_appeared_5" id="year_appeared_5" placeholder="YYYY" maxlength="4" value="<?php echo $applicant_comp_exam_exam_year[4]; ?>" readonly>
                          </td>
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_5" id="air_overall_rank_5" placeholder="AIR / Overall Rank" maxlength="9" value="<?php echo $applicant_comp_exam_all_india_rank[4]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);">
                          </td>
                          <td>
                            <select class="form-control  study" id="qualified_not_qualified_5" name="qualified_not_qualified_5">
                              <option value=""><?php echo ($applicant_comp_exam_qualified[4]) ? $applicant_comp_exam_qualified[4] :'Select Qualified / Not Qualified'; ?></option>
                             </select>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td>
                            <input class="form-control" type="hidden" placeholder="" id="comp_exam_pk_id_6" name="comp_exam_pk_id_6" value="<?php echo $applicant_comp_exam_pk_id[5]; ?>">
                            <select class="form-control  study" id="competitive_exam_6" name="competitive_exam_6" data-parsley-required="false" data-parsley-required-message="Please select the competitive examination" data-parsley-errors-container="#custom-competitive_exam_6-parsley-error" data-parsley-trigger="change">
                           <option> <?php echo isset($applicant_comp_exam_name[5]) ? $applicant_comp_exam_name[5] : 'Select Competitive Examination';?></option>
                            
                            </select>
                            <span id="custom-competitive_exam_6-parsley-error"></span>
                          </td>
                          <td class="reg_width">
                            <input class="form-control" type="text" name="registration_no_6" id="registration_no_6" placeholder="Registration No" maxlength="10" value="<?php echo $applicant_comp_exam_registration_no[5]; ?>">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="score_obtained_6" id="score_obtained_6" placeholder="Score Obtained" maxlength="7"value="<?php echo $applicant_comp_exam_score_obtained[5]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                            <input class="form-control" type="text" name="max_score_6" id="max_score_6" placeholder="Max Score" maxlength="9" value="<?php echo $applicant_comp_exam_max_score[5]; ?>" data-parsley-type="number">
                          </td>
                          <td>
                              <input class="form-control" type="text" name="year_appeared_6" id="year_appeared_6" placeholder="YYYY" maxlength="4" value="<?php echo $applicant_comp_exam_exam_year[5]; ?>" readonly>
                          </td>
                          <td>
                              <input class="form-control" type="text" name="air_overall_rank_6" id="air_overall_rank_6" placeholder="AIR / Overall Rank" maxlength="9" value="<?php echo $applicant_comp_exam_all_india_rank[5]; ?>" data-parsley-type="number" onkeypress="return isNumber(event);" onkeypress="return isNumber(event);">
                          </td>
                          <td>
                            <select class="form-control  study" id="qualified_not_qualified_6" name="qualified_not_qualified_6">
                             <option value=""><?php echo ($applicant_comp_exam_qualified[5]) ? $applicant_comp_exam_qualified[5] :'Select Qualified / Not Qualified'; ?></option>
                            </select>
                          </td>
                        </tr>
                      </tbody>
