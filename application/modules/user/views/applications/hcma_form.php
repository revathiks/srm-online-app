...
if($applicant_application_details_list){
    ...
    $studied_from_india=$applicgrad_idant_application_details_list[0]['qualifyingexamfromindia'];
...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'hcma_form', 'name' => 'hcma_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
...
<div class=" w-100 pd-20 pd-sm-40" id="campus_div" style="display:none;">
            ...
            <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
                    <label class="form-control-label">Campus Preference 2</label>
                           <select class="form-control custom-select study" data-placeholder="Select Campus Preference 2" tabindex="-1" aria-hidden="true" name="campus_pref_2" id="campus_pref_2" title="Select Campus Preference" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_CHOOSE_CAMPUS_MSG;?>" data-parsley-errors-container="#custom-campus_pref_2-parsley-error" data-parsley-trigger="change">
...
<fieldset>
	...
	<div>
	<div><h6>Do you wish to add Guardian Details<h6></div>
...
<fieldset>
                ...
                <div class="form-group mr-5">                    
                    <div class="row">
                      <div class="col-lg-10">
                        ...
                        class="tx-danger">*</span></label>
                        <select class="form-control select2" data-placeholder="Select" tabindex="-1" aria-hidden="true" name="sslc_result_status" id="sslc_result_status" title="Select Result status" data-parsley-required="true" data-parsley-required-message="<?php echo SSLC_RESULT_STATUS;?>" data-parsley-errors-container="#custom-sslc_result_status-parsley-error">
                        <option value="">Select</option>
                        </select>
	  ...
	  <table class="table table-bordered mt-0">
		...
		<thead class="thead-light">
			<tr>
                ...
                <th class="align-middle"> Roll No. / Registration No.
		...
		<tbody>
			<tr>
				...
				<td>
					<div class="form-group mg-b-10-force tenth_markdiv" id="Appering_info_1">
				...
				<td>
					<div class="form-group mg-b-10-force tenth_markdiv">						
	...
	<h5 class="text-primary mb-3 twelfthtbl">12th / Diploma Details</h5>
	<div class="table-responsive">
	...
	<thead class="thead-light">
		...
		<tbody>
			<tr>
				...
				<td>
					<div class="form-group mg-b-10-force markdiv" id="markdiv" style="display: none"> 
	...
	<div class="help_text twelfthtbl"><?php echo DIPLOMA_HOLDER_MSG;?></div>
    <div class="mt-3 w-100">
        <div class="row">            
            <div class="col-lg-6">
                <div class="form-group">
                    <label class="form-control-label">NAD ID / Digilocker ID </label>
                     <input class="form-control" type="text" name="digilocker_id" id="digilocker_id" placeholder="Enter NAD ID / Digilocker ID " data-parsley-required="false" value="<?php echo $digilocker_id;?>" maxlength="<?php echo APLCT_NADID_MAXLENGTH;?>" data-parsley-type='alphanum'  data-parsley-type-message="<?php echo VALID_NADID_MSG;?>">
				  </div>
            </div>
        </div>
    </div>
   ...
   <div class="col-md-12">
		<div class="form-layout">
			<div class="row mg-b-25 mt-3">
				...
				<div class="row w-100" id="edumarksheet">
                      <div class="form-group col-md-6 tenthsheet" >
                          <label for="exampleFormControlTextarea1">Upload Your 10th Marksheet <span
								class="tx-danger" id="tenthsheet">*</span></label>
                      ...
                      <div class="form-group col-md-6 twelfthsheet" >
                          <label for="exampleFormControlTextarea1">Upload Your 12th Marksheet <span
								class="tx-danger" id="twelfthsheet">*</span></label>
				...
				<div class="row w-100 mt-3">
				<!--  <div class="col-md-6">
                        <a target="_blank" href="<?php echo base_url();?>hcma_preview">
