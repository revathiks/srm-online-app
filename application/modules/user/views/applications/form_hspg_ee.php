...
<div class="row">
    <div class="col-sm-12"> 
       ...
       //set sslc max year
        ...
        $attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'hspg_ee_form', 'name' => 'hspg_ee_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle' => "validator");
                    ...
                    <div class="row mg-b-25">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group formAreaCols"  id="non-indian" style="display:none;">
                                ...
                                <a target="_blank" href="<?php echo NRI_FOREIGN_URL;?>"><b><?php echo NRI_FOREIGN_URL;?></b></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="w-100 pd-20 pd-sm-40">
                ...
                <div class="form-layout">
                    <div class="row">
                        ...
                        <div class="col-lg-4" id="campus_div" style="display:none;">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label">Campus <span
                                        class="tx-danger">*</span></label>
                                <select class="form-control custom-select study" data-placeholder="Select Campus Preference 1" tabindex="-1" aria-hidden="true" name="campus_pref_1" id="campus_pref_1" title="Select Campus Preference 1" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CHOOSE_CAMPUS_MSG;?>" data-parsley-errors-container="#custom-campus_pref_1-parsley-error" data-parsley-trigger="change">
                    ...
                    <div class="row mg-b-25 mt-3" id="course_div" style="display:none;">	
                        <div class="col-lg-4" >
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control custom-select study" data-placeholder="Select Course Preference 1" tabindex="-1" aria-hidden="true" name="course_pref_1" id="course_pref_1" title="<?php echo REQD_CHOOSE_COURSE_MSG;?>" data-parsley-required="true" data-parsley-required-message="Please Select Course Preference 1" data-parsley-errors-container="#custom-course_pref_1-parsley-error" data-parsley-trigger="change">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control custom-select study" data-placeholder="Select Course Preference 2" tabindex="-1" aria-hidden="true" name="course_pref_2" id="course_pref_2" title="<?php echo REQD_CHOOSE_COURSE_MSG;?>" data-parsley-required="false" data-parsley-required-message="Please Select Course Preference 2" data-parsley-errors-container="#custom-course_pref_2-parsley-error" data-parsley-trigger="change">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control custom-select study" data-placeholder="Select Course Preference 3" tabindex="-1" aria-hidden="true" name="course_pref_3" id="course_pref_3" title="<?php echo REQD_CHOOSE_COURSE_MSG;?>" data-parsley-required="false" data-parsley-required-message="Please Select Course Preference 3" data-parsley-errors-container="#custom-course_pref_3-parsley-error" data-parsley-trigger="change">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control select2 test_state" data-placeholder="Select Test State Perferences 2" tabindex="-1" aria-hidden="true" name="state_pref_2" id="state_pref_2" title="<?php echo REQD_SELECT_STATE_PREFERENCE2_MSG; ?>" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_SELECT_STATE_PREFERENCE2_MSG; ?>" data-parsley-errors-container="#custom-state_pref_2-parsley-error" data-parsley-trigger="change">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control select2 test_state" data-placeholder="Select Test State Perferences 3" tabindex="-1" aria-hidden="true" name="state_pref_3" id="state_pref_3" title="<?php echo REQD_SELECT_STATE_PREFERENCE3_MSG; ?>" data-parsley-required="false" data-parsley-required-message="Please Select Test State Perferences 3" data-parsley-errors-container="#custom-state_pref_3-parsley-error" data-parsley-trigger="change">
        ...
        <fieldset>
            ...
            <div id="selectForm" class="w-100">
                <input type="hidden" id="grad_id_hidden" value="<?php echo $grad_id; ?>"/>
                <div class="row">
                    <div class="col-lg-6" id="qualification_status">
            ...
            <div><h5 class="text-primary mb-3 mt-4">Academic Details</h5></div>
            <div class="table-responsive">
                <table class="table table-bordered mt-1">
                    ...
                    <tbody>
                        ...
                        <tr class="table_twelfth">
                            <td>
                                <p>12th <span class="tx-danger twelfthreq">*</span> </p>
                            </td>
                            ...
                            <td>
                                ...
                                <input type="text" class="form-control" name="other_twelfth_board" id="other_twelfth_board" placeholder="If Other, please enter here.." maxlength="<?php echo APLCT_OTHER_BOARD_MAXLENGTH; ?>" value="<?php echo $other_board_name_twelfth; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>">
                                </div>
                            </td>
                        ...
                        <tr class="ugtable">
                            <td>
                                <p>Graduation <span class="tx-danger ugreq">*</span></p>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="form-group mg-b-10-force ugtableCol">                                   
                                    ...
                                    <div class="form-group mt-1" id="other_univ_ug" style="display: none;">
                                     <input type="text" class="form-control" name="university_other_ug" id="university_other_ug" placeholder="If Other, please enter here.." maxlength="<?php echo APLCT_OTHER_BOARD_MAXLENGTH; ?>" value="<?php echo $university_other_ug; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>">
                                    </div>
                            ...
                            <td>
                                <div class="form-group mg-b-10-force markug ugtableCol">
                                    <div style="<?php echo $hideUgcols; ?>" id="appering_info_1">                                      
                            ...
                            <td>
                                <div class="form-group mg-b-10-force markug ugtableCol">
                                    <div id="appering_info_2" style="<?php echo $hideUgcols; ?>">                                        
            ...
            <div><h5 class="text-primary mb-3 mt-4 pgtable" style="display:none;">For M.Phil Applicants Only </h5></div>
            <div class="table-responsive">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="form-group mg-b-10-force"> 
                                  <input class="form-control" type="hidden" placeholder="" id="grad_id_pg" name="grad_id_pg" value="<?php echo $applicant_grad_det_id_pg; ?>">
                                     ...
                                     <select class="form-control custom-select" id="university_pg" name="university_pg" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_UNIVERSITY_MSG; ?>" title="Select university" data-parsley-errors-container="#custom-university_pg-parsley-error" data-parsley-trigger="change">
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                <span id="custom-university_pg-parsley-error"></span>
                                <div class="form-group" id="other_univ_pg" style="display: none;">                                    
                               		<input type="text" class="form-control" name="university_other_pg" id="university_other_pg" placeholder="If Other, please enter here.." maxlength="<?php echo APLCT_OTHER_BOARD_MAXLENGTH; ?>" value="<?php echo $university_other_pg; ?>" data-parsley-nameonly="true" data-parsley-nameonly-message="<?php echo REQD_ALPHA_NAME_ONLY_MSG; ?>">
                                </div>
                            </td>

                            <td>
                                <div class="form-group mg-b-10-force markpg">
                                    <select class="form-control custom-select" id="user_marking_scheme_pg" name="user_marking_scheme_pg" data-parsley-required="false"  data-parsley-required-message="<?php echo REQD_MARK_SCHEME_MSG; ?>" data-parsley-errors-container="#custom-user_marking_scheme_pg-error" data-parsley-trigger="change">
                                      <option value="">Select</option>
                                    </select>
                                </div>
                            ...
                            <td>
                                <div class="form-group mg-b-10-force">						
                                    <div>
                                   	 <input class="form-control" type="text" name="yr_passing_pg" id="yr_passing_pg" class="form-control datepicker" placeholder="YYYY" data-parsley-required="false" data-parsley-required-message="<?php echo REQD_YEAR_OF_PASSING_MSG; ?>" data-parsley-trigger="change" value="<?php echo $completion_year_pg; ?>" maxlength="<?php echo APLCT_YEAR_OF_PASSING_MAXLENGTH; ?>" onkeypress="return isNumber(event);">
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-2">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="online" name="payment_mode" class="custom-control-input"  data-parsley-required="true" data-parsley-required-message="Please Select Payment Mode" data-parsley-errors-container="#custom-payment_mode-parsley-error" data-parsley-trigger="change" value="1" <?php echo ($payment_mode_id == PAYMENT_MODE_ONLINE_ID) ? 'checked' : ''; ?>>
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="dd" name="payment_mode" class="custom-control-input"  data-parsley-required="true" data-parsley-required-message="Please Select Payment Mode" data-parsley-errors-container="#custom-payment_mode-parsley-error" data-parsley-trigger="change" value="1" <?php echo ($payment_mode_id == PAYMENT_MODE_DEMAND_DRAFT_ID) ? 'checked' : ''; ?>>
