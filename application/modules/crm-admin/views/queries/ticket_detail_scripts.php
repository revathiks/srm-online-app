...
var url = "<?php echo base_url(); ?>crm-admin/ticket_details/"+ticketid+"/"+logged_applicant_id+"/"+logged_applicant_login_id;
var redirect="<?php echo base_url(); ?>crm-admin/queries";
