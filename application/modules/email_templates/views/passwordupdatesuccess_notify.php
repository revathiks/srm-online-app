                        ...
                        <tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding:10px 0 10px 10px"> 
                                                    <img src="<?php echo base_url().$this->config->item('template_logo_image_path' );?>" style="max-height: 92px;" alt="logo" class="CToWUd"> </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="padding:10px">
                                    ...
                                    <p class="m-1">As requested, we have successfully changed your password for SRM Group Of Institutions. New password is mentioned below:
                                    <p class="m-1"><strong>Email : <?php echo $email;?></strong></p>
                                    <p class="m-1"><strong>Password : <?php echo $pwd;?></strong></p>
                                </td>
                            </tr>
                            <tr>
