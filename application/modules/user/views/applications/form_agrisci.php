...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'agrisci_form', 'name' => 'agrisci_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
...
<fieldset>
	...
	<div class="w-100 pd-20 pd-sm-40">
		...
		<div class="form-layout">
			...
			<div id="international_bsc_hons_am" style="display:none;"><p><?php echo NRI_FOREIGN; ?></p>
				<a href="<?php echo NRI_FOREIGN_URL; ?>"><?php echo NRI_FOREIGN_URL; ?></a>
			</div>
			<div id="guidelines" style="display:none;"><span class="tx-danger">* </span><p><?php echo IS_AGREE_INFO; ?></p>
				<label class="ckbox">
...
<fieldset>
	...
	<div class="w-100 pd-20 pd-sm-40">
		<h5 class="card-body-title mt-4 text-primary">Select Program Level and Course Preference</h5>
		<div class="form-layout">
			<div class="row mg-b-25 mt-3">
				<div class="col-lg-6">
					<div class="form-group mg-b-10-force">
						<label class="form-control-label">Program Level <span class="tx-danger"> *</span></label>
						<select class="form-control select2" data-placeholder="Choose Program Level" tabindex="-1" aria-hidden="true" name="pd_program_level" id="pd_program_level" title="Choose Program Level" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CHOOSE_PROGRAM_MSG; ?>" data-parsley-errors-container="#custom-pd_program_level-parsley-error">
							<option value="">Select Program Level</option>
						</select>
						<span id="custom-pd_program_level-parsley-error"></span>
					</div>
				</div><!-- col-4 -->
				<div class="col-lg-6" id="agrisci_course" style="display:none;">
					<div class="form-group mg-b-10-force">
						<label class="form-control-label">Course Preference <span class="tx-danger"> *</span></label>
						<select class="form-control select2" data-placeholder="Choose Course Preference" tabindex="-1" aria-hidden="true" name="pd_course_preference" id="pd_course_preference" title="Choose Course Preference" data-parsley-required="true" data-parsley-required-message="<?php echo REQD_CHOOSE_COURSE_MSG; ?>" data-parsley-errors-container="#custom-pd_course_preference-parsley-error">
		...
		<div class="form-layout">
			<div class="row mg-b-25 mt-3">
				...
				<div class="row w-100">
                      ...
                      <div class="form-group col-md-6" id="main_div_twelvfth_marksheet" style="display:none;">
