...
if($dob){
	$dob=isset($dob)? date('m/d/Y',strtotime($dob)):'';
}
...
$attributes = array('class' => 'form-horizontal form-wizard-wrapper .custom-validation', 'id' => 'phd_jan_form', 'name' => 'phd_jan_form', 'enctype' => 'multipart/form-data', 'data-parsley-validate data-toggle'=>"validator");
