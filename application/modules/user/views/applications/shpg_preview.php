<style>
span.select2-selection.select2-selection--single[aria-labelledby="select2-phone_no_code-container"],span.select2-selection.select2-selection--single[aria-labelledby="select2-pd_father_phone_no_code-container"],span.select2-selection.select2-selection--single[aria-labelledby="select2-pd_mother_phone_no_code-container"],span.select2-selection.select2-selection--single[aria-labelledby="select2-pd_guardian_phone_no_code-container"],span.select2-selection.select2-selection--single[aria-labelledby="select2-pd_father_alt_phone_no_code-container"],span.select2-selection.select2-selection--single[aria-labelledby="select2-pd_mother_alt_phone_no_code-container"] {
...
$course_2 = isset($course_2) ? $course_2 : 'Choose Course Preference 2';
$course_3 = isset($course_3) ? $course_3 : 'Choose Course Preference 3';
...
$parent_name=isset($applicant_application_details_list[0]['applicant_name_declaration'])?$applicant_application_details_list[0]['applicant_name_declaration']:'';
$applicant_name=isset($applicant_application_details_list[0]['applicant_parentname_declaration'])?$applicant_application_details_list[0]['applicant_parentname_declaration']:'';
...
$stream_id = isset($applicant_schooling_list[1]['stream_id']) ? $applicant_schooling_list[1]['stream_id'] : '';
$stream_name = isset($applicant_schooling_list[1]['stream_name']) ? $applicant_schooling_list[1]['stream_name'] : '';
...
<div class="row">
    <div class="col-md-1">
        <a href="<?php echo base_url(); ?>shpg" class="btn btn-primary active w-100 mt-3" role="button" aria-pressed="true">Back</a>
    </div>
</div>
                            ...
                            <div class="row w-100">
                             ...
                             <h5 class="text-primary mb-3">Academic Details</h5>
                                ...
                                <section class="row">
                                    ...
                                    <table class="table table-bordered table-responsive mt-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group mg-b-10-force">
                                                        <select class="form-control select2" name="academic_yr_passing" id="academic_yr_passing" title="Choose Year" data-parsley-required="true" data-parsley-required-message="Please Choose Year Of Passing" data-parsley-errors-container="#custom-academic_yr_passing-parsley-error">
                                    ...
                                    <?php if($qual_status_id >1){ ?>
                                       <div class="row w-100">
                                        <div class="col-md-12">
                                        <h5 class="text-primary mb-3">12th / Diploma Details</h5>
                                     <table class="table table-bordered table-responsive mt-0 twelfthtbl" id="twelfthtbl">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group mg-b-10-force">
                                                        <select class="form-control select2" name="academic_yr_passing_twelfth" id="academic_yr_passing_twelfth" title="Choose Year Of Passing" data-parsley-required="true" data-parsley-required-message="Please Choose Year Of Passing" data-parsley-errors-container="#custom-academic_yr_passing_twelfth-parsley-error">
                                                ...
                                                <td>
                                                    <div >
                                                        <div class="form-group mg-b-10-force">
                                                            <select class="form-control select2" name="academic_stream" id="academic_stream" title="Choose Stream" data-parsley-required="true" data-parsley-required-message="Required" data-parsley-errors-container="#custom-academic_stream-parsley-error">
                                    ...
                                    <div class="help_text">For Diploma holders: Please choose <b>other </b>option in stream column and fill with your type of diploma in others field.</div>
                                    </div>
                                   </div>
                                  <?php } ?>
    <?php if($qual_status_id > 3) { ?> 
    <div class="row w-100">
         <div class="col-md-12">                                   
        <div><h5 class="text-primary mb-3 mt-4 ugtable" >Under Graduation Details</h5></div>
    	<table class="table table-bordered table-responsive mt-0 ugtable" id="ugtable" >
            <thead class="thead-light">
                <tr>
                    <th></th>
                    <th> Institute</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                    	<div class="form-group mg-b-10-force">
						<select class="form-control select2" name="yr_passing_ug" id="yr_passing_ug" title="Choose Year Of Passing" data-parsley-required="true" data-parsley-required-message="Please Choose Year Of Passing" data-parsley-errors-container="#custom-yr_passing_ug-parsley-error">
                                        ...
                                        <div class="col-lg-6 mb-3">
                                            <div class="card mb-3 base_details_card">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-subtitle">Phone Number : <?php echo $mobile_no ?></p>
                                                </div>
                                            </div>
                                            <!-- card -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input type="radio" id="customRadioInline2" name="outer-group[0][customRadioInline1]"
                                                                       class="custom-control-input">
                                                                <label class="custom-control-label" for="customRadioInline2">DD</label>
                                                            </div>
                                                        </div>
                                                    </div>
