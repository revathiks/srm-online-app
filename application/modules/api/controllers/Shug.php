 ...
 *
 */
class Shug extends API_Controller {
    ...
    public function shug_basic_detail_post() {
        $app_form_id_hcma = APP_FORM_ID_SHUG;
    ...
    public function shug_preference_get() {
        $table_schema = SCHEMA_ADMISSION;
    ...
    public function shug_personal_detail_post() {
        $applicant_personal_det_table = APPLICANT_PERSONAL_DET_TABLE;
        ...
        if($campus_pref) {
            ...
            foreach($campus_pref as $k=>$v) {
                ...
                $n_caempus_prefr_id = $applicant_campus_prefer_id[$k];
    ...
    public function shug_parent_detail_post()
    {
        $app_form_id_hcma = APP_FORM_ID_SHUG;
    ...
    public function shug_addressdet_post()
    {
    ...
    public function shug_academicdet_post()
    {
        $user_data = $this->post();
        $table_schema = SCHEMA_ADMISSION;
        $applicant_personal_det_table = APPLICANT_PERSONAL_DET_TABLE;
        ...
        if($current_qualification_status > 1 ) {
            ...
            if($user_data['institute_name_eleven']!=""){
                ...
                $board_eleven = ($user_data['board_eleven']!='' && $user_data['board_eleven']!='null') ? $user_data['board_eleven'] : NULL;
                $marking_scheme_eleven = ($user_data['marking_scheme_eleven']!='' && $user_data['marking_scheme_eleven']!='null') ? $user_data['marking_scheme_eleven']:NULL;
                $cgpa_eleven = ($user_data['cgpa_eleven']!='' && $user_data['cgpa_eleven']!='null') ?$user_data['cgpa_eleven'] :NULL;
        ...
        //end new
        $this->_get_error_status($other_det_res);
    ...
    public function shug_declaration_post() {
        $app_form_id_hcma = APP_FORM_ID_SHUG;
        $applicant_personal_det_table = APPLICANT_PERSONAL_DET_TABLE;
        $applicant_appln_det_table = APPLICANT_APPLN;
        $table_schema = SCHEMA_ADMISSION;
