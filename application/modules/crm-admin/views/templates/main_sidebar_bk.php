      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>backend/dashboard"><i class="fa fa-tachometer"></i>Dashboard</a></li>
            <li><a href="<?php echo base_url(); ?>backend/do_upload_view"><i class="fa fa-upload"></i>Image Upload</a></li>			
          </ul>		  
        </li>
