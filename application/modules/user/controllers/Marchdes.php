...
class Marchdes extends FrontendController
{
	//
    public $CI;
    ...
    public function marchdes_form($view_type = false) {
        ...
        $applicant_login_id=$this->user_details_data['user_details']['data'][0]['applicant_login_id'];
            ...
            $this->data['site_title'] = $this->data['page_title'] = 'M.Arch / M.Des Application Form';
            if($view_type == 'preview') {
                $this->data['site_title'] = $this->data['page_title'] = 'M.Arch / M.Des Application Form Preview';
                //$this->template('applications/form_btech_preview', $this->data, true);
				$this->template('applications/form_marchdes', $this->data, true);    
            } else {
