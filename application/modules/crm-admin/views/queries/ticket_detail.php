<div class="row">
    <div class="col-12">   
        ...
        if (!empty($ticketinfo)) {
            ...
            $status_id = $ticketinfo[0]['status_id'];
    ...
    if (!empty($ticket_conversations)) {
        foreach ($ticket_conversations as $conversation) {
            ...
            if (!empty($conv_created_at)) {
                $conv_created_at = date("j M Y  H:i A", strtotime($conv_created_at));
            }
            $colWidth = "col-md-12";
                    ...
                    <div class="form-layout">
                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-12">
                                <div class="form-group">
                                <?php 
                                $status=array(TICKETS_INPROGRESS_STATUS=>'In Progress',
                                    TICKETS_CLOSED_STATUS=>'Closed');
                                ?>
                                    
                                    <select id="status_id" class="form-control">
                                    <?php  
                                        foreach($status as $key => $statuscol) { 
                                            $selected="";
                                            if($key==$status_id){
                                            $selected="selected='selected'";
                                        }
                                     ?>
                        				<option <?php echo $selected;?> value="<?php echo $key ; ?>"><?php echo $statuscol;?></option> 
                        			 <?php } ?>
                        			</select>
